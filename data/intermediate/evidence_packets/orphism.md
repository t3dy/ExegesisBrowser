...
```
**Co-occurrences**: Christianity, Form, Well, Gnosticism, Dionysos, Plotinus, Elijah, Father, Like, Time, After, Cosmic, Savior, Good, Light, Firebright, Okay, Could, Does, Just, Something, Look, Being, Self, Orphic, Divine, Himself, Sibyl, Viewed, Grace, More, Through, Such, Certainly, Doris, True, Would, Other, Were, Beyond, Have, Life, Body, Justice, Truth, Human, Doesn

---
### Line 1142-1150 (Match: 'Orphism')
**Folder**: book is
...
```
**Co-occurrences**: Christ, Christian, Spirit, Holy, Jesus, Holy Spirit, King, Roman, However, Father, Maybe, Like, World, Only, Time, Harpax, After, Light, Even, Firebright, Okay, Look, Once, Again, Being, March, Runciter, Self, Chrissy, Those, Still, More, Through, Actually, Calvin, Would, Somehow, Kingship, Were, Back, Whatever, Justice, Spring, Wise, Testament, Passover, Remember, Truth, Dream

---
### Line 2248-2256 (Match: 'Orphism')
**Folder**: BOOK OF
...
```
**Co-occurrences**: Christ, Christian, Jesus, Christianity, Plato, Kingdom, Greek, Well, Perhaps, Plotinus, Like, World, Since, Fall, Because, Time, Savior, Does, Anyhow, Just, Again, Kingdom of God, Being, Jesus Christ, Although, Orphic, Divine, Himself, Gods, Probably, Deus, Anamnesis, Without, Those, Most, Living, Secret, Deity, Would, Were, Back, Egyptian, Beyond, Have, Things, Body, Eckehart, Memory, Later, Having, Remember, Knowledge, Ptath

---
### Line 2486-2494 (Match: 'Orphism')
**Folder**: vol 12
...
Needs Review
```
**Co-occurrences**: Christian, Spirit, Holy, Jesus, Christianity, Holy Spirit, Form, Fish, Greek, Bible, Wisdom, Dionysos, Perhaps, Elijah, Like, Because, Only, Time, Harpax, Good, Even, Could, Does, Something, Taoism, Being, Girl, Orphic, Himself, Great, Viewed, Without, Grace, More, Another, Living, Heaven, Real, Certainly, Before, Zoroastrianism, Death, Would, Other, Were, Very, Back, Surely, Under, Have, Life, Dark, Freedom, Later, Evil, God Himself, Elisha, Human, Dream, Ananke

---
### Line 6820-6828 (Match: 'Orphism')
**Folder**: part cycle
...
Indexed
```
**Co-occurrences**: Christ, Valis, Ubik, Toso, Thomas, Indexed, Rome, Paul, Empire, Roman, Like, Cosmic, Buckman, Cosmic Christ, Kosmos, Being, Orphic, Soul, Pyth, Death, Under, Journey, Justice, Dark, Right

---
### Line 8363-8371 (Match: 'Orphism')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Christianity, Gnosticism, Like, Only, Time, Cosmic, Paraclete, Cosmic Christ, Joint, Does, Something, Being, Everything, Probably, Anamnesis, Nothing, Part, Through, Certainly, True, Universe, Will, Were, Under, Have, Absolute, Evil, Except, Salvation, Free, Right

---
### Line 20519-20527 (Match: 'Orphism')
**Folder**: part of
...
```
**Co-occurrences**: Valis, Form, Plato, Wisdom, Like, Platonist, Pythagoras, Could, Reality, Kosmos, Being, Empedocles, Apollo, Sibyl, Anamnesis, More, Soul, Most, Certainly, Things, Life, Having, Dialectic, Magic, Greater, Human

---
### Line 25708-25716 (Match: 'Orphism')
**Folder**: part of
...
Folder, Still, Part, Zeus, Church, Voice, Finally, Have, Absolute, Body, Kyrios, Blood, Qumran, Human, Ananke

---
### Line 28025-28033 (Match: 'Orphism')
**Folder**: part of
...
Needs Review
44
94 So "Valis" is a scrupulous documentation which, if accepted, verifies the basic constituents of Orphism/Pythagoreanism in seeing Valis I saw kosmos forming at the center of the infinite - or, as I phrase it in "Valis," the rational invading the irrational + transubstantiating (devouring) it (assimilating it.) + this is directly con‐ nected to Apollo's "moderation [telos) in all things" - proportion + harmony + limit as a religion it is shamanistic apollonism + hence connected with the Sibyl (at Delphs), Apollo's oracle whom he took over + spoke through. the God here is Apollo, not Dionysus (this agrees with the andeid: Apollo, Sibyl, cyclops, blessed isles. But I go one step farther than the account of Pythagorean cosmogony (available to me): I say of Valis: "the seed is the second thought by her geometrically expressed." 1) "second thought" - telos that makes the atelos her first thought: original dis‐ rdered (non-kosmos) creation. It came first (as is obvious in the Pythagorean cos logony). 2) who is "she"? She is "the designer of the binary computer" which generates the dialectic opposited + which we're plugged into. "She is Logos of it but God created it (i.e. caused he to exist. She envisioned it as thought + he turned it into reality. But who is she who t rentally conceived it? The bird woman"! I "She decides for God what believe she is St. Sophia: She is wisdom + is the He shall do. The kosmos

Last edit almost 3 years ago by svayambhu108
45
Needs Review
```
**Co-occurrences**: Valis, Logos, Sophia, Wisdom, Reality, Kosmos, Apollo, Sibyl, Dionysus, Through, Creation, Things, Dialectic

---
### Line 28477-28485 (Match: 'Orphism')
**Folder**: folder 49

```text
(1) the 8-step Xtian salvific experience occurred to me (so it does exist)

(2) but scarcely anyone else reports it : it is the waking up of the Buddha, not a mass experience & (alas) not really occurring due simply to "accepting Christ." Rather, it is a culmination of a number of lifetimes - in my case stretching back over 3000 years to Egyptian Crete. &, before that, to the Stars.

It is connected to Orphism, the Elysian Mysteries & the Greco-Roman Mystery religions. It is an attempt to remember & thus to regain our original nature. __ Look : it is evident that what I've been calling "the Law" & "Elemental Powers" in fact describes a totally controlled mechanical system - esp. the synchronized inner-outer tapes. I say, more modern terms than "angels" must be applied, we are a rigidly determined system that is run by information, & an information blueprint exists (before the system) that programs it into us. (for example we are occluded in terms of perception, memory, & cognition, in order to not notice this control.) In view of this reasoning I can assume that the mind I encountered is in charge of the system; it may even [have]

Last edit almost 9 years ago by Toso
folder 49 - 019
Complete
```
**Co-occurrences**: Christ, Christian, Toso, Complete, Roman, Folder, Buddha, Mind, Even, Does, Look, Toso
Folder, Greco, More, Before, Back, Egyptian, Have, Memory, Information, Remember, Crete

---
### Line 29218-29226 (Match: 'Orphism')
**Folder**: folder 49
...
```
**Co-occurrences**: Christian, Complete, Rome, Christianity, Well, These, Plotinus, Like, World, Because, Time, Folder, Buddha, Book, Both, Sankara, Self, Dante, Buddhism, Orphic, Through, Soul, Will, Commedia, Have, Paradise, Track

---
### Line 29220-29228 (Match: 'Orphism')
**Folder**: folder 49
...
---
### Line 30539-30547 (Match: 'Orphism')
**Folder**: Book of
...
Needs Review
```
**Co-occurrences**: Christ, Christianity, Dionysos, Father, Good, Even, Just, Both, Obviously, Orphic, Divine, Himself, Their, More, Most, Heaven, Revelation, Messenger, Will, Were, Life, Instead, Later, Evil, Durant

---
### Line 33850-33858 (Match: 'Orphism')
**Folder**: part of
...
```
**Co-occurrences**: Christ, Plato, Plotinus, World, Parmenides, Fall, Platonist, Cosmic, Cosmic Christ, Does, Taoism, Realm, Again, Reality, Kosmos, Heraclitus, Anamnesis, Dokos, More, Another, Through, Flux, Certainly, Revelation, Creation, Very, Have, Dialectic, Upper, Lower, Whereas

---
### Line 33931-33939 (Match: 'Orphism')
**Folder**: Unknown

```text
The great bipolarities are: integration versus strife; unity versus multiplicity. Unity equals integration; strife equals multiplicity. Negentropy equals integration equals unity. Entropy equals strife equals multiplicity. Few, complex, integrated; many, simple, disintegrated. And yet above it all is the One which is totally reconciled internally and totally simple; an anomqly.

And it is stacked as a hierarchy. And, in the higher realms, there is a Mind. Actually it operates here in realm 4, but veiled. With each descent, Mind becomes more veiled; strife becomes mixed with chaos — first strife (the dialectic) enters, and then chaos. And below chaos: the immutable world of total determinism, with no real mind; the realm of evil. Ananke.

I will stake everything on this: it is evolutionary^, not a primordial descent; it is evolution; it is stacking; it is building; it is creating. Each higher realm evolves out of the lower. The ancients had it backward, due to Orphism's influence. Matter evolves into biological life which evolves into meta life forms: Valis.

Last edit almost 5 years ago by svayambhu108

{folder 01 - 001}
```
**Co-occurrences**: Valis, Form, World, Folder, Mind, Realm, Everything, Great, More, Real, Actually, Will, Many, Life, Evil, Dialectic, Lower, Ananke

---
### Line 33982-33990 (Match: 'Orphism')
**Folder**: folder 01
...
But what I would stress at this point is that the Form world when it broke into the world of accidents (or I ascended to it, as Plotinus describes) --it was so vast; the spaces were enormous; it was so much more real, awesome, than the epiphenomenal world that we normally go through our lives experiencing. I would say, Yes, it did seem like an archetypal world, in both the Platonist sense and the Jungian sense; it was immense in terms of substance, of space, of time, of pure being. How could I suppose it to have been other than substantia itself? I have really always known this. What distinguishes Plotinus' system from, say, Gnosticism, is that for Plotinus such experiences took place in this life, as they did for me, not, as with Gnosticism, after death. In a very real sense, Plotinus' system is this-worldly, although it deals with meta-levels of reality. This crucial difference between his system and most others should have directed me that way from the start. And, too, Neo-Platonism is (as the reference books say) the culmination of Greek philosophy: it grew out of Plato, Pythagorianism and the mystery religions, including Orphism. It should have been the first place I looked.

E of PH on universals (near the end of the article); "That experience, thought, and language depend on the use of universals, in some sense, is undeniable, and the explanation of this is to be given by a suitably illuminating description of the world we experience ... The philosophical history of universals has been plagued by the persistent treatment of words as names, which has been made easier by philosophers' taking as their examples only objects and their qualities. But questions about universals are questions about generality, and generality is the essential feature of all words, not just of those that might plausibly be called names." Russell in 1921: "I think a logical argument could be produced to show that universals are part of the structure of the world." Nominalism is shown in this article simply to not work: "Perhaps the only extreme nominalist has been Humpty Dumpty." It looked to the British empiricists as if nominalism was commonsense, but it turns out not to be (Locke, Hume, etc). In other words a belief in universals is not a naive fossile remnant from archaic philosophies.
```
**Co-occurrences**: Indexed, Form, Plato, Greek, Gnosticism, Perhaps, Plotinus, Like, World, Only, Time, Platonist, After, Folder, Platonism, Book, Could, Just, Suppose, Both, Reality, Being, Although, Indexed
Folder, Those, Part, Their, More, Through, Most, Real, Such, Death, Would, Other, Were, Very, Have, Life, Jungian, Form World

---
### Line 34497-34505 (Match: 'Orphism')
**Folder**: folder 01

```text
Following 10-21-80 p. 8

well as Plato's anamnesis? Since through it you become aware of the reality of the universals (eide), hence the mere accidental semireality of the spatiotemporal world?

On page 10-21 p.8 I spectulate that Plato, due to his contact with the Orphics + Pythagoras knew exactly what anamnesis consisted of + accomplished. Now I have come to this new conclusion as to the real purpose of religion (to free us from the tyranny of the [spatiotemporal] world + that Platonist anamnesis is the most successful way of doing this. So is it not likely that Plato knew this -about anamnesis + the purpose of: the Mysteries! He has adapted the secrets of Orphism, Pythagoreanism + the Mysteries to philosophical purposes -intellectual metaphysics, in answer to the question "Ti to on?"- but for sure Orphism + Pythagoreanism utilized anamnesis, so why not the Mysteries? They were related to Orphism (Dionysian rites to Orphism & Elusius)! + Orp-

Jesus as cypher for Zeus-Zagreus i.e. Dionysus as child who is eaten to obtain divine immortality.

Let me, tremblingly, recap what anamnesis does. The soul is splintered over thousands of miles of time + space, anamnesis [... (1) Free ...self of the]
```
**Co-occurrences**: Jesus, Plato, Well, World, Since, Time, Platonist, Pythagoras, Does, Reality, Zagreus, Self, Orphic, Divine, Anamnesis, Dionysus, Zeus, Through, Soul, Most, Real, Page, Were, Have, Free, Answer
