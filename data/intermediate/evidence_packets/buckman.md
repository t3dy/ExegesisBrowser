...
```
**Co-occurrences**: Christ, Tears, Logos, Perhaps, Father, Maybe, Like, World, Only, John, Time, After, Faith, Mind, Even, Taverner, Does, Something, Again, Everything, House, Gods, Fate, Probably, More, Another, Egypt, Most, Real, Such, Actually, Revelation, Mother, Death, Universe, Deity, Other, Judge, Whatever, Under, Have, Life, Information, Trinity, Today, Dream, Evidently, Right, Answer

---
### Line 2106-2114 (Match: 'Buckman')
**Folder**: part of
...
Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Christ, Tears, Christian, Ubik, Jesus, Form, Felix, Well, Lord, These, Maybe, Only, Harpax, Black, Book, Even, Gospel, Could, Taverner, Soviet, Both, Reality, Being, Self, Probably, Kathy, Their, Most, Such, Love, Revelation, Consider, Western, Finally, Other, Somehow, Very, Back, Beyond, Surely, Under, Many, Have, Life, Claudia, Cross, West, Dream, Doesn, Right, Until

---
### Line 2130-2138 (Match: 'Buckman')
**Folder**: book but
...
```
**Co-occurrences**: Tears, Acts, Holy, Christianity, Felix, Bible, Like, World, Harpax, After, Black, Book, Even, Anyhow, Just, Something, Reality, Kosmos, Obviously, Philip, More, Another, Through, Living, Before, Other, Later, Suddenly, Dream, Right

---
### Line 2132-2140 (Match: 'Buckman')
**Folder**: book but
...
Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Christ, Tears, Acts, Christian, Spirit, Holy, Christianity, Holy Spirit, Felix, Bible, Parousia, Wisdom, Like, World, Since, Harpax, After, Black, Book, Even, Anyhow, Just, Something, Reality, Luke, Kosmos, Being, Obviously, Philip, Probably, Their, More, Another, Through, Living, Such, Before, True, Other, Were, Many, Wise, Later, Dead, Suddenly, Human, Dream, Right

---
### Line 2968-2976 (Match: 'Buckman')
**Folder**: book was
...
```
**Co-occurrences**: Tears, Acts, Spirit, However, Maybe, Like, World, Since, Because, Therefore, Only, Time, Nixon, After, Black, Book, Even, Could, Just, Although, Great, Probably, Jason, Part, Their, More, Another, Most, Living, Real, Actually, Certainly, True, Death, Would, Other, Somehow, Very, Have, Things, Body, Later, Government, During, Dream, Until

---
### Line 3349-3357 (Match: 'Buckman')
**Folder**: book when
...
Needs Review
```
**Co-occurrences**: Christ, Tears, Acts, Form, Sophia, King, Greek, Empire, Parousia, Roman, Since, Because, Only, Cosmic, Good, Book, Cosmic Christ, Taverner, Does, Something, Again, Both, Everything, Either, Great, Viewed, Those, Dokos, More, Pantocrator, Through, Most, Living, Such, Certainly, Love, Before, Universe, Were, Very, Have, Things, Justice, Wise, Evil, Pauline

---
### Line 4118-4126 (Match: 'Buckman')
**Folder**: part could
...
Needs Review
```
**Co-occurrences**: Christ, Tears, Christian, Complete, Christianity, Perhaps, Advent, Like, World, Since, Iron, Prison, Only, Time, Black, Mind, Even, Once, Divine, Black Iron Prison, Either, Palm, Viewed, Without, Still, More, Living, Real, Will, Would, Were, Back, Have, Tree, Later, Having, Iron Prison, Dream

---
### Line 5727-5735 (Match: 'Buckman')
**Folder**: part of
...
Indexed
```
**Co-occurrences**: Christ, Tears, Toso, Indexed, Rome, Form, Kingdom, These, Plotinus, Father, World, Iron, Prison, Time, Platonist, Black, Could, Pinky, Again, Being, Divine, Black Iron Prison, Himself, Great, More, Babylon, Real, Somehow, Were, Illustration, Very, Back, Beyond, Truth, Iron Prison, Until, August

---
### Line 5752-5760 (Match: 'Buckman')
**Folder**: book was
...
Indexed
```
**Co-occurrences**: Christ, Tears, Christian, Toso, Indexed, Rome, Form, Sophia, King, Paul, Felix, Roman, Wisdom, Like, World, Fall, Prison, After, Book, Could, Taverner, Obviously, Frolix, Daniel, House, Jason, Santa, Those, Their, More, Another, Through, Babylon, Most, Actually, Before, Were, Jason Taverner, Very, Have, Later, Remember, Truth, Dream

---
### Line 6753-6761 (Match: 'Buckman')
**Folder**: part of
...
Complete
```
**Co-occurrences**: Valis, Tears, Acts, Toso, Thomas, Complete, Rome, Time, Could, Taverner, Just, Kosmos, Self, Pyth, Macro, Have, Life, Right

---
### Line 6761-6769 (Match: 'Buckman')
**Folder**: part of
...
```
**Co-occurrences**: Christ, Jesus, Complete, Rome, Form, King, Dionysos, Maybe, Taverner, Either, Their, True, Illustration, Life, Pentheus, Final, Pilate

---
### Line 6783-6791 (Match: 'Buckman')
**Folder**: part of
...
what the 3-eyed (C) Sibyl was talking about vis-a-vis the conspirators (Bs). Thus the "father" who sent the "son" here is essentially a moral order (ma'at). The B life form overstepped (atelos) in preying on us. The B life form is my android vs the authentic human; they wield power instead of love. They are the goats whom "Christ" divides from the sheep. Then the "Acts" world seen in 3-74 by Thomas is this (planet) world now + always as seen by a C, under that permanent aspect (as is "Tears" qua world, including the unfolding of the proto-story - the trap + Buckman (a B) against Taverner (a C mimicking an A )). It (this world) is seen by someone from off this planet, which is why I kept gazing at the stars + feeling vast spaces. The different perception of USA 1974 is due to an ontological difference in the percipient. This is the Bible as window on the world. So the NT proto-narrative tells about an invasion (of this world as BIP), + not one in the past but perpetually. It is a viewpoint, + a series of actions by a specific group, ontologically different from everyone else. Why do I keep thinking of Ds as 4s?

Last edit over 5 years ago by Toso
10
Indexed
```
**Co-occurrences**: Christ, Tears, Acts, Toso, Thomas, Indexed, Form, Bible, Father, World, Taverner, Sibyl, Love, Under, Life, Instead, Human, Someone

---
### Line 6791-6799 (Match: 'Buckman')
**Folder**: part two
...
Last edit over 5 years ago by Toso
```
**Co-occurrences**: Christ, Valis, Tears, Toso, Indexed, Logos, Xerox, Form, Like, Only, Firebright, Taverner, Kosmos, Being, Missive, Xerox Missive, Jason, Part, Real, Pyth, Jason Taverner, Have, Life, Body

---
### Line 6810-6818 (Match: 'Buckman')
**Folder**: part cycle
...
Last edit over 5 years ago by Toso
```
**Co-occurrences**: Valis, Tears, Toso, King, Only, Just, Taoism, Both, Kosmos, Divine, Their, More, Death, Illustration, Whatever, Life, Wise

---
### Line 6820-6828 (Match: 'Buckman')
**Folder**: part cycle
...
Indexed
```
**Co-occurrences**: Christ, Valis, Ubik, Toso, Thomas, Indexed, Rome, Paul, Empire, Roman, Like, Cosmic, Cosmic Christ, Kosmos, Being, Orphic, Soul, Orphism, Pyth, Death, Under, Journey, Justice, Dark, Right

---
### Line 7333-7341 (Match: 'Buckman')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Valis, Tears, Acts, Christian, Zebra, Logos, Rome, Christianity, Felix, Perhaps, Scanner, World, Iron, Only, Nixon, Black, Even, Himself, Deus, Another, Real, Secret, Love, Irae, Death, Universe, Would, Were, Freedom, Evil, God Himself, Deus Irae, Dream, Final, Until

---
### Line 7638-7646 (Match: 'Buckman')
**Folder**: book of
...
36
```
**Co-occurrences**: Christ, Tears, Ubik, Zebra, Sophia, Felix, Since, Therefore, Black, Divine, House, Part, More, Another, Real, Love, Deity, Would, Somehow, Were, Have, Life, Knowledge, Otherwise, Dream

---
### Line 8193-8201 (Match: 'Buckman')
**Folder**: part of
...
121
```
**Co-occurrences**: Christ, Tears, Well, Maze, World, Time, Black, Even, Could, Soviet, Christi, Divine, Corpus, Part, Through, Soul, Corpus Christi, Actually, Will, Other, Very, Back, Have

---
### Line 8340-8348 (Match: 'Buckman')
**Folder**: part of
...
Needs Review
144
135 I see why it is said by Xtian mystics that they were "ravished by God." -RW's book "myth + reality" makes me think that "Ubik" is more correct accurate + precise a description of the divine + how it works in relation to us than I had ever imagined. My great error in '74 + on was thinking that "sacred time" had invaded linear time, but what in fact had happened was that I had entered "sacred time." my grief (as with Buckman in "Tears") in being t transmuted - not into love - but into a realization that it is [already] love - love dammed up + denied in me, seeking an outlet. Thus it burst through in TI's when I met Linda. That episode + the episode in which I gave the black stranger money for gas + drove him to the Gasstation - those two incidents combined form the scene in "Tears" (at the all night gas station) which, I find, is from Acts. I, in the novel in 70, saw ahead to '78 - Buckman's isolation + grif my isolation + grief, + love. "EB: Mnemosyne" "the basis of all life + creativity."

Last edit almost 3 years ago by svayambhu108
145
Needs Review
```
**Co-occurrences**: Tears, Acts, Christian, Ubik, Form, Time, Black, Book, Reality, Being, Divine, Great, Those, More, Through, Love, Were, Life, Sacred
