...
```
**Co-occurrences**: Tears, Christian, Spirit, Logos, Jesus, King, Well, Dionysos, These, Perhaps, Elijah, Father, Maybe, Since, Only, Time, Harpax, After, Could, Something, Reality, Zagreus, Frolix, Gods, Zeus, Jung, Another, Such, Actually, Deity, Somehow, Further, Information, Except, Durant

---
### Line 2530-2538 (Match: 'Pentheus')
**Folder**: part of
...
```
**Co-occurrences**: Christ, Jesus, Complete, Rome, Form, King, Dionysos, Maybe, Buckman, Taverner, Either, Their, True, Illustration, Life, Final, Pilate

---
### Line 7271-7279 (Match: 'Pentheus')
**Folder**: part of

```text
Look what I just said. From Judeah, the outer lands, the center has been penetrated: in a sense Rome as adversary has fallen, or at least a prefiguring of its fall has taken place. Rome has fallen- in Acts, in "Tears" and in our "B" (1974) worl. The persecuted can now step forth and speak unhindered. After his confrontation with the authorities as represented by Felix, Jason is allowed to resume his work. He has even more followers than ever (viewers). The juridical process has proven fair. The persecuting authorities are in retreat; sorrow and loss has fallen over them and because of this they (ie Felix) are changed.

The success of the persecuted innocent is assured. What has been done. The changes which have set in, cannot be revered. This was all done under the tutulary guidary of the spirit. The initial structure of the new church has been established and the gospel has pierced Rome itself, never to leave.
...
11
```
**Co-occurrences**: Tears, Acts, Spirit, Rome, King, Felix, Wisdom, World, Fall, Because, After, Even, Gospel, Just, Look, Divine, Jason, More, Church, Love, Judge, Under, Have

---
### Line 7676-7684 (Match: 'Pentheus')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Tears, Spirit, Form, King, Felix, Greek, Well, However, Dionysos, Perhaps, Like, Since, Only, Time, Savior, Good, Does, Anyhow, Once, Shiva, Being, Himself, Bacchae, Fate, Wait, Real, Secret, Love, True, Will, Deity, Other, Back, Things, Body, Memory, Knowledge, Hermes, Human, Evidently, Final

---
### Line 9318-9326 (Match: 'Pentheus')
**Folder**: Unknown
...
Complete
23
New theory: the dream material + the Acts material in "Tears" was a red herring crypto message, designed to satisfy the search for a hidden message. It establishes Xtian orthodoxy. The real message was the single word "Felix" as one of its meanings (e.g. prosperous, lucky, or happy). I select "happy" because it is the exact opposite of the ostensible message of tears + sorrow (i.e. Pentheus, king of tears: the world power + evil one). This one word code is like the one number code in "The Unteleported Man"; it is not intrinsic. What it signifies, who put it there (+ the longer spurious "real message") + for whom it was intended I have no idea. The religious material may all have been a red herring, the dream material served to locate for the correct (proper) receiver the true coded message, as if saying, "the next word you read is the (true, coded) message." Thus the dream notifies the receiver that the actual message is coming (as Mark Roogna's letter notified me that the Xerox letter was coming).

The dream sequence, like Roogna's letter was a "cocking" device.

If you speed up the frames of a movie you see motion. Somehow I speeded up the frames of reality + saw motion: i.e. ZEBRA at work. My perceptions synchronize with it. (i.e. didn't lag.)
```
**Co-occurrences**: Tears, Acts, Christian, Zebra, Complete, Xerox, King, Felix, Like, World, Because, Reality, Real, True, Somehow, Roogna, Have, Evil, Dream

---
### Line 11832-11840 (Match: 'Pentheus')
**Folder**: book it
...
Complete
```
**Co-occurrences**: Tears, Complete, Felix, Dionysos, World, Time, Shiva, Nothing, Judge, Have

---
### Line 11838-11846 (Match: 'Pentheus')
**Folder**: book it
...
```
**Co-occurrences**: Christ, Tears, Spirit, Complete, Rome, King, Dionysos, Scanner, Cosmic, Does, Shiva, Brain, Zeus, Real, Hamlet, Have, Evil, Human

---
### Line 11846-11854 (Match: 'Pentheus')
**Folder**: book it
...
Christ's passion-story is a Tears story, it is an alibi. He was/is the joy God, not the God of Tears (King Pentheus). He was exculpated, as revealed in "Tears" covering over the true (Dionysos) story.

Last edit almost 5 years ago by sekennedy62
33
Needs Review
```
**Co-occurrences**: Christ, Tears, King, Dionysos, Like, Cosmic, Shiva, Reality, Their, True, Many, Human

---
### Line 11852-11860 (Match: 'Pentheus')
**Folder**: book it
...
Needs Review
33
t It is not true that suffering is the to (be) Christ. He himself said, "yo grief will turn to joy," it was io I felt when I had anamnesis (thos i we're being told a lie; the via i rosa is the road to the enemy the of Tears - Buckman. That is an ali s the truth is good news - he lives - he did not suffer, it was an illusion. are reunited with him in joy, not gried or suffering or tears. He told us not to the via dolorosa. perhaps the absolutely rock bottom fi message in "Tears" is that Christ has alre returned - did so at the time of Acts. We are suffering (sic) under a pentheus Tears delusion (realm II). This delusi t must be dispelled for us to see the tr which is a via Felix t let us assume that a secret messa is smuggled through in "Tears" by def it must be at variance with what the story we are told is, + (2) different from the face message in "Tears. My 2-74/3-74 e ience confirms it: Christ returned fact did so at the time of Acts. The t (God) + time (age) of joy are here. Nothing is going to happen that i t .

Last edit almost 3 years ago by svayambhu108
34
Complete
```
**Co-occurrences**: Christ, Tears, Acts, Complete, Felix, Perhaps, Time, Good, Buckman, Realm, Being, Himself, Anamnesis, Nothing, Through, Secret, True, Will, Under, Truth

---
### Line 11935-11943 (Match: 'Pentheus')
**Folder**: Unknown
...
Taverner = drinker = Dionysus = Christ = the Xtian underground opposing "Rome," the central Pentheus - Tears - tyranny.

In 2-74 I was brought into the secret Xtian underground on a conscious "enlightened" (non-occluded) basis.

The entire BIP world of "Tears" - i.e. the bulk of "Tears" is a delusion precisely because of Christ's miraculous intervention, back at the time of Acts.
```
**Co-occurrences**: Christ, Tears, Acts, Christian, Rome, Felix, Like, World, Because, Time, Good, Could, Taverner, Sibyl, Dionysus, Secret, Greece, True, Back, Dream

---
### Line 12277-12285 (Match: 'Pentheus')
**Folder**: book was

```text
BIP, a prison, + an occluding system generating (1) a negative hallucination of the truth; + (2) generating a simulated "Alibi" world.

Messages of hope + cheer smuggled in past the occluding BIP, the BIP tells us, e.g. "Man is sinful." The smuggled in messages, e.g. in "Tears" speak of happiness + innocence + rescue, as in the James-James dream. + the eventual downfall of the BIP + the occlusion. At least one of the ETIs helping us is here (Zebra).

The whole Tears, Pentheus, crucifixion suffering story is a lie.

Last edit over 4 years ago by sekennedy62

61
```
**Co-occurrences**: Tears, Zebra, James, World, Prison, Truth, Dream

---
### Line 12310-12318 (Match: 'Pentheus')
**Folder**: book was
...
Complete
62
10) The 2nd coming abolish the tears (pentheus) + crucifixion;

11) The real road to Christ + salvation is one of celebration + joy, not the cross + the passion

12) Christ is Dionysos + (12a) over threw the Nixon tyranny.
```
**Co-occurrences**: Christ, Tears, Complete, Dionysos, Nixon, Real, Cross, Salvation

---
### Line 12370-12378 (Match: 'Pentheus')
**Folder**: part of
...
Complete
```
**Co-occurrences**: Tears, Complete, King, Prison, Buckman, Taverner, Realm, Although, Bacchae, Jason, Jason Taverner

---
### Line 12385-12393 (Match: 'Pentheus')
**Folder**: part of

```text
66
even before cracking the coded message in "Tears" I knew Christ to secretly be Dionysos (v. my U.K. speech). ➀ it was revealed to me in a dream; ➁ that quatrain of Pindar; ➂ My StP trip. Also Dionysos is a shaman, possessing God, which fits my 3-74 experience - one of theolepsy.

The Fall of "the King of Tears" in my novel (at the hands of Dionysos) was exactly duplicated in the overthrow of Nixon (King Pentheus), so we can deduce that Dionysos (Christ) was behind the overthrow, probably via the secret real Xtian church. We deduce this by assuming that the novel is an analog of USA 1974 + the events there of. This application of the code-story to Nixon's fall fits what I already was shown. I knew that the novel + it being released at that time in some way bore coded material (e.g. "Felix") connected with US political events in 1974, but only now, 1978, upon cracking the coded message can I see the parallel of the message.

Last edit over 4 years ago by sekennedy62
67
Complete
```
**Co-occurrences**: Christ, Tears, Christian, Complete, King, Felix, Dionysos, Fall, Only, Time, Nixon, Even, Being, Probably, Church, Real, Upon, Secret, Before, Dream

---
### Line 12429-12437 (Match: 'Pentheus')
**Folder**: part of
...
```
**Co-occurrences**: Complete, Xerox, Maybe, Like, World, Even, Taverner, Just, Being, Missive, Self, Girl, Xerox Missive, Jason, Their, More, Real, Certainly, Love, Finally, Will, Jason Taverner, Life, Likewise, Lower, Doesn

---
### Line 21147-21155 (Match: 'Pentheus')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Tears, Acts, Holy, Form, King, Torah, Bible, Dionysos, Advent, Like, Prison, Savior, Book, Could, Zagreus, Bacchae, Nothing, Living, Real, True, Will, Other, Caesar, Dream, Whereas
