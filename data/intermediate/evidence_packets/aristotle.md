...
```
**Co-occurrences**: Christ, Complete, Paul, Well, Dionysos, These, Perhaps, Only, Time, Platonism, Both, Reality, Orphic, Christos, Nothing, Those, More, Real, Such, Voice, Death, Would, Other, Under, Many, Have, Life, Spring, Instead, Neither, Days, Except, Dead, Suddenly, Pauline, Dream, Final

---
### Line 1530-1538 (Match: 'Aristotle')
...
```
**Co-occurrences**: Acts, Spirit, Sophia, Greek, Golden, Wisdom, Dionysos, Perhaps, Elijah, Like, World, Since, Only, Time, Harpax, Even, Does, Just, Once, Again, Both, Being, Although, Everything, Dante, Divine, Either, Gods, Anamnesis, Part, Their, More, Another, Soul, Ground, Actually, Certainly, Before, Consider, Greece, True, Universe, Will, Deity, Would, Very, Attic, Whatever, Have, Life, Body, Memory, Whether, Knowledge, Upper, During, Human, Lower, Evidently, Right

---
### Line 1798-1806 (Match: 'Aristotle')
**Folder**: part of
...
```
**Co-occurrences**: Spirit, Holy, Logos, Complete, Holy Spirit, Form, Sophia, Greek, Well, Perhaps, Advent, Plotinus, Like, World, Since, Because, Only, Could, Does, Just, Realm, Again, Being, Catholic, Divine, Philip, More, Such, Voice, True, Would, Judge, Attic, Surely, Have, Things, Information, Freedom, Instead, Evil, Socrates, Likewise, Knowledge, Truth, Reformers, Human, Lamb, Right, Answer

---
### Line 2586-2594 (Match: 'Aristotle')
**Folder**: part has

```text
This would create a Second Adam or New Man (in the old language, "free of sin," which is to say, "free of the sting of death," which means he --I-- can inherit eternal life).

The problem in the world is not evil it is death.

. . . In Aristotle the one sould of the 3 which is immortal is the one which seeks to know (seeks sophia).

"My divine children, whom I am preparing." (dream)

Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Sophia, World, Harpax, Adam, Divine, Death, Would, Life, Evil, Dream, Free

---
### Line 2945-2953 (Match: 'Aristotle')
**Folder**: Book of
...
Needs Review
```
**Co-occurrences**: Christ, Christian, Logos, Jesus, Form, Sophia, Well, However, Wisdom, These, Plotinus, Like, World, Since, Fall, John, Earth, Savior, Book, Light, Even, Okay, Could, Just, Look, Once, Realm, Again, Being, Although, Great, Deus, Grace, More, Through, Heaven, Real, Such, Upon, Before, Irae, Death, Will, Would, Other, Further, Have, Fake, Information, Freedom, Deus Irae, During, Lower, Someone

---
### Line 3182-3190 (Match: 'Aristotle')
**Folder**: part divine
...
```
**Co-occurrences**: Spirit, Holy, Christianity, Plato, Greek, Well, Bible, However, Wisdom, Perhaps, Elijah, World, Since, Gnosis, Only, Time, Faith, Holy Wisdom, Good, Even, Could, Everything, Divine, Probably, Deus, Nothing, Still, Part, Through, Soul, Such, Voice, Love, Before, True, Irae, Universe, Will, Would, Other, Beyond, Surely, Whatever, Have, Life, Absolute, Memory, Information, Deus Irae, Today, During, Salvation, Someone, Answer

---
### Line 3584-3592 (Match: 'Aristotle')
**Folder**: part in
...
Last edit almost 5 years ago by svayambhu108
```
**Co-occurrences**: Christ, Christian, Holy, Logos, Jesus, Complete, Rome, Form, Kingdom, King, Bible, Wisdom, Lord, Perhaps, Advent, Plotinus, Elijah, Father, World, Only, Time, Earth, Cosmic, Holy Wisdom, Good, Mind, Book, Even, Gospel, Could, Realm, Reality, Jesus Christ, Although, Either, Gods, Probably, Grace, Still, More, Church, Heaven, Real, Before, Revelation, Western, Universe, Will, Christopher, Would, Other, Have, Journey, Life, Absolute, Wise, Later, Having, West, During, Answer

---
### Line 5303-5311 (Match: 'Aristotle')
**Folder**: book it
...
Needs Review
```
**Co-occurrences**: Christ, Tears, Ubik, Zebra, Sophia, Advent, World, Since, Because, Time, Book, Again, Empedocles, Hegel, Runciter, Deus, Their, Real, Before, Irae, Will, Have, Later, Knowledge, Deus Irae, Greater, Dream, Right

---
### Line 5861-5869 (Match: 'Aristotle')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Gnostic, Paul, Spinoza, Like, World, Good, Realm, Reality, Being, Leibnitz, Through, Most, Nonetheless, Such, Before, True, Artifact, Evil, Hermes, Right

---
### Line 8334-8342 (Match: 'Aristotle')
**Folder**: part of
...
Needs Review
143
bua Inanimate causal processes --by definition-- are unaware of one another, and som often clash -- which is to say, inter‐ act to nullify one another and thereby constitute chaos. e These mindless collisions give rise on the part of the sentient observer to the correct inferrence that the universe is not sentiently guided. However, a single instance of inanimate causal processes "dovetailing" in a manner absolutely indicating an overriding sentient controller (repeat: a single instance absolutely displaying either an immanent or transcendent "steering") -- that one instance would be enough by which to correctly deduce the existence of what is popularly called God. (Reasoning: proof of God's steering does not depend on him dovetailing --or be seen to dovetail-- all or even many inani‐ mate causal chains. This is not generally recognized. Here is an analogy: a gun being fired fires from a half-cocked position one time. This one time is sufficient to deem --correctly-- the gun malfunctioning. The system, for it to be so, most exclude all exceptions, not just some. one sentient dovetailing, one firing half- cocked -- that is absolute proof.) But there is an even stronger line of reasoning: If God does not exist, no cases of him controlling inanimate processes can occur (or more broadly speaking, no controlling of inanimate processes by evident intent by any non-mundane entity, such as human or animal). I have observed a very small number of such dovetailing by intent within the processes or at least near enough to exert decisive control of outcome. Therefore: It is logically impossible that, if it is assumed that what I observed did in fact occur, the statement "no supernatural deity-like entity exists" is a at least in term‐ of what is generally meant by "supernatural deity-like entity." (Analysis of sylogism: The proposition "there is no God" does not equal the proposition "generally or usually there is no God." The proposition excludes all exceptions (Aristotle's Law of the Excluded Middle). If one exception can be ascertained as a certainty, the proposition is false. It need not be false in all empirical instances observed. Any general concept of function versus malfunction will act as a proper analogy; a system which "generally or usually functions" is not equivilent to a system of which it can be said "this system functions," even though I the latter proposition does not contain the key term "all." The concept "functions" is properly understood as containing the modifier "all." The propositions "there is a God" and "there is not a God" are mutually exclusive, A or not-A (Law of the Excluded Middle). Ipso facto. Deus dixit. true

Last edit almost 3 years ago by svayambhu108
144
Needs Review
```
**Co-occurrences**: However, These, Like, Therefore, Time, Even, Does, Just, Being, Either, Deus, Part, More, Another, Most, Such, True, Universe, Will, Deity, Would, Very, Many, Have, Absolute, Human

---
### Line 9954-9962 (Match: 'Aristotle')
**Folder**: part of

```text
So, if "Ubik" is to be believed, the very part of the (this, our) world which you would least expect to be Form I (real + divine + thinking) is - trash + commercials, etc i.e. the lowest stratum of our world: no wonder Richard saw pre Socratic cosmology (i.e. Empedocles) in "Ubik" Empedocles is close to Parmenides, with his 2 primal forces. I think, though, Parmenides is close to it.

Plato allowed some (eikoi) reality to Form II, but of a lesser, incised, merely passive nature which only receives forms (which alone are truly real). It is a twolevel hierarchy for him.

Upon consideration, why would I or Parmenides or anyone wish to deny the reality of the phenomenal world? It goes hand in hand with the intuition that another reality - this one truly real - lies behind the apparent one. In my 2½ decade of writing I could not discern the contours of that hidden true reality - this only took place successfully in 2-74, + not through my acuity but "done to me." So to speak [..] What did it consists of, this revealed, hidden world? Was the proximity in space + time to me (to us) of the First Advent. This was the moment in human history (the only one) in which the supralunar penetrated the sublunar (to use Aristotle's terms); if Aristotle was right, the two realms normally do not interact.

What the time of the 1st Advent consisted of (esp the period of Acts) was a doorway, via the spirit, into the next or other or heavenly world. If, while alive, a human were to see that other world it would be through the doorway opened up at that time; hence, the manifestation of that space-time continuum of our world equals

Last edit about 5 years ago by sekennedy62
```
**Co-occurrences**: Acts, Ubik, Spirit, Form, Plato, Advent, World, Parmenides, Only, Time, Could, Reality, Empedocles, Divine, Part, Another, Through, Real, Upon, True, Would, Other, Were, Very, Human, Right

---
### Line 12142-12150 (Match: 'Aristotle')
**Folder**: book has

```text
3) Therefore - ?? A) its actually cAD70, B) Rome won out over exoteric above ground Xtianity, but a secret underground true church, unsuspected, still collapsed. D) Negative hallucination - Christ returned + accompanying this event the Xtians won. (Note: D + B are mutually exclusive). E) It's a fight between (B) + (D), + our world is the arena.

aw fuck it.

I offer again the 3 layer or "two secret truths" theory. B + D are both true. But D is more true than B. As I a long time ago said, we are going to have to deal with propositions that are both true + not true simultaneously. Along these lines, (B) lost (D). Down with Aristotle's logic.

Tied in with the defeat (sic) of the cross is the defeat of authentic xtianity vis-a-vis Rome which is a success. Defeat = victory. That's the only answer - lass mich ruhen Christ won by being defeated. Because

Last edit over 4 years ago by sekennedy62
```
**Co-occurrences**: Christ, Christian, Rome, Christianity, These, World, Because, Therefore, Only, Time, Again, Both, Being, Still, More, Church, Ground, Actually, Secret, True, Have, Cross, Answer

---
### Line 13992-14000 (Match: 'Aristotle')
**Folder**: folder 02
...
folder 02 - 031
the USA 1974, therefore it is irreal. 2) Acts irrupted into it, displacing it 3) Therefore Acts is real, the Dinge-an-sich, or, boiled down to Aristotle's 2-value logic: 1) If there are two worlds, one must be real (i.e. only one can be real) + the other false. (irreal) This is palpably faulty; viz: because 1) Both could be real, equally so, or: 2) Both could be false (irreal). Equally so. Had I not seen the vast interface brain Zebra + its messages I'd have to choose (1), because if I didn't I'd have to deny reality to everything but myself; however, I did see the vast brain + its traffic of living info. So I select (2) as more probable, + designate Zebra as the truly real. (To avoid one very blatant error, that of reasoning that I regressed to a former - ancient - incarnation + world, let me point out: 1) He + his world came here; I didn't regress anywhere + 2) We have no proof of reincarnation anyhow. This line of argument presumes former lives (cf. Lucretius on the fallacy of this). Better evidence, even is: 1) The two worlds were syntonic: could be readily blended into one Gestalt with dual aspects 2) I didn't remember: I saw, + was (Thomas). I have abundant evidence that Thomas is someone else, not me, in my head [...]

Last edit over 9 years ago by Toso
folder 02 - 032
Complete
```
**Co-occurrences**: Acts, Toso, Thomas, Zebra, Complete, However, World, Because, Therefore, Only, Folder, Even, Gestalt, Could, Anyhow, Both, Reality, Everything, Toso
Folder, Brain, More, Living, Real, Other, Were, Very, Have, Info, Remember, Someone

---
### Line 14531-14539 (Match: 'Aristotle')
**Folder**: part in
...
Folder, Those, Part, More, Paracelsus, Jung, Another, Star, Most, Heaven, Wars, Things, Body, German, Magic, Human, Free, Until

---
### Line 21501-21509 (Match: 'Aristotle')
**Folder**: part of
...
Needs Review
144
for Then can it be said that in apprehend Ubik + Valis I have come in contact with another non-physical more real, sentient universe? Which is involved in peculiar way with our own [physical a one). It's more than the rational invading s the irrational; it's the real "invading" the irreal - which fits with the acosmism of my 27 years of writing. Again. "Ubik" The correct model: is 1) Their entropic world isn't real. 2) Ubik, anti-entropic, is. the two interact, somehow, upon dying, the chip sees them as distinct (set to ground?) the convulsive, metasticizing worlds which I write about are the physically substantive one deprived of the upper. I separated the two, + was rewarded in 3-74 by seeing -not this lower one - but the upper, whose existence I did not suspect except in "Ubik"! I dissected the universe + found to my surprise two universes! (no human can know if a natural law is suspended because we don't have a full or perfeet knowledge of "natural law" The most important aspect of the domain is teleological cause. In of natural law fact what aristotle called "final cause" was just an awareness of purpose in the domai we now call natural law

Last edit almost 3 years ago by svayambhu108
145
Needs Review
```
**Co-occurrences**: Valis, Ubik, World, Because, Just, Again, Their, More, Another, Most, Ground, Real, Upon, Universe, Somehow, Have, Except, Knowledge, Upper, Human, Lower, Chip, Final

---
### Line 21876-21884 (Match: 'Aristotle')
**Folder**: book about

```text
Each proposition endlessly generatses its mirror opposite: the dialectic which I saw - as in "the man who"

1. "we are in the prison" } 2. "we are in the Garden"

The 2-Brained logic brings you into contact with the well-springs of the [true?] dialectical logic of reality, & away from Aristotle & his phony hypostases.

The ethical nature of the [Xtlan?] problem - solving system puts it in touch with the order known as Ma'at, an ultimate principle.

The [Venux?] response shows: it can act act on both at once, without choosing one proposition over the other. Utilizing both brains, [ideation?] in me, [motn?] in the others, but how it
```
**Co-occurrences**: Well, Prison, Garden, Once, Both, Reality, Without, True, Other, Dialectic

---
### Line 22336-22344 (Match: 'Aristotle')
**Folder**: part of

```text
The importance of this: God himself is even more vast than I had previously realized. & it recalls Xenophanes' statement, "One God there is, who by the thought of his mind wields all things.” It gives me a deeper conception of him, if VALIS was just an effect. & it was this that came to my rescue! A mere expression of his will.

--

The whole thrust - basis - of my 3-74 experiences of VALIS has to do with what Aristotle called final cases or teleology. What does it mean if you see teleology operating in intimate nature? It obviously points to purpose which points to a mind which has both intention, implying plan & knolwedge, & the power to "stimulate": (2) He (Aristotle) did hold that change & order needed explanation. God is the transcendent unmoved mover who causes change & also stimulates the world & all its parts to achieve proper goals. This unmoved mover causes change & inspires goal seeking without himself undergoing any changes. "(1)" Aristotle held that the existence of the world did not require any reference to a transcendent or ultimate power.”* EB

This fits exactly what I experienced. Aristotle held that god, the prime mover, was/is immaterial & did not occupy space.

* This is contrasted to the JewishChristian view of God the creator of the universe. I always ^thought that Aristotle’s "prime mover" was primary in time before the universe created it. But I see what he experienced as god as prime mover is exactly what I experienced in 3-74.
```
**Co-occurrences**: Valis, World, Time, Mind, Even, Does, Just, Both, Obviously, Himself, Without, Creator, More, Xenophanes, Before, Universe, Will, Things, God Himself, Final

---
### Line 22338-22346 (Match: 'Aristotle')
**Folder**: part of
...
Last edit 16 minutes ago by Gabriel Mckee
```
**Co-occurrences**: Valis, World, Time, Gabriel, Mckee, Gabriel Mckee, Mind, Does, Both, Obviously, Himself, Without, Creator, Before, Universe, Final

---
### Line 22340-22348 (Match: 'Aristotle')
**Folder**: part of
...
Complete
```
**Co-occurrences**: Valis, Complete, World, Time, Gabriel, Mckee, Gabriel Mckee, Mind, Does, Both, Obviously, Himself, Without, Creator, Before, Universe, Final
