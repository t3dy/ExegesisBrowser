...
### Line 6160-6168 (Match: 'Star Wars')
**Folder**: part but
...
```
**Co-occurrences**: Christ, Zebra, Rome, Kingdom, King, Empire, World, Time, After, Black, Eldritch, Palmer, Palmer Eldritch, Those, Another, Star, Such, Would, Other, Mission, Were, Wars, Back, Have, Evil

---
### Line 6172-6180 (Match: 'Star Wars')
**Folder**: part but
...
```
**Co-occurrences**: Like, Only, Even, Could, Just, Something, Once, Again, Luke, Nothing, More, Star, Such, Voice, Actually, Before, Will, Were, Wars, Many, Things, Body, Remember, Magic

---
### Line 6180-6188 (Match: 'Star Wars')
**Folder**: part but
...
Last edit over 4 years ago by Kfischer
```
**Co-occurrences**: Well, Perhaps, Like, Only, Time, Once, Luke, Although, Himself, Those, Another, Star, Nonetheless, Voice, Other, Were, Wars, Back, Beyond, Under, Have, Wise, Neither, Evil, Remember, Government, Greater

---
### Line 6198-6206 (Match: 'Star Wars')
**Folder**: part but
...
6
```
**Co-occurrences**: Christ, Complete, Rome, Bible, Roman, World, Iron, Only, Time, Nixon, Stigmata, Book, Even, Does, Both, Reality, Luke, Daniel, More, Star, Babylon, Voice, Upon, Death, Will, Wars, Have, Government, Dead, Evidently

---
### Line 6203-6211 (Match: 'Star Wars')
**Folder**: part but
...
```
**Co-occurrences**: Christ, Tears, Ubik, Empire, Maze, Advent, World, Fall, Only, John, Time, Faith, Stigmata, Book, Reality, Frolix, Deus, Dokos, Another, Star, Real, Secret, Irae, Finally, Will, Other, Wars, Have, Life, Evil, Remember, Except, Knowledge, Deus Irae, Truth, Dream, Baptist

---
### Line 6205-6213 (Match: 'Star Wars')
**Folder**: part but
...
---
### Line 6207-6215 (Match: 'Star Wars')
**Folder**: part but
...
---
### Line 6213-6221 (Match: 'Star Wars')
**Folder**: part but
...
Needs Review
```
**Co-occurrences**: Valis, Christian, Ubik, Kingdom, Empire, Maze, Perhaps, Maybe, World, Iron, Prison, Only, Time, Earth, Black, Faith, Stigmata, Savior, Good, Even, Joint, Just, Kingdom of God, Maya, Reality, Eldritch, Black Iron Prison, Palmer, Frolix, Palmer Eldritch, Dokos, Their, Star, True, Will, Would, Were, Wars, Back, Have, Wise, Evil, Truth, Iron Prison

---
### Line 6219-6227 (Match: 'Star Wars')
**Folder**: part but
...
Needs Review
8
Perhaps if my "it's all dokos" theme has any real value, it has such because the true reality is precisely as I saw it in 3-74: we are slaves in the prison of an* evil city ("Imperial"). When I make people question the reality of the [phenominal?] world I open up the way for them to cease to wear blinders, to wake up and see their true lot - because [only?] if they can see the Black Iron Prison are they going to rebel. "Star Wars" makes no [ultimate?] to claim or show Earth as 1) One of the planets in thrall to the [empire?] 2) How we are deluded into not knowing this 3) That such as Ubik is informing us and 4) We must - or did already - rebel

Someday I will learn if what I did [vis-a-vis?] the [xerox letter?] was in itself an act of rebellion or my rebelling had previously occurred (ie the writing, the ramparts thing) and 3-74 was to protect me. I think more was involved than just to protect me: I think a crucial blow (as in "Star Wars" a well-aimed torpedo was released) I think I nailed someone - evil.

One fascinating thought: It is the dokos. the deception, which keeps us from realizing the "Star Wars" isn't fiction but is true. However, perhaps "Star Wars" [resonates?] on a subliminal level.
```
**Co-occurrences**: Ubik, Xerox, Well, Empire, However, Perhaps, World, Because, Iron, Prison, Only, Earth, Black, Just, Reality, Black Iron Prison, Dokos, Their, More, Star, Real, Such, True, Will, Wars, Evil, Iron Prison, Someone

---
### Line 6221-6229 (Match: 'Star Wars')
**Folder**: part but
...
---
### Line 6223-6231 (Match: 'Star Wars')
**Folder**: part but
...
---
### Line 6237-6245 (Match: 'Star Wars')
**Folder**: Unknown
...
Needs Review
```
**Co-occurrences**: Christ, Brahman, Empire, Once, Those, Still, Star, Through, Living, Real, Voice, Upon, Secret, Death, Wars, Justice, Evil, Dead, London, Someone

---
### Line 6297-6305 (Match: 'Star Wars')
...
Needs Review
```
**Co-occurrences**: Tears, Acts, Ubik, Brahman, Maze, Advent, World, Therefore, Time, After, Stigmata, Book, Even, Could, Joint, Does, Again, Kosmos, Divine, Frolix, Those, Another, Star, Phil, Through, Real, Such, Dick, Certainly, True, Will, Would, Were, Wars, Have, Information, Info, Truth, Dream, Phil Dick

---
### Line 6315-6323 (Match: 'Star Wars')
**Folder**: book covers
...
Needs Review
```
**Co-occurrences**: Christ, Valis, Ubik, Zebra, Logos, Sophia, Well, Maze, Wisdom, World, Since, Fall, Prison, Only, After, Good, Book, Even, Does, Look, Reality, Everything, Frolix, Still, Part, More, Star, Babylon, Voice, Universe, Wars, Beyond, Have, Things, Info, Right, Track

---
### Line 6321-6329 (Match: 'Star Wars')
**Folder**: book came
...
21
```
**Co-occurrences**: King, Empire, However, Maze, Like, World, Iron, Prison, Only, After, Black, Cosmic, Stigmata, Savior, Book, Light, Realm, Reality, Luke, Kosmos, Being, Black Iron Prison, Great, Anamnesis, Those, Dokos, Their, Star, Through, Metz, Real, Such, Voice, True, Death, Will, Were, Wars, Under, Evil, Greater, Iron Prison, Right, Someone

---
### Line 6326-6334 (Match: 'Star Wars')
**Folder**: book came
...
Needs Review
```
**Co-occurrences**: Rome, Only, Time, Could, Does, Look, Once, Realm, Suppose, Reality, Being, Although, Eldritch, Palmer, Palmer Eldritch, Dokos, Star, Real, Such, Would, Other, Were, Wars, Have, Things, Unless, Knowledge, Answer

---
### Line 6368-6376 (Match: 'Star Wars')
**Folder**: book came
...
Needs Review
```
**Co-occurrences**: Christ, Valis, Tears, Christian, Zebra, Xerox, Empire, Lord, Like, World, Iron, Prison, Time, Nixon, After, Black, Savior, Good, Book, Could, Just, Luke, Although, Eldritch, Black Iron Prison, Palmer, Anamnesis, Palmer Eldritch, Their, Star, Before, Death, Will, Would, Somehow, Were, Wars, Meanwhile, Have, Memory, Evil, Remember, Iron Prison, Free

---
### Line 6374-6382 (Match: 'Star Wars')
**Folder**: book came
...
Needs Review
```
**Co-occurrences**: Christ, Christian, Rome, Empire, World, Prison, Time, After, Good, Even, Something, Once, Again, Suppose, Both, Being, Himself, Probably, Still, More, Another, Star, Babylon, Certainly, Secret, Before, Zoroastrianism, True, Will, Wars, Have, Government, Final

---
### Line 6902-6910 (Match: 'Star Wars')
**Folder**: part of
...
Indexed
```
**Co-occurrences**: Christ, Tears, Acts, Christian, Toso, Indexed, Xerox, Sophia, Satan, Empire, Like, World, Because, Therefore, Only, St Sophia, Okay, Could, Both, Being, Missive, Xerox Missive, Part, Star, Living, Real, True, Will, Other, Creation, Wars, Have, Evil

---
### Line 9653-9661 (Match: 'Star Wars')
**Folder**: part of

```text
46
Why AD 70 + the fall of the temple at Jerusalem represents the last moment in actual history? It [..] the final victory + hence coming into total being of the imperial BIP - which has never changed since. It marked the moment of completion of the template: i.e. its victory. After that, nothing changed, that is where we are now. Everything since is seeming. But - wasn't a real blow dealt it in 1974? Didn't ZEBRA intervene not against the veiling hologram but the reality of the prison itself? Yes. Has it done so before? I think so - periodically (e.g. the Protestant Revolt, the American Revolution, etc➀). The Imperial Empire has a foe. Is the foe - ZEBRA - winning? It wins temporarily, but the BIP reasserts itself, like a cancer.

➀ Nevsky, Star Wars, Palmer Eldritch - the slotted eyes the visage of iron I saw in the sky.

The BIP has a build-in system of replication: to defeat one of its pluriforms you must become (like) it, hence the older pluriform dies + is resurrected in the new, hopefully (on its part) stronger than ever. This process escapes the awareness of the attacker, who do not understand that all pluriforms are printouts from the archetypal matrix + have a kind of life. The BIP thrive on attackers who imitate (hence replicate) it. This is how it endures, + even grows. Nor does the old pluriform understand what it is doing, except in rare cases: viz: when Hitler said, "the victory of Fascism is that it forces its enemies to become like it." Indeed Fascism has done this successfully, sporified, so to speak. It is like a malignant life form which proliferates. The nature of it is to concentrate + consolidate power at its center, whereas its opponent stands at the fringes. It is almost as if centrifugal + centripetal forces are at work opposing each other. The BIP's resurrection is like a parody of Christ's; both appear immortal.

Last edit about 5 years ago by sekennedy62
```
**Co-occurrences**: Christ, Zebra, Form, Empire, Like, Since, Fall, Iron, Prison, After, Even, Does, Both, Reality, Being, Everything, Eldritch, Palmer, Palmer Eldritch, Nothing, Part, Star, Real, Before, Other, Wars, Have, Life, Except, Whereas, Final
