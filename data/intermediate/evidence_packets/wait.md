...
Complete
```
**Co-occurrences**: Complete, Bible, Like, Nixon, Good, Anyhow, Zebrapedia, Just, Something, Look, Tessa, Dick, Universe, Will, Other, Page, Erasmus, Have

---
### Line 314-322 (Match: 'Wait')
**Folder**: book as
...
```
**Co-occurrences**: Complete, Like, Only, Book, Being, Runciter, Still, Star, Heaven, Ground, Voice, Actually, True, Universe, Would, Whatever, Have, Claudia, Spring, Except, Dream, Until

---
### Line 333-341 (Match: 'Wait')
**Folder**: book as
...
```
**Co-occurrences**: Kingdom, These, Only, Even, Could, Look, Maya, Reality, Zagreus, Being, Anamnesis, Those, Their, Star, Real, Voice, Will, Would, Kingship, Back, Things, Life, Body, Spring, Dead, Suddenly, During, Answer, Until

---
### Line 813-821 (Match: 'Wait')
**Folder**: part segment
...
```
**Co-occurrences**: Form, Well, Lord, These, Perhaps, Elijah, Father, Like, Since, Prison, Only, Time, Harpax, After, Even, Could, Just, Look, Once, Reality, Being, Although, Everything, Great, House, Without, Those, Their, More, Most, Before, True, Messenger, Death, Finally, Will, Would, Were, Back, Beyond, Under, Many, Have, Journey, Judgment, Life, Dark, Suddenly, Human, Evidently, Free

---
### Line 1325-1333 (Match: 'Wait')
...
```
**Co-occurrences**: Christ, Logos, Jesus, Kingdom, Felix, Satan, Parousia, Perhaps, Advent, Father, Maybe, Since, Only, John, Time, Harpax, After, Savior, Good, Book, Gospel, Could, Does, Pinky, Something, Both, Being, Jesus Christ, Although, Everything, Himself, Bacchae, Without, More, Real, Nonetheless, Certainly, Secret, True, Easter, Will, Would, Hamlet, Kingship, Very, Campbell, Have, Journey, Life, Absolute, Body, Truth, Whereas, Until, Grail

---
### Line 1426-1434 (Match: 'Wait')
**Folder**: Unknown
...
```
**Co-occurrences**: Christ, Form, Well, Maze, Perhaps, Maybe, Like, World, Because, Only, Time, After, Good, Light, Could, Anyhow, Just, Something, Look, Again, Reality, Being, Self, Himself, Anamnesis, Grace, Those, Still, Most, Nonetheless, True, Death, Universe, Finally, Would, Very, Surely, Many, Have, Clearly, Life, Body, Having, Remember, Cross, Dead, Answer

---
### Line 1575-1583 (Match: 'Wait')
**Folder**: book COSMIC
...
Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Christian, Form, Fish, Golden, These, Maybe, Like, Golden Fish, Time, Harpax, After, Light, Anyhow, Once, Everything, Great, Jewish, Still, Through, Ground, Finally, Would, Back, Under, Have, Life, Unless, Lower, Right

---
### Line 1924-1932 (Match: 'Wait')
**Folder**: part left
...
```
**Co-occurrences**: Christ, Tears, Spirit, Holy, Holy Spirit, Form, Sophia, King, Bible, Parousia, Golden, Wisdom, These, Perhaps, Elijah, Like, World, Fall, Time, Earth, Garden, Book, Light, Could, Hebrew, Just, Something, Again, Both, Reality, Being, Obviously, Everything, Platonic, Great, Part, Another, Most, Real, Voice, Certainly, Before, Revelation, Finally, Will, Would, Mission, Were, Back, Tree, Life, Spring, Remember, Unless, Knowledge, Truth, Dream, Evidently, Until

---
### Line 2915-2923 (Match: 'Wait')
**Folder**: part our
...
Needs Review
```
**Co-occurrences**: Christ, Christian, Spirit, Rome, Christianity, Form, These, Perhaps, Advent, Godhead, World, Since, Because, Only, Time, Nixon, After, Cosmic, Faith, Savior, Platonism, Good, Mind, Even, Just, Both, Reality, Being, Although, Self, Gods, Nothing, Their, More, Through, Flux, Actually, Revelation, Universe, Will, Would, Other, Angel, Very, Back, Many, Have, Things, Absolute

---
### Line 3461-3469 (Match: 'Wait')
**Folder**: part of
...
276
```
**Co-occurrences**: Christ, Christian, Spirit, Holy, Xerox, Holy Spirit, Well, Roman, Elijah, Since, Only, Even, Could, Soviet, Something, Being, March, Either, Probably, Without, Nothing, Those, Still, Their, More, Another, Real, Such, Actually, Certainly, True, Will, Would, Other, Were, Back, Whatever, Roogna, Have, Things, Fake, Info, Later, Days, Except, Knowledge, Elisha, Suddenly, Dream, Doesn, Right, Someone, White

---
### Line 4062-4070 (Match: 'Wait')
**Folder**: part could
...
Needs Review
```
**Co-occurrences**: Acts, Xerox, Satan, Because, Mind, Light, Just, Once, Maya, Being, Grace, Through, Such, Love, Before, True, Finally, Deity, Were, Back, Have, Clearly, Things, Life, Dark, Memory, Evil, Remember, Unless, Karmic, Right

---
### Line 4205-4213 (Match: 'Wait')
**Folder**: part of
...
61
61 purpose of the anamnesis) to save one spiritually, I am surer; to usher (bring) me into the corpus Christ, which He must believe is where I belong: to grant me peace + rest in What I most want: return to him ("that I might live in him / invisible + dim"). To save me in an ammediate practical sense (ie the authorities, re the Xerox letter). Probably my many intuition, a bout the Xerox letter are all correct the focus should be on the Xerox letter; I was in physical + spiritual seopardy from it, +: it was part of the great blueprint, the plan something I could do, if helped, + couldn't if not helped. Wait - I think all this is incorrect, startion with ( on p. 89. They are my memorie, since the 1st Advent is in an eternal now (not just 1900 yeas ago) that was my big breakthrough + it slipped right bad out it my mind: God thing I grote it all down. I experienced it as of the veral equinox of 1974 + the experience (memory) was/is authentically mine (needed no other personality). What I've done from ( It on is come up with another + very elaborate them. actually although it makes sense it is unnecessary. What was done was: my primordial faculties, as described by calvin. Were temporarily restored; hence I experienced the first Advent as happening now, since it is now; also I could distinguish the outlines of Christ or God + the plan, conversed with God, + experienced the immortality of my soul + saw the division of the world into The 2 worlds augustine depicted, + lots else besides. But the fundamental experience of the advent was an experience into + of the depths - the deepest layers - it reality (as was remem bering my true self + externally, seem God). It is all a move. ment deeper + deeper into internal + external reality beneath the surface skin of each, to the realm of absolute forms. The "Roman world" is right here always, perpetually renewing itself, +, at as aven deeper level, the Logos weaving the causal threats.

Last edit almost 3 years ago by svayambhu108
62
Needs Review
```
**Co-occurrences**: Christ, Logos, Xerox, Form, Roman, Advent, World, Since, Mind, Could, Just, Something, Realm, Reality, Although, Self, Corpus, Great, Augustine, Probably, Anamnesis, Part, Another, Soul, Most, Actually, True, Calvin, Other, Were, Very, Many, Absolute, Memory, Right

---
### Line 4489-4497 (Match: 'Wait')
**Folder**: part of
...
it stands complete,+ therefore, I experienced, it travels backward + creates itself Backward (in reverse, retrograde sequence, the way the writer of a mystery novel writes backward), it does not travel backward to the Alpha (starting) point, + begins there in normal forward linear time sequence; it does not have to wait until it gets bad all the way to the start - it can better do it retrograde since this assumes omega, the outcome,+ also it baffles the blind forward - moving creator - they work in opposite directions + the forward moving one can't figure out what is going on + how to thwart it (since the wisdom entity possesses absolute foresight + hence always knows at any give instant which is the best possible play (arrangement) at that stage (it is obviously limited to + bound by the obtaining conditions at that - at any - given stage; this is why we perceive it as arranging only, not creating - how can it create if it is moving backward?

In view of its intentions -+ direction of movement - it is easy to see how it could readily act to extricate the oppressed; it is continually bettering conditions in terms of justice, truth, freedom, righteousness + joy.

It, too, would assume a forwarding quality, of anticipating evil bondage rather than [receving?] it after it occurs; thus much of the salvific work it does would never be perceived by us, since the malign conditions would be aborted - never be.
```
**Co-occurrences**: Complete, Wisdom, Since, Therefore, Only, Time, After, Could, Does, Obviously, Creator, Would, Have, Absolute, Justice, Freedom, Evil, Truth, Until

---
### Line 4703-4711 (Match: 'Wait')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christian, Holy, Zebra, Xerox, King, Perhaps, World, Time, Good, Gospel, Just, Realm, Being, Self, Himself, Great, Probably, Deus, Without, Still, Phil, Real, Dick, Certainly, Before, True, Irae, Will, Would, Were, Very, Have, Life, Days, Evil, Deus Irae, Phil Dick, Final, Until

---
### Line 4894-4902 (Match: 'Wait')
**Folder**: part was
...
Needs Review
```
**Co-occurrences**: Xerox, Kingdom, Golden, These, Advent, World, Because, Time, Garden, Just, Both, Being, Although, Great, Without, Part, Through, Before, Will, Would, Were, Back, Have, Life, Apparently, Having, Karmic, Evidently, Final, Track, Until

---
### Line 5398-5406 (Match: 'Wait')
**Folder**: part of

```text
From a psychological standpoint the above is all true. The "metabolic toxin" did not continue on to destroy other, valuable psychic contents after having done its job. (Which would have reduced me to deteriorated schiz. simplex or hebe, etc.) The overvalent idea (delusional complex) that the FBI was persecuting me was literally dissolved in a short, absolute take-over of my consciousness by archetypal contents of my collective unconsc.

Viewed this way it can be said: when the paranoiac paradigm actually manifested itself (in the form of the Xerox letter -
...
```
**Co-occurrences**: Xerox, Form, Because, John, After, Gabriel, Mckee, Gabriel Mckee, Anyhow, Viewed, Part, Actually, Before, True, Would, Other, Have, Absolute, Days, Having, Free

---
### Line 5872-5880 (Match: 'Wait')
**Folder**: part of
...
16
It redemptive entity remains silent; you must make the initial choice. In a sense so choosing constitutes a sue generis moment - something near not merely the result of efficient causes; such an event is in itself a miracle, for where did it come from? How did it arise! The practical consequences are disasterous + lethal. Nothing practical b acheived. Why is it done? The person delivers himself over to total ruin, + for what? No one told him to. No one thanks him or admires him. His career, his life, his future are destroyed. It is impossible to trace his act back (as effect) to some cause. The understanding which informed him was a residual spark of a once - divine nature, long forgotten, but by what he has done he has identified himself to the celestial powers, which seems be what this place is all about (cf N.T. parables). If I am right that one must disclose one's divine origin (hence nature) by such an act, before the celestial powers can identify you out of the mixture, then it is possible to construct a rationale for God intervening in his own system (world). The initial sui generis act of balking (or whatever) signals the celestial power + it responds. This unfolding strip is indeed a closed system But there are, living within it, persons who came here from a higher realm, forgot, who, like straying sheep must be or can be found- identified. Upon such identifi lation they are made recipients of divine grace" which is to say, intervention into the closed system. The process of extrication itself has begun. It does not wait for the after-death reward - existence. All that is asked for (oneeded. is for the person to identify himself. This answers all manner of questions about predestings i, who will be saved, faith vs good works, etc., + also how such questions (issues) arose at all. There has been a general intuition that you had to do or be something to get saved something from you was required, but what? The JWs seem have come the closest, also the quakers, to oe

Last edit almost 3 years ago by svayambhu108
17
Needs Review
```
**Co-occurrences**: Like, World, After, Faith, Good, Does, Something, Once, Realm, Divine, Himself, Grace, Nothing, Living, Such, Upon, Before, Death, Will, Back, Whatever, Have, Life, Right

---
### Line 7192-7200 (Match: 'Wait')
**Folder**: book of
...
Christ "returns" but only because archetypal sacred time is reached by those for whom he is the paradigm. We cannot discourse with Holy Wisdom (in these cyclic space-time) reprises; for that we must await the 2nd incarnation prophecies. The role of the sufferer and the helper are him but the conscious psyche of of him evidentally is missing: we have the enacted drama but cannot colloquite with the central figure (the voice whicch Elijah heard). For that we must still wait: it is not the consciousness of Christ that is here but the dramatic figure only. But he is here. Yet not yet reborn psychologically; he is self-unaware, and must be awoken to his own identity (in us). Is this what Thomas was- a partical reawakening of Him to Himself (Christ) so that for a little while he remembered and knew hiself as He is (as in Van Vogt's "The book of Ptath") and this reawakening is what modern world history- and suffering and helping- leads us towards, point [omega symbol]? The presence is here, but the voice of silent, for it has forgotten.

--

ah- the C. AD 70 is becoming progressively more red and the 1937 one is fading.
```
**Co-occurrences**: Christ, Thomas, Holy, Wisdom, These, Elijah, World, Because, Only, Time, Holy Wisdom, Book, Self, Himself, Those, Still, More, Voice, Have, Ptath, Sacred
