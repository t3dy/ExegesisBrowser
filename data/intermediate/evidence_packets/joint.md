...
```
**Co-occurrences**: Ubik, Form, Gnostic, Like, World, Only, Time, Good, Yang, Tessa, Soul, Before, Universe, Will, Would, Other, Were, Very, Claudia, Spring, Memory, Form One, Blood, Dream, Chip

---
### Line 1902-1910 (Match: 'Joint')
**Folder**: part left
...
```
**Co-occurrences**: Logos, Form, Kingdom, Well, These, Maybe, Like, World, Parmenides, Because, Only, Time, Harpax, Garden, Light, Could, Does, Once, Reality, Kosmos, Heraclitus, Being, Self, Everything, Without, Brain, Still, Through, Most, Ground, Real, Such, Voice, Upon, Actually, Before, Mother, True, Universe, Very, Back, Beyond, Have, Things, Justice, Memory, Having, Truth, Magic, Right, Until

---
### Line 2797-2805 (Match: 'Joint')
**Folder**: Book of
...
Last edit almost 5 years ago by svayambhu108
```
**Co-occurrences**: Christ, Christian, Holy, Rome, Christianity, King, Well, Parousia, Wisdom, These, Advent, Father, Like, World, Time, Nixon, Holy Wisdom, Good, Yang, Could, Just, Something, Taoism, Again, Suppose, Reality, Empedocles, Himself, Great, Bacchae, Probably, Nothing, Kathy, Their, Such, Love, Greece, Would, Other, Hamlet, Were, Back, Whatever, Evil, Remember, Cross, Dialectic, Dead, Otherwise, Dream, Lamb, Right, Answer, Until

---
### Line 3747-3755 (Match: 'Joint')
**Folder**: Book of
...
All those written pages and great important books I saw in dreams: the) contained sacred wisdom, which is to say, Haggia Sopnia, the Wisdom of God, which is returning# We rejected it before; this could either refer to Jesus, or even back, all the way to the beginning, in the Old Testament, where our ancestors wouldn't take God's advice (i.e. His sacred wisdom). Evidently we will now get a second chance. (Perhaps the Greek medical advice I received is an example of this.) In fact, all the assisting I received in 3 74 consist of Haggia Sophia. Those were examples of St. Sophia, a code word for God's Sacred Wisdom which man has been deprived of, because man a long time and rejected it, according to our myths. So it was withdrawn and we were on our own, with disasterous results. If I ask what possessed me and guided me in actions, the answer is, Saint Sophia (we are told this is also the Logos). We are also told that Christ is/was the Losos. I have repeatedly said, "Some said: possessed me, but which saint?" Santa Sophia, evidently. (Again: hence the endless written pages and books, as well as what was spoken.) Well, then; I have a pretty good idea of what's in store for the world: what I experienced. A thirst for truth, justice, righteousness, and health. And understanding (wisdom in general). And, most of all, a direct colloquy with the Creator. Again. This agrees with the "3 ages" view: age of the Creator, age of Christ, and now we are in the age of the Holy Spirit which mean an internal relationship. Of great value in this realization is to understand that, as in my case, St. Sophia need not be born as an infant (human) physically and then mature over fifteen or twenty years; we're talking about an internal rebirth, as when we say, "Hope was reborn in him," there being no need of it progressing through growth stages finally to reach maturity; what is meant is that hope returned, as it once had been. Now, I am to my own certain personal firsthand knowledge the only person to whom this St. Sophia has come, it does not stand to reason that out of the 3 billion (?) people in the world it would come to me alone. I can reasonably assume (although it is just an assumption) that if it came to me (has come) then it came (has come) to others and probably a fair number of others. This, also, fits in with my conviction that the tyranny here in 74 and therefore the war in 75 was ended by the group action of people responding to divine prompting, in fact possibly the same as mine; these would be St. Sophia inspired and directed persons acting individually but in concert, which is reasonable, once the concept of St. Sophia "being reborn" is advanced. Would th_s not be what you would expect? Alone, even with this help, I, could not do much; joint human interaction is called for. The action assumes a social quality. Let's assume person A is motivated ("on impulse") to write to person B whom he'd ordinarily never think of writing to (e.g. me to the Wall Street Journal, or to Wiggins). Person B is then, "on impulse," seized with the next step directive. What if this explains the Xerox letter? That person was seized "on impulse" before I was; I was the person B to her/his A. We mean here a concerted network of activity, but toward ends none of the individuals can see.

Last edit almost 5 years ago by svayambhu108
307
Needs Review
```
**Co-occurrences**: Christ, Spirit, Holy, Logos, Jesus, Xerox, Holy Spirit, Sophia, Greek, Well, Wisdom, These, Perhaps, World, Because, Therefore, Only, Time, Good, Book, Even, Could, Does, Just, Once, Again, Being, Although, Divine, Either, Great, Probably, Santa, Creator, Those, Through, Most, Before, Santa Sophia, Finally, Will, Would, Were, Back, Have, Justice, Testament, Knowledge, Truth, Human, Evidently, Answer, Sacred

---
### Line 3794-3802 (Match: 'Joint')
**Folder**: Book of
...
Last edit almost 5 years ago by svayambhu108
```
**Co-occurrences**: Christ, Christian, Holy, Rome, Christianity, King, Well, Parousia, Wisdom, These, Advent, Father, Like, World, Time, Nixon, Holy Wisdom, Good, Yang, Could, Just, Something, Taoism, Again, Suppose, Reality, Empedocles, Himself, Great, Bacchae, Probably, Nothing, Kathy, Their, Such, Love, Greece, Would, Other, Hamlet, Back, Whatever, Evil, Remember, Cross, Dialectic, Dead, Otherwise, Dream, Lamb, Right, Answer, Until

---
### Line 4171-4179 (Match: 'Joint')
**Folder**: book which
...
56
```
**Co-occurrences**: Tears, Ubik, Rome, Christianity, Roman, Like, World, Time, Stigmata, Light, Could, Just, Both, Reality, Being, Divine, Probably, Greco, More, Through, Real, True, Other, Body, Fake, Except, Knowledge, Greater, Impostor, Dream, Doesn, Answer

---
### Line 4176-4184 (Match: 'Joint')
**Folder**: book which
...
56
8 Thus in "Joint" I begin to view the apparent world, this world, as dream (maya). Howear, "Joint" also says. He lives at a different time than the apparent time of the pseudo, fake construct world (i.e. I didn't once live in Rome C AD 70; I have been there really all this time; it is really c AD 70 [Kighs now). A conclusion I'm not prepared to accept. Just slightly after the first Advent, + awaition the seconds what if I abandon the concept of linear time entirely (deducting for my "Rome" experient that there is no such thing as linear time) + view this in terms of ontology - of varyin degrees of reality. Instead of saying that Roman (in more accurately apostolic time is more real than ours I say the authentic early Christions were as being, name here (than people of our time) + are transsubstantiating the universe (along some kind of orthogoral axis which not only con we not move along, but can't even see (imaging), Just as the form-regression, in Ubik force those people to adops another model of the universe, my layer-by-layer form regression (outer to inner, like onion layers, not back word) forces me to adduce another universe - model - probably Platonistic horic to de with levels of ontology: "the rocket ship really is" etc, + 1974 fullerton really is" etc. What possesses the greatest amonit of being is the first Advent. first d Advent "- lesser realms (points, or layers) t level.

Last edit almost 3 years ago by svayambhu108
57
Needs Review
```
**Co-occurrences**: Ubik, Rome, Form, Roman, Advent, Like, World, Only, Time, After, Even, Just, Once, Maya, Reality, Being, Probably, Those, More, Another, Real, Such, Fullerton, Universe, Were, Back, Have, Fake, Instead, Dream

---
### Line 5702-5710 (Match: 'Joint')
**Folder**: part of
...
6
```
**Co-occurrences**: Valis, Tears, Toso, Indexed, Spirit, Well, Bible, Perhaps, Like, World, Since, Time, Good, Even, Could, Anyhow, Both, Being, Self, Eldritch, Divine, Himself, Palmer, Corpus, Palmer Eldritch, Part, More, Real, Before, Deity, Would, Very, Have, Memory, Instead, Later, Trinity, Knowledge, Truth, Human, Answer

---
### Line 5707-5715 (Match: 'Joint')
**Folder**: part of
...
Indexed
```
**Co-occurrences**: Toso, Indexed, Spirit, Bible, Maybe, Like, World, Since, Time, After, Does, Anyhow, Again, Reality, Divine, House, Without, Another, Soul, Real, Actually, Revelation, True, Somehow, Very, Back, Beyond, Many, Have, Body, Dark, Fake, Information, Later, Dream

---
### Line 6213-6221 (Match: 'Joint')
**Folder**: part but
...
Needs Review
```
**Co-occurrences**: Valis, Christian, Ubik, Kingdom, Empire, Maze, Perhaps, Maybe, World, Iron, Prison, Only, Time, Earth, Black, Faith, Stigmata, Savior, Good, Even, Just, Kingdom of God, Maya, Reality, Eldritch, Black Iron Prison, Palmer, Frolix, Palmer Eldritch, Dokos, Their, Star, True, Will, Would, Were, Wars, Back, Have, Star Wars, Wise, Evil, Truth, Iron Prison

---
### Line 6297-6305 (Match: 'Joint')
...
Needs Review
```
**Co-occurrences**: Tears, Acts, Ubik, Brahman, Maze, Advent, World, Therefore, Time, After, Stigmata, Book, Even, Could, Does, Again, Kosmos, Divine, Frolix, Those, Another, Star, Phil, Through, Real, Such, Dick, Certainly, True, Will, Would, Were, Wars, Have, Information, Star Wars, Info, Truth, Dream, Phil Dick

---
### Line 6303-6311 (Match: 'Joint')
**Folder**: book helps
...
Needs Review
```
**Co-occurrences**: Tears, Ubik, Rome, Maze, Scanner, World, Iron, Prison, Only, Time, Black, Stigmata, Garden, Book, Light, Even, Could, Just, Reality, Self, Black Iron Prison, Deus, Another, Through, Real, Love, True, Irae, Finally, Further, Fake, Info, Having, Remember, Deus Irae, Truth, Impostor, Iron Prison

---
### Line 6309-6317 (Match: 'Joint')
**Folder**: book helps
...
Needs Review
18
N all there instances I've found of "divine" (Logos or Gnostic] truths (material) inserting in my writing - it's not inserted; this is just one elongated instance of the natural process of the orthogonal koinos thrusting up from withing below, such books as "Ubik" being both instances of + accounts about the upward thristing which is going on - for me, the supreme moment arriving in 3/74: with my 5th chakra temporarily opened I could see it all going on: the real world transmuting this by abolishing the illusory (evil) + substituting the real (good). Evil is destroyed by renderely it illusory + hence abolishing if thereby Had my 3-74 experience occurse, I might suppose my 26 year writing - theme to be vain, empty + foolich. I now for the first time see my writing as half I + my 3-74 experience as half II of a total experience: a surmise + search - then, abruptly, a finding, as the veil lifted (even though briefly). What happened in 3-74 was that the real, the thrusting - therech world which I intuited, proved actually to be there, + not only that, to be accessible (under certain circumstances); not only could it be looked for, it could be found. Rome c AD 70 was nothing more or less than the persus + of "Maze." + this linear time world of 1974/9 AD proved to be nothing more than such pseudo worlds, taken to be real, as in "Ubik" "Joint," + "Maze" + "3 Stigmata." Yet, it has taken me literally years since 3-74 to see that as persusa is to Delmak-O, Rome c AD 70 is to us AD 1974. I never anticipated such a tremendous pay off (breakthrough), despite the fact that the corpus of my writing is a map, an analysis, + a guide. The 26years of writing, without 3-74, is a map of nothing, + 3-74, without the body of writing, is conceptually inexplicable.

Last edit almost 3 years ago by svayambhu108
19
Needs Review
```
**Co-occurrences**: Ubik, Logos, Rome, Gnostic, Maze, World, Since, Only, Time, Stigmata, Good, Book, Even, Could, Just, Suppose, Both, Being, Divine, Corpus, Without, Nothing, More, Real, Such, Actually, Under, Body, Evil

---
### Line 6397-6405 (Match: 'Joint')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christian, Ubik, Form, Roman, Maze, Like, World, Only, Time, Stigmata, Anyhow, Once, Again, Reality, Although, Santa, Anamnesis, Through, Living, Real, Secret, Consider, Will, Would, Were, Have, Berkeley, Fake, Memory, Remember, Except, During, Dream, Doesn

---
### Line 6403-6411 (Match: 'Joint')
**Folder**: part of
...
Needs Review
34
3 Jeters logic comes in here. Where he worked out a priori (logically) that it must really be only around 70 AD. (or else the scriptures are false.) (Where in fact the scriptures are the key, the door, to the true what is, in contrast to what is mere appearance.) We of the apostolic age - did we cease to stay awake? Contrary to the admonitions we fell asleep (as the Essenes put it, sank deeper into unconscious ness + unawareness) + dreamed, mutually, the linear time except for my writing (e.g. "Maze," "Ubik "3 dream. Stigmata," "Joint," etc) these concepts can't even be thought at all, even intellectually, let alone believed. did we program ourselves? Or is it the deceiver at work, our ancient foe"? I submit the following theory: that punched-through (or orthogonal) time creates a sort of vortex around which linear time circles, the way gravity warps the straight line (+, e.g. The trajectory of Light), into ultimately, a circle - which of the pull is great enough, cannot escape at all. The 1st Advent was such a punched-through center; although we continued to measme a straight or linear trajectory for time, if was in fact trapped in a circle, never escaping The events of the 1st half of the 1st century AD. This will happen again at the time of the 2nd Advent, but I say even this: the 2nd Advent, in relation to "circling" linear time, of necessity punch through - not thousands of years after Advent I but shortly thereafter - reinforcing Advent I into final + full fulfillment (e.g. the stone hured. The empire destroyed - + this is precisely what we saw in '74: the archetype "Babylon" destroyed. the exterior relieving column being the punching through hosts. This is really a stunning breakthrough, acheived by more carefully examining what is meant by the act of remembering. "He remembered who he was + what he was supposed to do." Past time is not involved

Last edit almost 3 years ago by svayambhu108
35
Needs Review
```
**Co-occurrences**: Ubik, Empire, Maze, These, Advent, Only, Time, After, Stigmata, Light, Even, Again, Being, Although, Great, Essene, More, Through, Babylon, Such, True, Will, Except, Dream, Final

---
### Line 6888-6896 (Match: 'Joint')
**Folder**: part of
...
```
**Co-occurrences**: Valis, Acts, Christian, Toso, Kingdom, Like, World, After, Mind, Does, Look, Kingdom of God, Reality, Kosmos, Part, Pyth, Secret, Illustration

---
### Line 8363-8371 (Match: 'Joint')
**Folder**: part of
...
Needs Review
148
139 "We see as by reflection in a metal Pan." Nothing short of absolute + total rectification is in processs There is really a baffling mystery here. Incredible paradoxes - they abound in the N.T. (all that "the first shall be the last" business). Whence arose our occlusion? (+ amnesia?) We are under an evil spell (curse) by a master magician (cf Klingsor). Not only is causality irreal (as I guessed 30 years ago) but everything is like - shit! like in "time out of Joint. Unreal universe! I'm going to opt for Gnosticism. We're being deceived, here, + only anamnesis can save us. It's all a hoax (except for true Xtianity, Pythagorianism, Orphism, etc). we are not free agents; we're part of a system, + are run by it. What I want to knowas: why is this fact concealed from us? (i.e. if it's benign - + the intervention in 3-74 certainly was one possibility: we are being observed (+ also taught-given lessons + problems), hence secretly judged. Like scientists watching children through a one-way mirror. yeah, I'm sure of it. evaluated, + probably for something yet to come. I'll bet were being judged, + the Cosmic Christ (i.e. Paraclete) is secretly helping us to do right, to move toward salvation + hence a return to God. We're cur‐ pently on probation. The puppet-strings are to aid us I (have) soccumbed (by 3-74) to the will of God, rather than my own. Is that bad? No Christ does not explain; he restores (i.e. understanding)

Last edit almost 3 years ago by svayambhu108
149
Needs Review
```
**Co-occurrences**: Christ, Christianity, Gnosticism, Like, Only, Time, Cosmic, Paraclete, Cosmic Christ, Does, Something, Being, Everything, Probably, Anamnesis, Nothing, Part, Through, Orphism, Certainly, True, Universe, Will, Were, Under, Have, Absolute, Evil, Except, Salvation, Free, Right

---
### Line 8796-8804 (Match: 'Joint')
**Folder**: part of

```text
invisibly invaded but is replicating or growing. It is an information plasma - vs an original info + faculty-destroying virus.

It bears a very strong resemblance to Ubik, which I put forth as the Logos. It is sentience pervading a mechanical structure, perhaps as a furthering of the Ur creation, shcih was + still is its job. It recreated me, Pinky, + nature objects + events, weaving us all together (into cosmos, out of chaos - animating us by its mind.

Am I saying that the basis of reality is words (or the word) (V John III), as in "Time out of Joint"? (eg. soft drink stand words = ideas = concepts, ideas in the mind (of God).

What I must remember about my 3-74 experience is that it actually was a 2-74 experience, having nothing to do with the CIA +/or the USSR or even Zebra. But seeing the Golden Fish sign + remembering. Electronic hanky-panky certainly was not involved in that; what was involved was a restoration to a superhuman state lost 1000s of years ago, inc. supernatural faculties.

Time is the key to the whole thing. + with it (ie its disappearance) there dissolves the illusary phenomenal world. Time + forgetfulness are somehow the same thing. Memory abolishes time (ie amamnesis) + hence abolishes illusion in some strange way. I don't understand, anamnesis actually restore (retrieves) the pas so that it is no longer the past - ie gone. This kind of memory has
```
**Co-occurrences**: Ubik, Zebra, Logos, Fish, Golden, Perhaps, World, Golden Fish, John, Time, Mind, Even, Pinky, Reality, Anamnesis, Nothing, Still, Actually, Certainly, Creation, Somehow, Very, Memory, Information, Info, Having, Remember

---
### Line 8855-8863 (Match: 'Joint')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Christian, Ubik, Zebra, Fish, However, These, Father, Like, World, Fall, Time, After, Noos, Stigmata, Book, Look, Both, Reality, Heraclitus, Everything, Either, More, Another, Through, Real, Back, Have, Tagomi, Dream, Track

---
### Line 8890-8898 (Match: 'Joint')
**Folder**: book is
...
36
```
**Co-occurrences**: Tears, Ubik, Form, Well, Maze, Perhaps, World, Gnosis, Only, Time, Mind, Even, Could, Look, Again, Reality, Being, Divine, More, Through, Real, Certainly, Revelation, True, Would, Other, Were, Have, Info, Remember, Electric, Except, Knowledge, Electric Ant
