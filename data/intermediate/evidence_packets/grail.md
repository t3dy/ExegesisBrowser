...
```
**Co-occurrences**: Tears, Jesus, Form, King, Maybe, John, Earth, Harpax, After, Good, Even, Both, Everything, Without, Still, Part, More, Another, Most, Such, Voice, Finally, Will, Other, Very, Back, Have, Things, Life, Wise, Later, Suddenly, Today, Comforter, Dream, Evidently, Right

---
### Line 1548-1556 (Match: 'Grail')
...
Needs Review
```
**Co-occurrences**: Christ, Time, Folder, Realm, Either, Grace, Through, Voice, Actually, Death, Universe, Parsifal, Would, Back, Life, Dialectic, Greater, Sacred

---
### Line 28135-28143 (Match: 'Grail')
**Folder**: part of
...
Needs Review
63
68 music is composed of -is - numbers Rightly, I seek beauty like Parsival sought the Grail - but what a price I pay. I don't write beautifulity - I just write reports about our conditing to go to those outside of (I'd pak. I am an anytyzer when I am attracted to marie laure (etc) I am attracted by God He takes this image to draw me along to my fulfillment, she is a way by which he appoachies me my wife. He wants me to go to france; hence marie Laure. But she is also part of the revolution shes how my efforts in the divine revolution are controlled (mainly; 3-74 was a unique crisis. The Xerox missive came from Soviet army intelligence nt KGB. They found weapons ideas in my writing! Intriqued; thought I was putting it into s-f novels as a code that I had was advertising + did super weapons. that I for s

Last edit almost 3 years ago by svayambhu108
64
Needs Review
```
**Co-occurrences**: Xerox, Like, Just, Soviet, Missive, Divine, Xerox Missive, Those, Part

---
### Line 39317-39325 (Match: 'Grail')
**Folder**: book which
...
to flee (which causes the maze to change + grow)? We can't. Something must enter from outside the maze to aid us. Something must remind us, awaken us, cause us to remember (the "legend of the Pearl"), + thus to see the maze frozen. {illustration of a maze} My vision. The template as map of the maze - Christ as map; Acts lens / grid as map. The Grail - the maze. The blood (plasmate) in the Grail speaks to us, giving us clues to remind us. Finding the Grail equals threading the maze; when you thread it [successfully] you reach -find!- the Grail; this is what finding the Grail is all about. + the blood -living information covert traffic- aids you (e.g. King Felix). Otherwise we go around + around forever. "Valis" is basically correct: maze, Grail, plasmate, living information, minds, instructions (help) fired to us from outside by Valis / Logos / Christ. Valis in my mind + in reality was Christ; in "Valis" I was right; he is here in the maze. These are the key terms: maze, we generate it by perceiving it, information from outside to give us clues, anamnesis, the blood of Christ speaking to us, the Grail, magic (!!), flight in / through time, the maze changing, the maze frozen, vertical motion (the 3 realms), Christ here camouflaged invading the maze to remind us (wake us up), time dilation, something entering from outside,

Last edit almost 8 years ago by Toso
folder 90 - 159
Complete
```
**Co-occurrences**: Christ, Valis, Acts, Toso, Indexed, Logos, Complete, King, Felix, Maze, These, Time, Folder, Mind, King Felix, Something, Reality, Toso
Folder, Anamnesis, Indexed
Folder, Through, Living, Illustration, Frozen, Information, Remember, Blood, Magic, Otherwise, Right

---
### Line 40219-40227 (Match: 'Grail')
**Folder**: folder 90
...
```
**Co-occurrences**: Valis, Christian, Ubik, Indexed, Holy, Jesus, Christianity, Sophia, Torah, Parousia, Maze, These, World, Time, Folder, Mind, Judaism, Pinky, Simon, Reality, Tony, Everything, Daniel, Deus, Indexed
Folder, Church, Through, Living, Actually, Mother, Easter, Irae, Death, Parsifal, Illustration, Erasmus, Berkeley, German, Information, Deus Irae, Truth, Magic, Magus, Simon Magus

---
### Line 40223-40231 (Match: 'Grail')
**Folder**: folder 90
...
```
**Co-occurrences**: Valis, Christian, Ubik, Toso, Holy, Jesus, Christianity, Sophia, Torah, Parousia, Maze, These, World, Time, Mind, Judaism, Pinky, Simon, Reality, Tony, Everything, Daniel, Deus, Church, Through, Living, Actually, Mother, Easter, Irae, Death, Parsifal, Illustration, Erasmus, Berkeley, German, Information, Deus Irae, Truth, Magic, Magus, Simon Magus

---
### Line 40241-40249 (Match: 'Grail')
**Folder**: folder 90
...
It's okay to believe because I know; I saw. I passed over to the other side. I recreated the past (in 2-74); I drew it back: {illustration: two boxes linked to one common box, probably symbolizing the meta-abstraction} - I broke the power of time in favor of meaning. I broke world, the power of delusion. It's all true; it has to do with organization in God's mind: the true ordering of reality. I have the key. I don't know it; I did it (2-3-74). It is Plato's anamnesis + recovery of the eide: the upper realm, Mens Dei, the MMSK. Acausality. Phylogons. Valis + the plasmate are the body + blood of Christ. The organizing "phylogon" is: intensity of meaning (not feeling but meaning. It acts as a perturbing warp. The power of the Grail + Christ's blood + Easter. "Roog" - this is a new way of seeing, but it is seeing as God sees. My Jungian intuitive organizing faculty enabled me to overcome time, space + causation in favor of meaning, which is how God sees. Hier in diesen fremden Land bin ich sogar tot; mein Leben war gestern, wie die Zeit geht; aber wie Bedeutung geht, leb' ich jetzt, das ewige Jetzt. Hore: if you do not understand this you will die like a rat in a gutter: Valis 3-74 was God. You know + experience but do not believe. The time has come to believe. There is no more that needs to be known. Plato to Augustine to Plotinus to Malebranche. This is enough.

Last edit over 7 years ago by Toso
folder 90 - 180
Indexed
```
**Co-occurrences**: Christ, Valis, Acts, Toso, Indexed, Plato, Plotinus, Like, World, Because, Malebranche, Time, Folder, Mind, Okay, Realm, Reality, Toso
Folder, Augustine, Probably, Anamnesis, Indexed
Folder, More, True, Easter, Will, Other, Illustration, Back, Have, Body, Jungian, Blood, Upper

---
### Line 40333-40341 (Match: 'Grail')
**Folder**: folder 90
...
dream opened up (last night like a door). I saw that the ambiance + the milieu, the time + place of the dream (I mean the "He lived a long time ago..." etc dream) is the same as the "lake" dream. I could see in my mind either Stanton or Lincoln, as if I were still dreaming it: the stove pipe hat, the beard, the type style + format of the newspaper. The mid-19th century USA, the Civil War. This was not a figuring out, a logical reasoning (last night); it was pure understanding (as when I got the info about Chrissy's birth defect). + it all came back because of Kitty's visit + the business about smuggling out those in Central America marked for death. I saw (last night) into the total world that the "lake" + "newspaper" dreams are doorways to. My associations were already there in my mind; they didn't occur last night: they surfaced, lightning fast: Lincoln - newspaper - "We print the truth" - Jesus - Torah - fantasy - F + SF - my writing career - Catholic church - music - 78s - Parsifal - Good Friday - the headline ("He lived a long time ago but is still alive" referring to Jesus - Lincoln - Quakers - freeing the slaves - the work of the revolutionary secret heretical sect of Xtians - wizards - wooden cradles - technology - the "magical" power of God - miracle - freedom versus slavery - I saw, I saw, + the "center" of it all from which everything else issues logically + by necessity (not just contingenity) is Tony Boucher ("wizards" refers to Ed Cartier + "Unknown Worlds" to technology disguised as magic, probably Celtic magic, hence "Parsifal" - the Grail - words - Torah - plasmate - the written pages that I saw in my dreams. Stanton - abolitionists). There is a deep meaning + logic to all this. What I am saying is that these two dreams refer elliptically + in a very disguised + cunning way to Tony. Not only

Last edit over 7 years ago by Toso

folder 90 - 191
```
**Co-occurrences**: Christian, Toso, Indexed, Jesus, Torah, These, Like, World, Because, Only, Time, Folder, Good, Mind, Could, Just, Catholic, Tony, Everything, Either, Probably, Chrissy, Indexed
Folder, Those, Still, Church, Secret, Death, Friday, Parsifal, Were, Very, Back, Freedom, Info, America, Truth, Magic, Dream

---
### Line 40389-40397 (Match: 'Grail')
**Folder**: part was
...
What is most remarkable is not just perceiving one's soul in + hence derived from the divine mind, but to see that soul as a complex of ideas, interacting to form a coherency: one's soul as something that can not only be known but also thought: soul, then as idea - + taking the form of ideas or subideas clustered together: reduced to or derived from what may in the final analysis be words. That's why the term "thing" is the wrong term. It is information. It is a unique intersection by one idea of another, a crossing, an ideational intersection: certain notions about freedom, magic, religious beauty (as expressed by the Grail theme + the Good Friday spell), revolutionary covert activity connected with elements of the Civil War, animals as they appear in children's books, something to do with the old-fashioned countryside + light, music, writing; but most of all a sense of the divine as if not only am I a notion in the divine mind but I as its notion contain in + as myself a notion of it. In other words I fade off into it, + it fades off into me, as if each is aware of + related to the other. The element of compelling assent now extends to my assent being compelled to recognition of my own existence, my own existence emanating from + conferred by the divine mind - which is another way of saying that when I at last discover my own existence as an objective thing I discover it in the divine mind as if awaiting me. I + that identity existed apart initially. (The issue, then, is one of the coming together of two halves to form an intact wholeness.) (As if one part was created here on Earth + is temporary; the other, existing in

Last edit over 7 years ago by Toso
folder 90 - 198
Complete
```
**Co-occurrences**: Toso, Complete, Form, Only, Earth, Folder, Good, Mind, Book, Light, Just, Something, Being, Divine, Toso
Folder, Part, Another, Soul, Most, Friday, Other, Information, Freedom, Magic, Final

---
### Line 41916-41924 (Match: 'Grail')
**Folder**: part of
...
251
1337 from antiquity. The present returns to the past like the hero in search of a precious Jewed (or the Grail), conquers the demon of madness (disorder, entropy) + returns with the treasure; the ancient type a psyche, which is needed as the other constituent for Ditheon (Godhood). the B psyche is in search of its own prior [now] lost self; hence anamnesis is essential. + it is precisely this prior lost self that provides the completeness that is Ditheon: the goal (retrieving A, the prior lost self, is The means to the goal). Hence the expression "salvator salvandus" correctly describes this process: all 3 (A, B + C) are the one selfsame self. On this heroic journey by B, the voice of its completed self C speaks to it, offering cryptic but crucial hints. For me the Ditheon completed self C is angel archer + is my soul, the soul of both b (PKD) + A ("Thomas"). She is Logos: supreme rationality, micro-analog to the macro-Logos that steers the universe. This is literally Christogenesis. We are talking about an evo lutionary completion that took 2000 years to bring about, but now Ditheon C pierces the future; as a was, B is, C will be (as I said in my letter to Russ); her life started in 3-74 (not 2-74!) + moves forward from There (exactly as the Taoism alchemists teach) i.e. the Golden flower; her real life begins i when I did, as mine did when Thoma

Last edit almost 3 years ago by svayambhu108
252
Needs Review
```
**Co-occurrences**: Thomas, Logos, Ditheon, Golden, Like, Taoism, Both, Self, Russ, Anamnesis, Soul, Real, Voice, Archer, Macro, Universe, Will, Other, Angel, Journey, Life

---
### Line 41986-41994 (Match: 'Grail')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Complete, Ditheon, Like, Gnosis, Does, Self, Everything, Great, Soul, Most, Voice, Archer, Will, Parsifal, Angel, Remember, Knowledge, Genesis

---
### Line 44852-44860 (Match: 'Grail')
**Folder**: folder 55

```text
term, then, revealed to me by the AI voice, is the crucial concept I need. -- the vastly augmented space -- spatial volume -- in (3-74) was due to our time becoming a 4th spatial axis; there is from this a net yield in increasing the pure amount of space; & at this degree, in this many dimensions, it approaches being the Infinite Void that is the Godhead itself -- that is, it partakes of infinity.
...
Indexed
```
**Co-occurrences**: Indexed, Holy, Form, Gnostic, Well, Gnosticism, However, Maze, Perhaps, Godhead, Plotinus, World, Since, Prison, Time, Folder, Zebrapedia, Both, Being, Buddhism, Either, Such, Voice, Deity, Buddhist, Very, Many, Have, Life, Knowledge, Sacred

---
### Line 44980-44988 (Match: 'Grail')
**Folder**: folder 55
...
Needs Review
folder 55 - 030
Leg is the purpose young man. the arrival of the viewed this way my 2-74 meta-abstraction was my guessing the truth, solving the riddle, remembering (anamnesis). it posits (as I say) two Kingdoms coaxial in space-time. I get the impressian that the actual reality is one in which a court sits in judgment - not on the two Kings but on the onlookers. Thus the are two audiences to the ritual drama: the populace enslaved + forgetful, + the invisible court which -presumably - is presided over by God himself. Those who upon watching understand + remember hence awaken + are rewarded with what we call salvation. those who do not are doomed t to continue on as they have been. This reminds me of the celtic legend of the procession in which the Holy Grail is carried) again, one upon seeing this must guess the riddle - i.e. what it means. magic, delusion, a spell - all this is involved in both instances. Thus (1 say) 2-3-74 had to do with Xtian magic. as when the Greek tect as turned into a halm tree. wn are dealing with the supernatural or with technolo

Last edit almost 3 years ago by svayambhu108

folder 55 - 031
```
**Co-occurrences**: Christian, Holy, Greek, Time, Folder, Again, Both, Reality, Himself, Viewed, Anamnesis, Those, Upon, Have, Tree, Judgment, Remember, God Himself, Truth, Magic, Salvation
