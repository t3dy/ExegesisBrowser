...
Needs Review
```
**Co-occurrences**: Fish, Greek, Gnosticism, Wisdom, These, Plotinus, Maybe, Like, Mind, Could, Something, Again, Being, Self, Grace, Jung, Gold, Such, Actually, Certainly, True, Would, Were, Very, Many, Have, Absolute, Info, Magic, Hermes, Dream, Someone

---
### Line 782-790 (Match: 'America')
**Folder**: part segment
...
Needs Review
```
**Co-occurrences**: Christian, Logos, Jesus, Well, Parousia, These, Perhaps, James, Like, World, Since, Only, Time, Harpax, After, Even, Could, Pinky, Just, Suppose, Both, Reality, Being, March, Himself, Either, Great, Probably, Tessa, Nothing, Still, Their, More, Church, Most, Real, Love, Before, Finally, Will, Other, Were, Back, Whatever, Have, Body, Reformers, Human, Dream, Lamb

---
### Line 1481-1489 (Match: 'America')
**Folder**: book the
...
. . . Tiny but intriguing thought: my TEARS dream is quite like the pre-cog dreams of the Aztecs before Cortez landed: men on horseback in armor (robes). Points to an invasion, by the "gods," as they believed. This alone as explanation would account for the absolute grief I felt in the dream; Montazuma's sister's grief. Q: What do "Portuguese States of America, Cabrillo, Walloon, Vinland & the TEARS dream have in common?" A: my god, early explorers (add "the scouts coming in," too.)

Last edit over 5 years ago by Harpax
164
Needs Review
```
**Co-occurrences**: Tears, Christian, Perhaps, Like, Harpax, After, Mind, Even, Again, Both, Being, Gods, Those, Part, Most, Before, True, Would, Further, Have, Absolute, Claudia, Later, Having, Except, Dream, Right

---
### Line 2396-2404 (Match: 'America')
**Folder**: part alone
...
Needs Review
```
**Co-occurrences**: These, Maybe, World, Since, Only, Time, Harpax, Good, Even, Could, Just, More, Most, Before, True, Will, Were, Under, Have, Spring, Evil, Likewise, Blood

---
### Line 3041-3049 (Match: 'America')
**Folder**: Book of
...
Needs Review
```
**Co-occurrences**: Christ, Kingdom, Parousia, World, Since, Savior, Could, Does, Kingdom of God, Both, Self, Either, Chrissy, Nothing, More, Most, Living, Secret, Doris, Macro, Have, Information, Knowledge, Doesn, Final, Sacred

---
### Line 7435-7443 (Match: 'America')
**Folder**: part of

```text
I wonder how much stuff in my stories & novels has been skilfully implanted by my future me.
...
```
**Co-occurrences**: Valis, Tears, Wisdom, World, Gnosis, Iron, Prison, Time, Black, Although, Self, Black Iron Prison, Metz, Will, Back, Have, Iron Prison, Dream, Until

---
### Line 13148-13156 (Match: 'America')
**Folder**: part of
...
Indexed
```
**Co-occurrences**: Toso, Indexed, Form, Paul, World, Nixon, Good, Both, Being, Hegel, Although, Self, Divine, Beethoven, Brain, Were, Very, Back, Freedom, Dialectic, Greater, Human, Free

---
### Line 14475-14483 (Match: 'America')
**Folder**: Folder 03
...
Folder 03 - 006
```
**Co-occurrences**: Christ, Christian, Toso, Indexed, Rome, Empire, Like, World, Time, Nixon, Folder, Hermetic, Jakob Boehme, Being, Catholic, Without, Indexed
Folder, Bruno, Church, Voice, Actually, Secret, True, Would, Were, Very, Back, Have, Instead, Otherwise

---
### Line 14557-14565 (Match: 'America')
**Folder**: Folder 03
...
Folder, Greco, Still, Their, Bruno, Jung, Through, Real, Actually, Secret, True, Macro, Finally, Have, Memory, Jungian, Cross, Truth, Magic, Until

---
### Line 14703-14711 (Match: 'America')
**Folder**: Folder 03
...
Folder, Indexed
Folder, Still, Their, Paracelsus, Metz, Real, Certainly, Secret, True, Finally, Very, Have

---
### Line 21124-21132 (Match: 'America')
**Folder**: part of
...
Needs Review
79
i Our ultimate enemy is personified by the Nazis. This enemy is what I stigmatize in all my (the super state which writing: the Empire pervades my it controls our perception of reality) This is the point it corpus of writing, as a topic of my writing: to disclose the enemy + name it + my purpose isn't to disclose us what it does but them, which I have done. This was my job + did it, very successfully. (As witness what St I studies says about me.) I have always been aware of the Empire. What I did not know was who + what I was. In 2-3-74 I found out, but my work didn't begin then; in a sense it ended then The plasmate must have been in me when I wrote "Tears" so I didn't get it from the pharmacy Girl. In "Tears" did I show I had the plasmate in me? "I had the missing part of the information." + it showed up in "Tears"? No - all that was in "Tears" was to tell them where the missing informa i was: who had it "Tears": 5 police Marshals - spain (4 generals + the "Fifth column"). "Portuguese states of America. Salizar-fascist. Walloon: the flemish fascists. Rex: flemish fascists. Sterilization of blacks: third reich. Felix: Rome (i.e. italy). spain 2 portugal 3 Flemish walloon is rea s thind reich sitaly Felix t 5 fascist countuies/groups = so liety in/of "Tears" the USA: KKK. (dream.) I had told tim 6. 1) "Tears" was totalitarian + 2) racial that sterilization identified it as fascist not USSR. Tears" to our world - MITHC. "Grasshipper" - me + abendsen + Julian

Last edit almost 3 years ago by svayambhu108
80
Needs Review
```
**Co-occurrences**: Tears, Rome, Felix, Empire, World, Does, Reality, Girl, Corpus, Part, Very, Have, Information, Dream

---
### Line 22677-22685 (Match: 'America')
**Folder**: part of
...
Needs Review
122
88 Valis can restore all the apostolic Xtians effortlessly. + this means their world. This realization all stems from grasping that Thomas neither entered me signalled e nor aroused himself; he w into arousal + had no choice but to be n once again - + in this world as well as his own (physical resurrection!) Here the recovery of prior forms, as is dealt with in "Ubik" must be considered since (it always seems to be in "Ubik"!) everything call time continua) will eventually become prior forms, then everything can be retrieved + nothing is lost There is no evidence that this (1974/9) is a real present + not a retrieved (i.e. replayed) present; in fact there is evidence to the contrary: "Ubik," "Tears," "MITHC," + esp regarding the Xerox missive, a "Faith." most of all, the infringement by Thomas ti his space-time. Thomas + his world. Then, are to be regarded as retrieved + hence existing now (otherwise the term "retrieved" signifies nothing). someone + his world has no say-so in being retrieved (played back: the active mode). "... + all the modern prophets who have seen that slave revolts are rational Acts but wars of nationhood are not, who have called for new definitions of madness + sanity, + who have not been afraid to diagnose the insanity of those most rational (Dionysos war-makers" managerial of mes in America

Last edit almost 3 years ago by svayambhu108
123
Needs Review
```
**Co-occurrences**: Valis, Tears, Acts, Christian, Ubik, Thomas, Xerox, Form, Well, Dionysos, World, Since, Time, Faith, Once, Again, Being, Missive, Everything, Xerox Missive, Himself, Nothing, Those, Their, Most, Real, Will, Wars, Back, Have, Neither, Otherwise, Someone

---
### Line 23597-23605 (Match: 'America')
**Folder**: part of
...
Needs Review
70
964 argument against religion (Xtianity) as the explanation, since the Acts material is a means by which further info is extracted, + this further info has to do with a revolution ary subversive underground: Taverner is guilty of what the authorities suspect him of: if you bring in "Scanner," unknown even to himself. did Thomas defect? Decided he didn't want to go home? Had too good a thing going here? + told all he knew: his expert analysis of party strategy vis-a-vis us Sof. It wasn't me overriding him but his decision. He feared the Xerox missives arrival: the summons: official. What he was doing -contacting the Bureau- scared him, but going home scared him more. My God - he had quarreled with Lem; he'd be disciplined! He had gotten out of line + knew it. This is what the Xerox missive was all about: the heat. ("intelligence officer in the army.") I am afraid that if you go on the AI voice. Military intel‐ ligence is involved, which is serious. I'm afraid that the info in "Tears" extracted by the Acts grid points to Pigspurt; this can especially be clearly seen when "Frolix 8" is blended in, i.e.: the underground in both novels homogenized. Pigspurt thereby (the collation) becomes evident. the cordonite underground is thus carried out further in "Tears" although without the Acts grid you can't discern it. What "Tears" adds is a distinctly soviet element (e.g. the 5 marshals). (FLC, micken quinn, etc). (Specifically it is set in contemporary america.) (There has been a Soviet takeover.) The revolution by the cordinite underground in "Frolix 8" becomes successful in "Tears" - has taken power.

Last edit almost 3 years ago by svayambhu108

71
```
**Co-occurrences**: Tears, Acts, Thomas, Xerox, Christianity, Scanner, Since, Pigspurt, Good, Even, Taverner, Soviet, Both, Missive, Although, Xerox Missive, Himself, Frolix, Bureau, Without, More, Voice, Further, Clearly, Info

---
### Line 23602-23610 (Match: 'America')
**Folder**: book does
...
71
4655 Taverner i.e. the underground [Felix Buckman s (represented by Paul) Paul Paul winds up as the state, at the point that Jaso Taverner ceases to be Paul Buckman) + Felix Buckman becomes back on to Felix not underground Paul; i.e. the revolution not Paul not Paul has successfully taken (represented as/by Paul) place, + the revolutionaries the start are in power who were not in power at So this book does not entirely deal at the end. with an underground, but rather an underground which winds up in the seat of authority - associated with 5 marshals + forced labor camps, i.e. a Soviet ie ized america. Message, then: the revolution has been successful. Now, if we identify the revolutionaries as Pigspurt s Pigspurt, we are depicting as take-over of America we see it happen during the book. This is rather a serious message + if decoded (via the Acts grid) might well earn me a probe (contact) from "an intel ligence officer in the army"; the Q is, which army? in short, not (just) an underground is depicted via the Acts grid, but an underground which by the end of the book is in power, instead of opposed to those in power. Now, shall we re-evaluate such items as "miokey quian"? In short, he who symbolizes authority (Felix Buckman) is at the end converted to the under‐ ground revolutionary cause. The only Q. is, what it This cause? Pigspurt? Eti? True Xtian? I think the Xtian element is a sequence analyzer grid. Therefore - doesn't the state wither away in the epilog? Millenialist Pigspurt! After the revolution. So "Tears" depicts a successful revolution after which the state withers away. So Buckman's conversion on the road via the may seem to be to Xtianity Acts grid - but one layer below that it I

Last edit almost 3 years ago by svayambhu108
72
Needs Review
```
**Co-occurrences**: Tears, Acts, Christian, Christianity, Paul, Felix, Well, Therefore, Only, After, Pigspurt, Buckman, Book, Taverner, Does, Just, Soviet, Those, Ground, Such, True, Were, Back, Under, Instead, During, Doesn

---
### Line 23742-23750 (Match: 'America')
**Folder**: book only
...
Needs Review
95
i 485 Then "the King of Tears" - the civil authority - is a figure head. what if there are two Roman Catholic churche: the ostensible exoteric one, which does not rule + is subject to the civil authorities (of Empires initially + now nation states) + an invisible esoteric Roman Catholic church which This was the initial "revealed" impression that I had upon seeing the dream section in "Tears." that it specifically referred to the Roman Catholic church, which would collate (identity) the under‐ ground with the inner side of the Roman Catholic church - +, further, the murder of the Rennedys being because they were Catholics + the church knowing it + fighting back. (Deposing Nixon.) the real issue being slavery - literal slavery + (Xtianity as a slave rebellion, which means that 1) The civil authorities (best examples being USSR + the Nazis) maintaining slave empires. 2) the church fighting to liberate men (despite what is ostensible). So the real issue between USSR + the Catholic church has to do with slavery vs freedom. This goes back to Egypt + Rome The protestant reformation effected a resurgence of slavery camouflaged as a fight for freedom. take the Dutch: look at apartheid. + England. + look at Germany! Look at our extermination of the Indians; fen [van] walloon: portuguese states of America. an alternate world where the protestant cause - + hence slavery - collapsed. This was the issue in the U.S. Involving Lincoln. The E.B. says "Faulkner's writing about an old black woman treating her as important as any human is due to Xtianity" actually cate a

Last edit almost 3 years ago by svayambhu108

96
```
**Co-occurrences**: Tears, Rome, Christianity, King, Roman, World, Because, Nixon, Black, Does, Look, Being, Catholic, Church, Egypt, Ground, Real, Upon, Actually, Would, Were, Back, Under, Further, Freedom, Human, Dream

---
### Line 23782-23790 (Match: 'America')
**Folder**: book of
...
Needs Review
```
**Co-occurrences**: Tears, Christian, Thomas, Spirit, Jesus, Rome, King, Wisdom, Perhaps, Only, Nixon, Pigspurt, Even, Does, Soviet, Reality, Although, Without, Grace, More, Church, Voice, Joachim, Would, Absolute, Knowledge, Human

---
### Line 23956-23964 (Match: 'America')
**Folder**: part of
...
Needs Review
132
23 i t s - The monopoly money in the dream could equal not play money but counterfeit money (i.e. what I have found is counter‐ fect!). Oh - + the slot: where words appear. Orphan annie decoder badge: Figa a i.e. counterfeit + code. "Cabrillo" I i i + equals "the man." (via cabillare (+ cabrillo the explorer: i.e. new world. Gold watch red (red glass is obtained from Gold.) ordering code for dairy: milk, cream, butter milk, etc. Food. Cereal box - Baby food with medical info on back. Many symbols of children - childhood. flower pot with stick with writing on it indicating variety of plant: Bruce tatlock school. Growing seed; stop-action photography. Many frames: phosphene graphics, with constants visible. Jack armstrong pedometer. Ah! Cereal premiums. This ties children's cereal to code! encoding done in childhood, ob vious. Now we're getting somewhere (+ monopoly + its play money is children's game). +, most of all, the words Olive Holt are from my childhood. Freya Holt living on dairy ranch. The contest of play money where I won box camera. Drugstore: medicine. Watch: timer on bomb. No - being timed in my response: stop watch. Calendar watch with slot for day + date like the rollex watch I had in point reyes But what if Fig. A refers to King-Felix not the Xerox missive? In any case according + to the dream I delivered it to the right people suppose cabrillo, placentia + the chicanos refers to us portuguese states of America"? dream in "Tears" - I had the initial impres sim that it referred to the Roman Catholic church

Last edit almost 3 years ago by svayambhu108
133
Needs Review
```
**Co-occurrences**: Tears, Xerox, King, Felix, Roman, Like, World, Could, Suppose, Being, Catholic, Missive, Xerox Missive, Church, Most, Living, Gold, Holt, Olive, Olive Holt, Back, Many, Have, Info, Dream, Right
