...
121
```
**Co-occurrences**: Tears, Acts, Christian, Spirit, Holy, Rome, Holy Spirit, Sophia, Paul, Fish, Greek, Well, Bible, Roman, Perhaps, Advent, Like, World, Since, Time, Harpax, After, Savior, Even, Could, Anyhow, Once, Both, Obviously, Probably, Santa, Still, Part, Their, Another, Pike, Such, Voice, Secret, Santa Sophia, Will, Would, Other, Somehow, Were, Back, Have, Life, Information, Later, Testament, Knowledge, Dead, During

---
### Line 1884-1892 (Match: 'Jim Pike')
**Folder**: part remain
...
Needs Review
```
**Co-occurrences**: Christ, Ubik, Jesus, World, Time, Harpax, Just, Something, Being, March, Jesus Christ, Great, Another, Pike, Beyond

---
### Line 2561-2569 (Match: 'Jim Pike')
**Folder**: book in
...
```
**Co-occurrences**: Christ, Ubik, Spirit, Holy, Christianity, Holy Spirit, Form, Well, These, Like, World, Parmenides, Only, Time, Harpax, After, Book, Light, Even, Could, Anyhow, Both, Being, Great, Without, Part, More, Another, Pike, Living, Such, Voice, Actually, Certainly, Before, Death, Universe, Would, Other, Somehow, Back, Surely, Have, Things, Fake, Later, Knowledge, Dead, Right, Someone, Until

---
### Line 3541-3549 (Match: 'Jim Pike')
**Folder**: book of
...
Needs Review
```
**Co-occurrences**: Christ, Spirit, Holy, Logos, Rome, Holy Spirit, Greek, Bible, Parousia, However, Wisdom, These, Perhaps, World, Since, Iron, Prison, Only, Time, After, Cosmic, Savior, Book, Cosmic Christ, Light, Could, Does, Again, Being, March, Catholic, Tony, Although, Himself, Bureau, Anamnesis, Creator, Still, Part, Their, Pike, Living, Heaven, Such, True, Death, Universe, Will, Christopher, Would, Very, Back, Many, Have, Life, Memory, Evil, Having, Remember, Truth, During, Iron Prison, Evidently, Answer, August, Sacred

---
### Line 5046-5054 (Match: 'Jim Pike')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Logos, Christianity, Greek, Roman, Time, Mind, Could, Reality, Being, Moses, Himself, Pike, Real, Such, Universe, Creation, Were, Back, Berkeley, Absolute, German, Freedom, Evil, Knowledge, Free, Right

---
### Line 5599-5607 (Match: 'Jim Pike')
**Folder**: part of
...
```
**Co-occurrences**: Tears, Xerox, Maze, Father, Like, Time, Nixon, Faith, Stigmata, Good, Mind, Book, Just, Although, Frolix, House, Without, Part, Their, More, Pike, Before, Death, Would, Very, Back, Have, Fake, Evil, Impostor, Right

---
### Line 6700-6708 (Match: 'Jim Pike')
**Folder**: part at
...
Indexed
```
**Co-occurrences**: Christ, Valis, Acts, Christian, Toso, Thomas, Indexed, Jesus, Rome, Christianity, Form, Fish, Perhaps, Because, Time, Faith, Does, Just, Something, Both, Jesus Christ, Those, Pike, Pyth, Secret, Zoroastrianism, Revelation, True, Have, Cross, Dialectic

---
### Line 6957-6965 (Match: 'Jim Pike')
**Folder**: part of
...
Complete
```
**Co-occurrences**: Valis, Christian, Toso, Jesus, Complete, Fish, Father, Black, Great, Pike, Heaven, Will, Illustration, Beyond, Have, Life

---
### Line 8243-8251 (Match: 'Jim Pike')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Sophia, Well, Parousia, Time, Earth, After, Mind, Could, Does, Again, Empedocles, Hagia, Tony, Hagia Sophia, Those, Paracelsus, Pike, Heaven, Such, Before, Death, Will, Would, Erasmus, Back, Many, Body, Human

---
### Line 9353-9361 (Match: 'Jim Pike')
**Folder**: part of
...
-----------
```
**Co-occurrences**: Christ, Christian, Thomas, Zebra, Elijah, Like, Time, Urgrund, Something, Both, Reality, Divine, Part, More, Another, Soul, Pike, Such, True, Will, Very, Whatever, Have, Artifact, Knowledge, Elisha, During, Free, Someone

---
### Line 11118-11126 (Match: 'Jim Pike')
**Folder**: Part of
...
Needs Review
```
**Co-occurrences**: Ubik, Maze, Godhead, World, Only, Stigmata, Mind, Even, Being, Eldritch, Palmer, Palmer Eldritch, Nothing, Creator, Part, More, Soul, Pike, Living, Real, Such, Secret, True, Universe, Other, Have, Life, Evil, Truth, Dead

---
### Line 13164-13172 (Match: 'Jim Pike')
**Folder**: part of
...
```
**Co-occurrences**: Valis, Ubik, Indexed, Zebra, Logos, Sophia, Like, Mind, Could, Although, Great, Brain, More, Pike, Other, Were, Back, Have, Dead, Evidently, Right

---
### Line 13706-13714 (Match: 'Jim Pike')
**Folder**: part of
...
Indexed
```
**Co-occurrences**: Acts, Christian, Toso, Indexed, Rome, Form, Perhaps, World, Time, Mind, Just, Once, Realm, Both, Being, Christi, Tony, Corpus, Without, Brain, Their, Through, Pike, Corpus Christi, Certainly, Back, Human

---
### Line 15759-15767 (Match: 'Jim Pike')
**Folder**: folder 22
...
Folder, More, Through, Pike, Mother, Will, Very, Many, Have, Life, Memory, Info, Whether, Greater, Qumran

---
### Line 15783-15791 (Match: 'Jim Pike')
**Folder**: folder 22
...
```
**Co-occurrences**: Christian, Ubik, Logos, Fish, Golden, Golden Fish, Essene, Pike, Living, Would, Somehow, Have, Memory, Info, Except, Cross, Answer, Until

---
### Line 16285-16293 (Match: 'Jim Pike')
**Folder**: folder 22
...
Last edit almost 3 years ago by svayambhu108
```
**Co-occurrences**: Christ, Christian, Thomas, Xerox, Form, Elijah, Parmenides, Because, Time, Folder, Anyhow, Just, Being, Empedocles, Missive, Although, Xerox Missive, Sibyl, Essene, Still, More, Pike, Secret, Other, Were, Have, Life, Knowledge, Dead, Doesn

---
### Line 17479-17487 (Match: 'Jim Pike')
**Folder**: part of
...
Folder, Taoist, Part, Pike, Such, Certainly, Before, Would, Somehow, Were, Have, Mani, Wilson, Dialectic

---
### Line 18834-18842 (Match: 'Jim Pike')
**Folder**: part of

```text
Complete
69
Then acts is a static space invaded by an information - entity: the Logos? Or - is (1) dissolving to reveal (2)? No, (2) is attacking (1) which is very real but obscured. Selfobscuring? (2) awakens us to our real situation.

Somehow time is consuming itself - I even passed on into a postmortum world ("tape"). Wait - that means that one of my two selves (PKD - thomas) is now dead + on the other side - whose voice I hear; it's the not-me, whichever one that is. That's track A I'm right; I died c. 3-18-74 in track A; one of my two selves is deceased the roses + cabin by the lake one, obviously. He is now on the other side - shades of Jim Pike!

Ich fürchte sohn. Jim Pike again. Acts - i.e biblical material from Jim Pike? + the Greek.

+ of course Jim would respond to the (Golden) fish sign. I (sic) would remember (i.e. who I really was + what I knew. He could not retain his sub rosa role/ status in me...as if until the Fish sign he had amnesia, was halfasleep. Like - note like - a former self - but actually symbiotic.
```
**Co-occurrences**: Acts, Thomas, Logos, Complete, Fish, Greek, Golden, Like, World, Time, Even, Could, Again, Obviously, Self, Wait, Pike, Real, Voice, Actually, Would, Other, Somehow, Biblical, Very, Information, Remember, Dead, Right, Track, Until

---
### Line 18836-18844 (Match: 'Jim Pike')
**Folder**: part of
...
Jim dies + the next book I write is full of biblical material unknown to me + a dream about a man murdered by what resembles the KKK. + the month book comes out I "remember" + a month later another personality, a vigorous xtian + freedom fighter, takes me over, who - etc + I dream that Mrs Chambers (?) is my mother. + in the roses dream I'm affluent.
```
**Co-occurrences**: Acts, Christian, Thomas, Logos, Fish, Greek, Golden, Like, World, Time, Book, Even, Could, Again, Obviously, Self, Wait, Another, Pike, Real, Voice, Actually, Mother, Would, Other, Somehow, Biblical, Very, Information, Freedom, Later, Remember, Dead, Dream, Right, Track, Until
