# Evidence Packet: Palmer Eldritch
...
### Line 985-993 (Match: 'Palmer Eldritch')
**Folder**: part of
...
66
```
**Co-occurrences**: Christ, Ubik, Holy, Rome, Form, Sophia, Kingdom, Greek, However, Maze, Father, Like, Because, Only, Time, Harpax, Faith, Stigmata, Savior, Light, Even, Firebright, Could, Does, Once, Zagreus, Being, Eldritch, Palmer, Anamnesis, Essene, Darkness, Still, Most, Real, Such, True, Death, Somehow, Kingship, Were, Very, Back, Beyond, Many, Life, Body, Spring, Having, Remember, Unless, Greater, During, Someone

---
### Line 992-1000 (Match: 'Palmer Eldritch')
**Folder**: part of
...
Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Christ, Holy, Jesus, Well, Bible, Maybe, Because, Time, Harpax, Good, Book, Light, Even, Could, Anyhow, Just, Both, Eldritch, Himself, Palmer, Either, Palm, Santa, Without, Darkness, More, Another, Real, Laura, Certainly, Doris, Death, Universe, Friday, Would, Other, Back, Have, Fake, Knowledge, Cross, Dead, Suddenly, During, Dream

---
### Line 2734-2742 (Match: 'Palmer Eldritch')
**Folder**: part of
...
```
**Co-occurrences**: Christ, Ubik, Holy, Zebra, Form, Maybe, Like, World, Stigmata, Could, Although, Eldritch, Palmer, Bureau, Without, Nothing, Their, Secret, Before, Revelation, True, Death, Would, Other, Have, Tree, Things, Life, Having, Truth, Right

---
### Line 5535-5543 (Match: 'Palmer Eldritch')
**Folder**: book about
...
```
**Co-occurrences**: Zebra, Logos, Form, Sophia, Perhaps, Like, World, Book, Light, Just, Eldritch, Palmer, Voice, Universe, Other, Very, Neither, Blood

---
### Line 5567-5575 (Match: 'Palmer Eldritch')
**Folder**: part of

```text
The key linking 1) + 2) is: simulate.

Here is where I went wrong: the simulation is 1) not evil (as I thought) + it is not less than what it simulates (as I thought) but more: not clever simulacra-reflex machines, but angelic, + not a human here + there but our entire reality (or nearly - it does cast out - reject - parts of what it was + not incorporate them.[)]

As I said correctly in my UK speech, its mask fooled me: I was onto it, all right, when I wrote my UK speech. Behind Palmer Eldritch's cold cruel mask lies the visage of a totally harmless + virtually defenseless organism - vide how easy it was to kill Christ, it born into human form, which it is about to try again with hope (expectation, knowledge) of success this time!

In "Colony" + "Adjustment Team" + "The Commuter" I was very close; also "Imposter." Some of us are expressions of the whole, this vast insect, with sealed off memories which are to be triggered only when the exact moment for the action has come.

Last edit over 5 years ago by wtutwiler70
```
**Co-occurrences**: Christ, Form, Only, Time, Does, Again, Reality, Eldritch, Palmer, More, Very, Evil, Knowledge, Human, Right

---
### Line 5628-5636 (Match: 'Palmer Eldritch')
**Folder**: part of

```text
This "insect" metamorphosis which I saw is precisely that which God refers to when he says, "Look! I am building a new heaven + a new earth, + the memory of the former things..." etc. [Isa 65:17]
...
[?] - is a moth - the luminous "moth" descending + moths are precisely the life form which mimics ([inc?] the occuli). (The Palmer Eldritch fearsome mask).

What we call "time" is the metamorphosis - changes of the moth as it passes from what it first was to what it will finally be. From our standpoint, it could reach its final state suddenly + [?] at any time - hence all the eschatological aspect of our religion. The Parousia is very precisely the moment at which it ends its in-time change process, its becoming, + abruptly is (in final form).

State one: the Black Iron Prison Now: the middle world Later in time: the Palm Tree Garden Finally: the [?] + {?] world, which may be a primordial state lost (the Fall) to which the metamorphosing moth is returning. Guess there really was a fall, so this metamorphosis is a repairing.
```
**Co-occurrences**: Form, Parousia, World, Fall, Iron, Prison, Time, Earth, Black, Garden, Could, Look, Eldritch, Black Iron Prison, Palmer, Palm, Heaven, Finally, Will, Very, Have, Tree, Things, Life, Memory, Later, Suddenly, Iron Prison, Final

---
### Line 5702-5710 (Match: 'Palmer Eldritch')
**Folder**: part of
...
6
```
**Co-occurrences**: Valis, Tears, Toso, Indexed, Spirit, Well, Bible, Perhaps, Like, World, Since, Time, Good, Even, Could, Joint, Anyhow, Both, Being, Self, Eldritch, Divine, Himself, Palmer, Corpus, Part, More, Real, Before, Deity, Would, Very, Have, Memory, Instead, Later, Trinity, Knowledge, Truth, Human, Answer

---
### Line 5795-5803 (Match: 'Palmer Eldritch')
**Folder**: part of
...
```
**Co-occurrences**: Tears, Ubik, Xerox, However, Maze, These, World, Gnosis, Prison, Only, Time, Stigmata, Good, Book, Does, Once, Again, Being, Eldritch, Palmer, Viewed, Grace, Tessa, Part, Through, Living, Certainly, Before, Will, Would, Have, Life, Information, Electric, Truth, Impostor, Electric Ant, Until

---
### Line 6162-6170 (Match: 'Palmer Eldritch')
**Folder**: part but
...
After we (Knights, Rebels, directed by the force) blew up the empire ("Bablyon") some of the evil ones came here. They blended with the native population. Pursuing rebels (such as I) followed, from that other star, [our?] memories of sure origin and mission blocked. In 1974, the evil quarry had surfaced (in the ["conspitators"?] of the vs); this was the signal, cause, for the force resotring our memories as to who we were, where we were from, and what we have to do. The 74 battle was teh "next" battle, at least here. Palmer Eldritch whome I saw, was the black [item claerking?] one. (Darth Vader)

3 races here: 2 with memories dating back thousands of years to another world. See "Present for Pat." Zebra = the force. I was one of those knights; our leader (king) was killed (ie Christ), and we lost them (Rome AD 70). But would win in 1974, the next time; now comes the establishment of the Park Kingdom, and rebirth of the king.

Christ would cause return of memory (anamnesis)to the "sons of light" (Good rebels) here; this is where he could see that even crucified we had overcome the world. My anamanesis was due to win; as Zebra he is still here.
```
**Co-occurrences**: Christ, Zebra, Rome, Kingdom, King, Empire, World, Time, After, Black, Good, Light, Even, Could, Eldritch, Palmer, Anamnesis, Those, Still, Another, Star, Such, Would, Other, Mission, Were, Wars, Back, Have, Memory, Star Wars, Evil, Sons

---
### Line 6213-6221 (Match: 'Palmer Eldritch')
**Folder**: part but
...
Needs Review
```
**Co-occurrences**: Valis, Christian, Ubik, Kingdom, Empire, Maze, Perhaps, Maybe, World, Iron, Prison, Only, Time, Earth, Black, Faith, Stigmata, Savior, Good, Even, Joint, Just, Kingdom of God, Maya, Reality, Eldritch, Black Iron Prison, Palmer, Frolix, Dokos, Their, Star, True, Will, Would, Were, Wars, Back, Have, Star Wars, Wise, Evil, Truth, Iron Prison

---
### Line 6326-6334 (Match: 'Palmer Eldritch')
**Folder**: book came
...
21
( Star Wars depicts the timeless present drama we have recently been involved in, presenting all the figures (characters - such as vader: "Palmer Eldritch"). This has been the real landscape below the linear dokos. If I ask, "is there orthogonal time?" I can't answer, "Yes, I know there is." But I could say, "If There were, I would expect it to exhibit the following characteristic: it would be a matrix which has not moved up the linear manifold" - i.e. it would resemble a far-distant past locus of the linear strip. This is what I would look for. Has anyone ever experienced this? Have It is any such encounter reported: But then suppose I start with my encounter with the evident massive time reversion to 70 AD Rome which I experienced in 3-74. I would need a theory to account for it. Suppose then I read a paper on the theoretical aspects of orthogonal time. I would see at once two things: 1) my experience couldn't be explained unless there was such a thing as orthogonal time (or some other kind of time than linear) + 2) I had confirmed the existence of orthogonal time empirically, although not intentionally. 3) I would advance the view that orthogonal time is set up (into existence) at a point or points where anothere reality (of which we have no direct knowledge, only secondary report) breaches into linear time at some point converting a process - moment into a permanent matrix. This would cause me to hypothesize that there is no past-present future linear time in that realm but rather some kind of essence being which may or may not way + wane in intensity but does not change, as we experience change (things coming into being + then passing away).

Last edit almost 3 years ago by svayambhu108
22
Needs Review
```
**Co-occurrences**: Rome, Only, Time, Could, Does, Look, Once, Realm, Suppose, Reality, Being, Although, Eldritch, Palmer, Dokos, Star, Real, Such, Would, Other, Were, Wars, Have, Things, Star Wars, Unless, Knowledge, Answer

---
### Line 6368-6376 (Match: 'Palmer Eldritch')
**Folder**: book came
...
Needs Review
```
**Co-occurrences**: Christ, Valis, Tears, Christian, Zebra, Xerox, Empire, Lord, Like, World, Iron, Prison, Time, Nixon, After, Black, Savior, Good, Book, Could, Just, Luke, Although, Eldritch, Black Iron Prison, Palmer, Anamnesis, Their, Star, Before, Death, Will, Would, Somehow, Were, Wars, Meanwhile, Have, Memory, Star Wars, Evil, Remember, Iron Prison, Free

---
### Line 6559-6567 (Match: 'Palmer Eldritch')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christian, Zebra, Form, Gnostic, Greek, Well, Wisdom, Like, World, Prison, Eldritch, Palmer, Either, Probably, Church, Another, Star, Through, Real, Secret, True, Egyptian, Have, Knowledge, Wilson, Human, Free

---
### Line 7070-7078 (Match: 'Palmer Eldritch')
**Folder**: folder 32
...
```
**Co-occurrences**: Ubik, Indexed, Logos, Sophia, Gnostic, Maze, Like, World, Since, Prison, After, Folder, Does, Zebrapedia, Both, Reality, Being, Runciter, Eldritch, Palmer, Deus, Indexed
Folder, Their, Another, Irae, Deity, Were, Have, Deus Irae, Human, Right, Sacred

---
### Line 7097-7105 (Match: 'Palmer Eldritch')
**Folder**: part of
...
Indexed
```
**Co-occurrences**: Christ, Valis, Tears, Indexed, Spirit, Holy, Zebra, Jesus, Holy Spirit, Kingdom, Fish, Well, Parousia, Golden, These, Elijah, Father, Like, World, Gnosis, Golden Fish, Only, Time, Earth, Cosmic, Stigmata, Cosmic Christ, Even, Could, Zebrapedia, Something, Both, Reality, Eldritch, Divine, Himself, Palmer, Great, Probably, Anamnesis, Still, Part, Another, Metz, Real, Before, True, Death, Finally, Will, Deity, Would, Other, Very, Have, Days, Remember, Knowledge, During, Dream, Until

---
### Line 7350-7358 (Match: 'Palmer Eldritch')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Tears, Christian, Ubik, Zebra, Logos, Jesus, Gnostic, Satan, Maze, Lord, Father, Like, World, Time, Earth, Stigmata, Good, Could, Eldritch, Palmer, Zoroastrian, Augustine, Zoroaster, Those, Jews, More, Heaven, Death, Universe, Will, Would, Other, Mission, Creation, Were, Have, Mani, Life, Absolute, Neither, Aphrodite, Whether, Evil, Having, Dead, Whereas, Track

---
### Line 7998-8006 (Match: 'Palmer Eldritch')
**Folder**: part of
...
Needs Review
92
95 I'm just going to speculates giving up all attempts at systematic proofs. Our chaotic world has been invaded by a supernatural divine conscious wise powerful entity, which is systematically replacing parts (objects, events + processes) the way Palmer Eldritch replaced the real world with him self qua spurious world. the two differences are: (in our actual world) N It is the ontologically real replacing the ontologically spurious (the diametric opposite from what is happening in the novel "the 3 Stigmata) + ➁ The replacing entity is benign, not evil. hence I say: "The 3 Stigmata" is an exact looking glass opposite or backward view of the real world. Except for the following: in both our real world (however real that may be! + in "the 3 Stigmata" ar enormously vast God-like sentient entity is replacing the natural processes. things, portions, with its mimicking organic body - which is to say, also, with its mind - there being no distinction between Palmer Eldrich qua mind vs qua body This is a discovery. In the case of this vast sentient entity, unlike with us, there is no psyche-soma dualism. Hence it is Noos. The key to what Zebra is + is doing can be inferred by using "the 3 Stigmata" as model, reversing the good bad + the real-spurious bipolarities +, as I discovered when recently I read the novel, it is in fact not a study of hallucination + drugs but of the miracle of transubstantiation. So via the novel we are led back to Christ + what Helhard de Chardin says about his vast cosmic plasmatic presence 4

Last edit almost 3 years ago by svayambhu108
93
Needs Review
```
**Co-occurrences**: Christ, Zebra, However, Like, World, Noos, Cosmic, Stigmata, Good, Mind, Just, Both, Being, Self, Eldritch, Divine, Palmer, Real, Back, Things, Body, Wise, Evil, Except, Chardin

---
### Line 8004-8012 (Match: 'Palmer Eldritch')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Maze, World, Stigmata, Good, Does, Suppose, Both, Maya, Being, Eldritch, Palmer, Eucharist, Those, Dokos, More, Real, True, Further, Neither, Evil, Final

---
### Line 8291-8299 (Match: 'Palmer Eldritch')
**Folder**: part is
...
136
o 120 + that advocate is the Paraclete. I saw the universe as it is: Divine. With us in [the Cosmic] Christ, + Christ in us. This is not panpsychism or pantheism; Christ has transmuted + absorbed the universe (a la Palmer Eldritch); the Holy Spirit in me showed us living in the organism we call The Corpus Christi. the universe [of matter) now is alive + thinks - as the Cosmic Christ.

Last edit almost 3 years ago by svayambhu108
137
Needs Review
```
**Co-occurrences**: Christ, Spirit, Holy, Holy Spirit, Cosmic, Paraclete, Cosmic Christ, Christi, Eldritch, Divine, Palmer, Corpus, Corpus Christi, Living, Universe
