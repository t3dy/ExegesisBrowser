...
106
```
**Co-occurrences**: Spirit, Greek, However, Dionysos, These, Perhaps, Plotinus, Like, Since, Because, Only, Time, Harpax, After, Something, Look, Again, Suppose, Both, Reality, Everything, Divine, Great, Gods, Brain, Part, More, Another, Real, Voice, Actually, Love, True, Universe, Will, Would, Other, Somehow, Were, Attic, Beyond, Whatever, Have, Life, Memory, India, Having, Remember, Human, Dream, Track

---
### Line 1496-1504 (Match: 'Socrates')
**Folder**: part pressing
...
```
**Co-occurrences**: Dionysos, Like, World, Harpax, Once, Apollo, Another, Secret, Whatever

---
### Line 1510-1518 (Match: 'Socrates')
**Folder**: part pressing
...
```
**Co-occurrences**: Christ, Logos, Dionysos, Like, World, Since, Does, Reality, Apollo, Another, Secret, Angel, Whatever, Under, Life

---
### Line 1540-1548 (Match: 'Socrates')
...
```
**Co-occurrences**: Jesus, Greek, However, Maybe, Like, World, After, Cosmic, Book, Does, Everything, Still, Through, Would, Creation, Many, Have, Life, Wise, Unless, Reformers

---
### Line 1605-1613 (Match: 'Socrates')
**Folder**: book COSMIC
...
```
**Co-occurrences**: Christ, Holy, Christianity, Greek, Maze, Maybe, Like, Time, Does, Himself, Still, Another, Greece, Other, Somehow, Attic, Have, Someone

---
### Line 1621-1629 (Match: 'Socrates')
**Folder**: book COSMIC
...
Needs Review
```
**Co-occurrences**: Spirit, Holy, Holy Spirit, Greek, Golden, Dionysos, These, Perhaps, Like, World, Since, Because, Time, Harpax, Mind, Anyhow, Both, Zagreus, Dante, Great, Gods, Nothing, Another, Most, Greece, Will, Other, Were, Erasmus, Attic, Things, Later, Human

---
### Line 1822-1830 (Match: 'Socrates')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Spirit, Holy, Complete, Holy Spirit, Form, Sophia, Greek, Well, Perhaps, Advent, Like, World, Since, Because, Harpax, Does, Just, Realm, Being, Divine, Philip, Aristotle, More, Such, Voice, True, Judge, Attic, Things, Information, Freedom, Evil, Knowledge, Truth, Reformers, Lamb, Right

---
### Line 3053-3061 (Match: 'Socrates')
**Folder**: part of
...
```
**Co-occurrences**: Christ, Tears, Christian, Ubik, Spirit, Xerox, Sophia, Gnostic, Fish, Greek, Gnosticism, Golden, Wisdom, Perhaps, World, Golden Fish, Time, After, Cosmic, Could, Something, Once, Again, Great, Sibyl, Anamnesis, Jewish, Creator, Still, Part, Living, Voice, Before, True, Will, Would, Other, Were, Very, Back, Have, Life, Body, Information, Wise, Aphrodite, Except, Dead, During, Dream, Evidently, Doesn, Free, Pleroma

---
### Line 14052-14060 (Match: 'Socrates')
**Folder**: part of
...
This is the paradox of, "where should you most expect to find God?" A.: "In the least likely place". I discern in this the following: "In point of fact you therefore cannot find God at all, he must -will- find you, + when + where you least expect it" - i.e. he will take you by surprise, like the still small voice which Elijah heard. Or like Oh Ho the ceramic pot. The oracle may speak to you from the gutter (whatever "gutter" might mean in this context). So my writing -itself part of the "gutter" +, as Lem says, "piling trash upon trash"- may serve as the sort of gadfly kind of thing that Socrates considered himself to act as. My writing is a very unlikely place to expect to encounter the Holy, the koinos, the message-processing, Ubik-like ultimate entity. This may be why I found such beauty, in 1971, in such people as Kathy + Stephanie - why I cherished them so. I had an intuition + it paid off. The plurality of push-pull worlds (psychoi to omni matrix) explains why Zebra could invade my world - + Tessa would see nothing. It (the breaking through) did not overlap into her world any more than Thomas did (or hence Acts). This B model shows not just what is, but why it (the various elements) must be as they are. There may be a specific task in the ratiocination of the brain: it may be at war -phagocyte-like- against a pathenogen. It is geared up for attack, combat + war.

[Text to picture of Model B and Ubik] The two are identical, + I didn't realize it until tonight. In formulating Model B I have returned to "Ubik" + not just the paradigm based on "Ubik".

Last edit almost 7 years ago by Toso
```
**Co-occurrences**: Acts, Ubik, Toso, Thomas, Holy, Zebra, Elijah, Like, World, Therefore, Folder, Could, Just, Himself, Tessa, Nothing, Brain, Kathy, Still, Part, More, Through, Most, Such, Voice, Upon, Will, Would, Very, Whatever, Have, Until

---
### Line 25350-25358 (Match: 'Socrates')
**Folder**: folder 48
...
Folder, Brain, Another, Soul, Ground, Real, Love, Illustration, Women, Having, Dream, Asher

---
### Line 25357-25365 (Match: 'Socrates')
**Folder**: folder 48
...
I'm within an ace of it. The dream is penetrated + our own mind "syntonics" the penetrating thing; we cause it to blend - we do it to ourselves because we want to dream on (cf the Fox: it's beautiful). So we camouflage it or anti set/ground it, to keep the dream going. We're plugged in, as in "Maze." + someone has found us in this state - v. all my novels. Waking is dangerous for us: terrifying. Even if done gently. By the outside initiator-intervener. Socrates. Eliade. "VR". We are literally asleep ("polyencephalic fusion"). This world is our own creation, not forced on us to delude us. No. Remember my dream? Belial won + holds all the centers of power. I had to be told (from outside) because Belial makes the dream syntonic to us so we collude. (With him.) The Fall. Christ was defeated in his coming here to wake us; he was to be, even more so than Socrates the gadfly. But they killed him. Got rid of him; killed Socrates, too. It's not good vs evil but asleep vs awake, irreal + auto-world (self generated, yes: the Rati self-stimulation) vs real. Q for "YHWH": how to create the rasp. What will rasp, since most things get worked into the dream + its irreal time feed back loop, its auto feed back world. Two things necessary to maintain it 1) Loss of memory of real world 2) Perceptual/cognitive occlusion + we have these!

Last edit almost 7 years ago by Toso
folder 48 - 112
Indexed
```
**Co-occurrences**: Christ, Toso, Indexed, Maze, These, World, Since, Fall, Because, Time, Folder, Good, Mind, Even, Self, Toso
Folder, Eliade, More, Most, Ground, Real, Will, Belial, Creation, Back, Have, Things, Memory, Evil, Remember, Dream, Someone

---
### Line 45350-45358 (Match: 'Socrates')
**Folder**: folder 55
...
Needs Review
folder 55 - 092
2-4 God by this knowledge, + he who has this not is not evil but deprived. + he on his own cannot change his situation, for there is no rational way - only a supernatural way - that this knowledge can be obtained. I must not blame someone who possesses not this knowledge, for there is no way he can obtain or acquire it on his own is totally dependent on the grace of God. Here is re where the original satori is as the 2-74 metaabstraction was. But this shows that although the 2-74 meta-abstraction had to do with cognition it was given to me from outside, which brings me to the issue of socrates vs Jesus that Tillich speaks of. reminding the person (socrates' route) of what is already in him; or Jesus' way (midwife, as Tillich puts it) It is not probably that the meta-abstraction was truly an intrinsic (internal) cognitive act on my part - either viewed in isolation or in relation to The sequence of earlier Satoris. All one knows is that now knows what one did not know, but not one due to ratiocination: due rather to some element outside. + this is the key clue: outside. But I figured out last night that we do not know world directly but through God as lens link interface. So the stimulus in outside reality affords God the interface the oppertunity (to use Malebranche's term) (No: his term is occasion) to transfer knowledge (This is in conformity with "pretextually, as it were + my whole conception of clutch, selection, enhancement suppression + not a special situal, only - as Joyce a i calls it - an epiphany of regular conditions. It is if the pretext is clearly only pretext: effect - that which is known - far exceeding its ostensible cause. As to the transfer of information regarding Christopher's birth defect the situation is clearly + explicitly such that it is palpably impossible objects can give rise t than insentient plural the information, in which case something is there have always spoken of as camouflaged that I in + as ordinary plural insentient objects

Last edit almost 3 years ago by svayambhu108
folder 55 - 093
Needs Review
```
**Co-occurrences**: Jesus, World, Malebranche, Only, Folder, Something, Reality, Although, Either, Probably, Viewed, Grace, Part, Through, Such, Christopher, Were, Have, Clearly, Information, Evil, Knowledge, Someone

---
### Line 45391-45399 (Match: 'Socrates')
**Folder**: part whole
...
Complete
folder 55 - 099
2-10 terms "cognitive estrangement" + "part whole compatibility" my reading Heigegger + of course the pre-socratics, esp. Pythagoras + Parmenides: Greek thought was the solution, all hight - oh, + my study of Plato's universalia ante rem apparently my Jungian intuitive function This then was socrates way (in did it. contrast to Jesus' as tillick speaks of). It authentic Platonist anamnesis + noesis. was + Valis is both kosmos + immanent nous of that kosmos - there is no real distinction, for in such an experience of reality everything is integrated into an organic structure, unitary + that thinks Also, this would be Neo-Platonism - Plotinus' the one This "Extinct." God, what this term conveys? Dasein/weltanschauung died out like a biological species + is totally absent from the present "Extinct" refers to that which was world - totally! not now - totally gone, not just rare + but is in contemporary terms, it cannot be revived) only by reason of anamnesis, amounting to a vast phylogenic reversion can it be recaptured was correct that day in 3-74 when I thought I b "This is the way they used to experience reality cosmic resorption! Great Brahman. A Shiva. but it is more precisely Greek: kosmos, such as Hans Jonas speaks of. + which I know to be predicated - necessarily - on the continuum view of reality (hence my Taoist training may well have aided me! + this relates to quantum mechanics.) (In which case the continuum view, in returning in + as quantum mechanics, may permit + even faster a return of a per‐ ception of the "extinct" true cosmos note: true cosmos. Not just cosmos

Last edit almost 3 years ago by svayambhu108
folder 55 - 100
Complete
```
**Co-occurrences**: Valis, Jesus, Complete, Plato, Brahman, Greek, Well, Plotinus, Like, World, Parmenides, Only, Platonist, Cosmic, Folder, Pythagoras, Platonism, Even, Just, Shiva, Both, Reality, Kosmos, Nous, Everything, Great, Anamnesis, Taoist, Part, Dasein, More, Real, Such, True, Would, Have, Apparently, Jungian
