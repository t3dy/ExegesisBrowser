...
### Line 2211-2219 (Match: 'Teilhard')
**Folder**: part of

```text
Needs Review
164
In all this, to decode one must ask, What does this term resemble? I'm dreaming about the very early explorers -- in fact, those who absolutely were the first. Vinland and that Ronoake Island thing, that first English colony. John Smith or whatever. Also, possibly add Albemuth as made out of Nova Albion or New England (a very early name dropped). With azimuth! A term used in navigation! And the "al" suggesting a star -- navigation by means of fixed stars. Also, the "Lampson" dream in which I saw below a navigational map of the inland bay area, as if from above, with a marking circle, like a satellite map.

. . . March 1974: I reached reunion with the Father. Today 5 31 75 I had a dream in which I was a child again back in the '30s; at an old-fashioned table I say with other people, and a man gave me a bowl of cereal. I saw that He was the Savior, and I began to cry with ecstatic joy. When I woke up I took a couple hours and managed to reconstruct the meaning of this dream. When I was very small, Christ fed me His Real Presence in the typical host-form: cereal (i.e. bread). I took Him into me back then, and, as in the parables of the mustard seed and the leavening, He grew within me. Later on, in adult life, I felt a growing need to nourish other people, esp. to feed them (in '74 we sent $400 for famine relief, for example). That which was given to me grew in me and began to yield fruit, or expression in my giving nourishment; I became by degrees the Man who had fed me as a child. Viewed this way, my 3 74 experience is not something dropped on me from outside, due to the "painted in the corner" need-situation I was in, but in fact the pay-off of a life time process or growth. It was the culmination of something alive and advancing inside me; in 3 74 I made it or reached it, re-union with the Father, which is to say, Christ as Mediator restored me to the Father (I didn't achieve it but was brought to it). Thus both Christ and the Father were present: Christ within me, leading me to the Father. This explain the long-term intimations I have had about being moved along toward a pay-off destiny (e.g. the dream in Canada wherein Kathy and everyone else take off their masks, finally, and Kathy says, "Now it all can be explained to you, what it was all about."). I was moving by degrees, step by step, toward the encounter with the dark-haired girl at the door with the gold fish-sign necklace. I assume that when I acted as the Savior and gave an analogous bowl of cereal to someone that I set a similar process in motion in him or her, too; thus, Christ delivers us, spreading Himself out through us by means of this "unauthorized" communion with His Real Body. Christ's role as mediator is now clear to me. A man, such as I, could never on his own find his way back to union with God. Therefore God Himself initiates the reunion, and it is God as Christ who acts to lead a man, myself in this case, along the difficult, long, narrow, confusing path to final redemption; to the right conclusion, which I experienced. A man's tragic difficulty does not being as a situation at any given moment in his life; he is born into it: separation from God. Thus Christ begins to lead a man back from the start; intervention began in my life long ago -- in fact as many of my dreams showed, in early childhood the groundwork was laid down; He was already active. 3 74 was not the difficulty but the pay-off. The last step before resurrection (finding immortality) was the death in the tomb, which I experienced during those many sleepless nights. This is what Teilhard de Chardin said; each man as Christ; the entire species working its way along the stations of the Cross, which is also what

Last edit over 5 years ago by Harpax
165
Needs Review
```
**Co-occurrences**: Christ, Acts, Form, Fish, Father, Like, Therefore, John, Time, Harpax, Savior, Could, Does, Something, Again, Both, Being, March, Girl, Himself, Viewed, Kathy, Those, Their, Star, Through, Real, Gold, Such, Before, Death, Finally, Other, Were, Very, Back, Whatever, Many, Have, Life, Body, Dark, Later, God Himself, Cross, Today, During, Dream, Chardin, Final, Right, Someone

---
### Line 2325-2333 (Match: 'Teilhard')
**Folder**: part piece
...
```
**Co-occurrences**: Christ, Tears, Logos, Kingdom, Greek, Well, Parousia, These, Perhaps, Like, World, Because, Therefore, Time, After, Mind, Could, Anyhow, Once, Realm, Again, Kingdom of God, Being, Great, Viewed, Part, Through, Soul, Most, Heaven, Ground, Real, Gold, Such, Voice, Before, Will, Would, Other, Somehow, Ching, Very, Back, Beyond, Surely, Have, Clearly, Things, Eckehart, Memory, Except, Cross, Dream

---
### Line 2677-2685 (Match: 'Teilhard')
**Folder**: book in
...
```
**Co-occurrences**: Christ, Holy, Logos, Form, Sophia, Wisdom, Father, World, Fall, Because, Faith, Savior, Holy Wisdom, Again, Reality, March, Great, More, Most, Living, Real, Before, Death, Universe, Will, Would, Other, Were, Very, Back, Have, Spring, Trinity, Passover, Suddenly, Dream, Chardin, Final

---
### Line 2683-2691 (Match: 'Teilhard')
**Folder**: book in
...
Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Christ, Spirit, Holy, Logos, Form, Sophia, Kingdom, Wisdom, Father, Like, World, Earth, Harpax, Faith, Holy Wisdom, Even, Reality, March, Great, More, Most, Living, Real, Secret, Love, Doris, True, Universe, Will, Would, Other, Back, Have, Body, Spring, Evil, Passover, Salvation, Chardin, Doesn, Final

---
### Line 3314-3322 (Match: 'Teilhard')
**Folder**: file numbers
...
Last edit almost 5 years ago by svayambhu108
```
**Co-occurrences**: Christ, Ubik, Spirit, Xerox, Rome, Form, Satan, Well, Bible, Parousia, Wisdom, Perhaps, Maybe, Like, Since, Because, Only, Time, Nixon, After, Mind, Even, Could, Anyhow, Just, Look, Once, Again, Being, March, Platonic, Either, Great, Without, Still, More, Church, Another, Through, Heaven, Real, Fullerton, Before, Universe, Finally, Were, Very, Back, Whatever, Under, Have, Things, Memory, Instead, Remember, Government, Someone, August

---
### Line 3335-3343 (Match: 'Teilhard')
**Folder**: file numbers
...
Needs Review
```
**Co-occurrences**: Christian, Ubik, Spirit, Logos, Rome, Form, Sophia, World, Since, Because, Only, Time, Earth, After, Good, Mind, Book, Even, Could, Anyhow, Something, Reality, Nous, Everything, Platonic, Either, Great, Anamnesis, Without, Those, Dokos, More, Most, Real, Actually, Fullerton, Certainly, Secret, Universe, Creation, Were, Back, Have, Things, Life, Later, Except, Suddenly, Dream, Salvation, Right, Someone

---
### Line 3382-3390 (Match: 'Teilhard')
**Folder**: book when
...
Needs Review
```
**Co-occurrences**: Spirit, Holy, Holy Spirit, Scanner, Like, Only, Time, Mind, Even, Does, Anyhow, Soviet, Something, Both, Being, Although, Divine, Probably, Brain, Those, Their, Through, Real, Fullerton, Will, Would, Other, Somehow, Were, Under, Further, Have, Life, Information, Later, Government, Otherwise, Human, Dream, Chardin, Answer

---
### Line 4426-4434 (Match: 'Teilhard')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Zebra, Form, Plato, Well, Wisdom, Perhaps, James, Earth, Noos, Even, Does, Just, Kosmos, Everything, Great, Brain, Timaeus, Will, Things, Life, Greater, Right, Ananke

---
### Line 5280-5288 (Match: 'Teilhard')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Christian, Thomas, Spirit, Zebra, Advent, Maybe, World, Since, Because, Time, Cosmic, Cosmic Christ, Could, Just, Hegel, Himself, Deus, Anamnesis, More, Revelation, Would, Were, Have, Absolute, Wise, Knowledge, Doesn, Right

---
### Line 5292-5300 (Match: 'Teilhard')
**Folder**: part of
...
76
```
**Co-occurrences**: Christ, Thomas, Spirit, Holy, Zebra, Holy Spirit, Paul, Well, However, Perhaps, World, Only, Time, Cosmic, Cosmic Christ, Just, Although, Self, Nothing, Creator, Heaven, Such, Macro, Universe, Finally, Will, Would, Have, Having, Final

---
### Line 5309-5317 (Match: 'Teilhard')
**Folder**: book it
...
Needs Review
```
**Co-occurrences**: Christ, Ubik, Zebra, Plato, Paul, These, Like, World, Noos, Runciter, Probably, More, Through, Certainly, Before, Universe, Will, Things, Information, Knowledge, Human, Lower, Right, Ananke

---
### Line 5315-5323 (Match: 'Teilhard')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Zebra, These, Like, Since, Because, Only, Time, Noos, Just, Being, Self, Everything, Corpus, Anamnesis, Without, Still, Part, More, Upon, Certainly, Death, Universe, Would, Very, Back, Have, Things

---
### Line 5321-5329 (Match: 'Teilhard')
**Folder**: part of
...
81
```
**Co-occurrences**: Christ, Tears, Ubik, Thomas, Zebra, Logos, Sophia, Like, World, Because, Only, Time, Noos, Mind, St Sophia, Could, Anyhow, Just, Again, Both, Reality, Christi, Hegel, Although, Corpus, Santa, Still, Part, Another, Corpus Christi, Living, Ground, Before, Whitehead, Universe, Deity, Would, Very, Surely, Have, Dream, Right, Until

---
### Line 6067-6075 (Match: 'Teilhard')
**Folder**: part of
...
Needs Review
25
22 i The sout of titanically verbal (informational) construct world of the computer, at. Level ➂ becomes more + more like (1). it is thought producing thought through the intermediary stage of flesh/body / material/nature - a replication, a giving birth. Is this not a description of the 1st Adven + even more so the 2nd advent? Level ( thrusts through (2) manifests itself in (3): foremostly, in the scriptures, but + not limited to them (as "Tears" testifies to, + as "Ubik" depicts, + now I'm beginning to include "Maze"). Holy Wisdom exists before all creation (i.e. the material universe). Then it creates or help create the material universe - i.e. level ( then it in carnates in level ➁ but expressing itself verbally - in terms of thoughts, words, concepts, etc, all of which add up to Holy Wisdom which is its essence. But level ( does not find it acceptable; it is killed + retured to level (+ from whence it came. However, it will try (incarnate, be born) in level ( again as a means of raising whel (3) into an authentic replication of level ( Zebra, which I saw under going metamorphosis, invisible to us normally, is evolving on level ( but will eventually invade level (3), assimilating it to itself + infusing it with essence (reality). This means that level ➁ is nothing more than a means to an end. A sentient being (Brahman) is giving birth to sentient being, ➂, which ➁ is not. ) must be regarded as a womb ("recepticle of being."). a kind of hatching "egg." The living, sentient product of This "egg" replicates the "parent" of the "egg." Thus I say, the ubiquitous immanent being, of level (e, does not divide (e.g. binary fission, etc) but creates an intermediary - + perhed temporary - state which in a certain literal sensed is not truly real, except as a source for what ultimately will be real - lovel (). This lever ( certainly resembles Teilhard do chardin's noosphere. We can expect level ➁ to be generating progressively more replicatory aspects of its own source- covel E! The ultimate true birth is exactly what is depicted in "Ubik": the wise information

Last edit almost 3 years ago by svayambhu108
```
**Co-occurrences**: Tears, Ubik, Holy, Zebra, Brahman, However, Maze, Wisdom, Advent, Like, World, Holy Wisdom, Even, Does, Again, Reality, Being, Nothing, More, Through, Living, Real, Certainly, Before, True, Universe, Will, Creation, Under, Body, Information, Wise, Except, Chardin

---
### Line 7310-7318 (Match: 'Teilhard')
...
16
```
**Co-occurrences**: Form, These, Like, Only, John, Time, Earth, Cosmic, Mind, Light, Just, Something, Although, Everything, Brain, Part, Their, Through, Universe, Ching, Beyond, Further, Have, Information, Magic, Hermes, Right, Answer

---
### Line 9248-9256 (Match: 'Teilhard')
**Folder**: part of
...
----------
```
**Co-occurrences**: Christ, Zebra, Complete, Form, Like, Because, Cosmic, Cosmic Christ, Does, Reality, Platonic, Living, Ground, True, Universe, Very, Dead, Chardin, Ananke

---
### Line 24184-24192 (Match: 'Teilhard')
**Folder**: part of
...
171
e 862 in that case yes; it was an evolutionary quantum leap in perception + cognition (vide Teilhard de Chardin). It was biologically + physiologically real. Since I can now pin I point what I experienced (acquired, displayed manifested) was shrewdness ("an almost uncanny ability to see below the surface" "an uncom‐ fortably or even dangerously close guess) I can see the survival utility pure + simple amidst the eerie + paranormal + mystical aspects. It was a form of instinct. Apparently I made use of a vast mind not my own but one that informs all creatures great + small although not always: not all creatures at all times + places. In that sense I was not functioning ontogenically but on some larger basis. As an expinant of an aggregate. I exhibited paranormal shrewdness, + as a survival factor this is probably the sine quo non shrewdness: guessing - + in such a way that there appears to be no basis for the guess being correct, or near correct, but it is; so it is uncanny; it can't be explained how the guess was made [correctly); + it looks below the surface it's a hunch. Paranormal - inexplicable. It's like a knowing; no, a para-knowing. You specifically to not know; this is precisely it. Yet you match the Gestalt of your guess as analog to he hidden underlying reality, +, although you ant prove it, the guess is paralled to the hidde ruth but not deduced - derived - from it! It i t arallel but not causually related. This is a ecial faculty. This acausal parallel Gestalt is working analog. A synchronication topologi‐

Last edit almost 3 years ago by svayambhu108
172
Needs Review
```
**Co-occurrences**: Form, Like, Since, Mind, Even, Gestalt, Reality, Being, Although, Great, Probably, Real, Such, Apparently, Chardin

---
### Line 24329-24337 (Match: 'Teilhard')
**Folder**: book of
...
196
58 But what would it really destroy within the echosphere? Strife. A Krasis would be formed: one interacting organism where randomness (a form of chaos) based on approximations (a form of the irrational. would be abolished; the wise mind (Valis) would decide which chipmunk to lose to an owl, + which chip munk to lead - or even isn't this exactly what drive - to safety. it did on my behalf? Being successfully trapped or successfully escaping a trap would depend on the decision of the core mind (Valis). So the simulation could simulate approximations whereas in fact coordination covertly would underlie all processes leading to desired goals. This is Teilhard's point omega: a con‐ verging of thought. the core mind could suspend its a priori knowledge existentially; i.e. it could know but not impart that knowledge to the sub‐ sumed creature unless the core mind so choose. Hence balance is retained but in a totally different way. Approximation space is retained as camouflage If you had that a priori knowledge, it itself would inform you of what its existence meant. "If an organism arose within an ecosphere with a priori knowledge (+ hence foreknowledge) of its vironment, so not using approximation space --" etc. am I such an organism? + I know a priori Valis, the wise mind - I innately knew of the dialectic,

Last edit almost 3 years ago by svayambhu108
197
Needs Review
```
**Co-occurrences**: Valis, Form, Mind, Even, Could, Being, Such, Would, Wise, Unless, Knowledge, Dialectic, Whereas, Chip

---
### Line 24364-24372 (Match: 'Teilhard')
**Folder**: part of
...
Needs Review
202
593 develop superior problem-solving abilities; i.e. to evolve. Valis is the system (which as I say, had to make adjustments when I solved the Xerox missive problem, especially in view of how I solved it). However there is a danger to the ecosphere in this a priori prior (foresighted) knowledge. The balance is jeopardized (for the reasons I give above). nonetheless this type of wisdom is that which both the O.T. + Zoroaster assign to God (i.e. the wise mind) himself (or Holy Wisdom herself; in any case it is the ultimate in knowing). So (presumably) it is favorably regarded by Valis; it is encouraged to come into existence, i but it represents a crisis in the ecosphere it may be a turning point, since approximate a posteriori or contingent) knowledge has given c way to a priori absolute knowledge - shrewdness. will not the ecosphere form, inexorably, one vast composite mind, now, such as Teilhard envisions as point omega a converging into unity + away from competitive plurality? this implies inevitable total integration + sub‐ sumation: final homeostasis: kosmos, per se. undoubtedly I am not the first, so this process has certainly already begun; what I did was join it. Could this already extant unitary composite entity be Valis? The need to problem-solve (in the manner I employed Acts like an alchemical crucible, transforming transmutating the solver igh

Last edit almost 3 years ago by svayambhu108
203
Needs Review
```
**Co-occurrences**: Valis, Acts, Holy, Xerox, Form, However, Wisdom, Like, Since, Holy Wisdom, Mind, Could, Both, Kosmos, Missive, Xerox Missive, Himself, Zoroaster, Nonetheless, Such, Certainly, Will, Absolute, Wise, Knowledge, Final
