...
### Line 8212-8220 (Match: 'Bruno')
**Folder**: part of

```text
Needs Review
123
115 In my "cosmogeny cosmoloay" I state that Zebra (3-74) was not the urgrund or true transcendent deity invading this world, but the artifact which created this world (+ therefore could not very well be regarded or act as an invader.). But on this point I could be very wrong. Like a spider entering its web to repair it - no, that still is the artifact. But the Spirit in my head was the spark of the divine -+ hence not Zebra. What I saw enternal to me was not what was in me. But I could be wrong. If ZEBRA was the urgrund, + not the artifact, then what I wit nessed as external, + experienced internally, was - has to have been - the Parousia. + I shrink from declaring that. Still, it was an invader in this world. Yet

Zebra uses mimickry to conceal itself from us, perhaps the mimiching fooled me into supposing it an invader. It was an invader, but in its own world (but making sure we never saw or suspected its existence, let alone its close presence In any case my paper winds up by accusing the artifact to be secretly working for our salvation; i.e. in conjunction with the urgrund - that the arti‐ fact is a teaching machine that wants us to rebel against it + affirm God. If the artifact isn't God it is at least an agent of God's plan of restoration. It did not know what its task was, + inflicted so much pain on us that we awoke. It, as Bruno believed, the mind/memory is divine + can reflect back "the divie which is behind the universe" Then weteach) are not fragments of the urgrund but

Last edit almost 3 years ago by svayambhu108
124
Needs Review
```
**Co-occurrences**: Spirit, Zebra, Well, Parousia, Perhaps, Like, World, Therefore, Urgrund, Mind, Could, Divine, Still, True, Universe, Deity, Very, Back, Have, Artifact, Memory, Salvation

---
### Line 8220-8228 (Match: 'Bruno')
**Folder**: part of

```text
Needs Review
124
11 analogs of the urgrund in which all of it is container in miniature, perhaps like - a seed; anyhow, the ur grund itself could be reconstructed out of any given one of us. What does this resemble (analogic think indited in my dream) if not the DNA present in each cell of the body- from which cell the entire body could be reconstituted (cloning). Or: suppose you photographed the cistuone chaped ceiling - + then the cistene chaped was destroyed. The painting could be retrieved" from the [little] photograph. There is topological congruency: one-to-one corres‐ pondence. Ir: consider the fact that a symphiny can be reduced" to a score, + the score can be "reduced" to a very long number, out of which the original symphony can be perfectly reconstituted. Or: like the mars pictures were radio transmitted in numerical dits. (4 different (from white to black) in all. memory. Stored information (as in a computer) but of a particular kind: like the magnetic patterns on iron ovide tape, not info concerning, say, "the magic Flute" is stored, but patterns (constituents) out of which the music realibation itself can be retrieved. This contains staggering

implications. ➀ Suppose gene pool memory (Bruno's magic memory) under anamnesis contains this sort of information out of which by analogic conversion former things can be efectly reconstructed via some sort of transduction. This is not really a novel or modern idea. in incient times poets memoriged whole ep to

Last edit almost 3 years ago by svayambhu108
125
Needs Review
```
**Co-occurrences**: Perhaps, Like, Iron, Black, Urgrund, Could, Does, Anyhow, Suppose, Anamnesis, Consider, Were, Very, Under, Things, Body, Memory, Information, Info, Magic, Dream, White

---
### Line 8226-8234 (Match: 'Bruno')
**Folder**: part of
...
126
```
**Co-occurrences**: Christ, Gnostic, However, Godhead, World, Iron, Urgrund, Mind, Hermetic, Anyhow, Something, Again, Although, Everything, Divine, Anamnesis, Consider, True, Macro, Universe, Have, Memory, Whether, Magic, Magus, Hermes

---
### Line 8237-8245 (Match: 'Bruno')
**Folder**: part of
...
Needs Review
127
119 I base this on (Bruno's + Parmenides] (the) concept that the urgrund is one: it is not polyencephalic in terms of a plurality of some kind. So here is an even deeper secret than the. uncovered so far. Projected delusional world - divine stratum beneath it - time travel - now I posit an augmented corpus Christi (my model all along). spanning all time + all space; i.e. ubiquitous (in time + space). It sounds like Xenophane's Noos, with this added: living men can participate in that Noos. + this Noos is the secret ruler of the world, so that those who are taken into it become "terminals" of it - i.e. temporarily Christs This would explain my 3-74 experience. My case may have been unusual; "they" sought me out. Is this mind, outside of time + space. God? In my opinion it is Holy Wisdom - i.e Christ. But Holy Wisdom conveys more, to me. It is possible that this mind is the sum total (+ No more) of all the "magi" throughout the ages, from all cultures, who have entered it: polyencephalic fusion extending back to Egypt. This is ZEBRA, the invisible gvide of history, unsuspected by those not in it. For me, it will always be primarily the corpus Christi, but probably it includes all wise men (e.g. Plato, Bruno, appolonics of yana, Asklepios, Irnaton, etc). This is quite some discovery. + it reaches over into the urgrund, with no clear demarkation. At that evel it's all one: man raised to Godhood, in response to

Last edit almost 3 years ago by svayambhu108
128
Needs Review
```
**Co-occurrences**: Christ, Holy, Zebra, Plato, Wisdom, Like, World, Parmenides, Time, Noos, Holy Wisdom, Urgrund, Mind, Even, Christi, Divine, Corpus, Probably, Those, More, Egypt, Corpus Christi, Living, Secret, Will, Would, Back, Have, Wise

---
### Line 8257-8265 (Match: 'Bruno')
**Folder**: part is
...
131
```
**Co-occurrences**: Christ, Thomas, Spirit, Holy, Rome, Christianity, Holy Spirit, Kingdom, Well, Wisdom, World, Because, After, Holy Wisdom, Good, Mind, Hermetic, Could, Simon, Kingdom of God, Empedocles, Although, Their, Another, Living, Secret, Consider, True, Death, Other, Erasmus, Very, Back, Many, Have, Absolute, Wise, Having, Knowledge, Greater, Magus, Human, Simon Magus, Until

---
### Line 8274-8282 (Match: 'Bruno')
**Folder**: part is
...
Needs Review
133
125 It may well be that my long-term suspicions about (1 enabled me to - unexpectedly - see not only it but ➁ as well. After all, in much of my writing (e.g. 3 Stigmata) the irreal world is manipulated by some sentient entity - this is the vulnerability of a merely projected world. + it is not just the maker of it that can "bend" it obviously. Did I not at last see (grast) ZEBRA as an invader, utalizing memesis? the "bending" could be "futuristic" technology. or world as expression (soma) of God's psyche - or of Noos: the bending was merely thought (+ that which "bent" was in me, too "bending" me from within as well as from without could it be said that [the enhanced, theoleptic) I did the "bending" around me? I with Bruno's "Magic universe -reflecting memory? This enhaned I extended beyond my body, out into the world around me. I say adamantly + definitely that (as swedenboroush sought for) what happened to me in 3-74 was that I (temporarily) regained the anima or soul lost knowledge (divine wisdom) which man lost in the fall. of this I am absolutely positive. Thrus anamnesis. I regained what I, as man, had lost. + I have known this to be the explanation of what happened in 3-74 ever since. This also represents the state of being saved (by divine intervention), the breaking of the power of the evil "God," + a recollection of innate hidden divinity isomorahism with the true God. a

Last edit almost 3 years ago by svayambhu108
134
Needs Review
```
**Co-occurrences**: Zebra, Well, Wisdom, World, Since, Fall, Only, After, Noos, Stigmata, Could, Just, Being, Obviously, Divine, Anamnesis, Without, Soul, True, Universe, Beyond, Have, Body, Memory, Evil, Knowledge, Magic

---
### Line 8419-8427 (Match: 'Bruno')
**Folder**: Book I
...
```
**Co-occurrences**: Christ, Acts, Christian, Form, Gnostic, Well, However, Perhaps, Father, World, Since, Fall, Because, Therefore, Only, Time, Cosmic, Paraclete, Faith, Urgrund, Mind, Hermetic, Cosmic Christ, Even, Does, Once, Again, Both, Reality, Being, Although, Self, Divine, Himself, Either, Gods, Anamnesis, Without, Brain, Creator, Those, Their, More, Church, Through, Egypt, Most, Real, Such, Upon, Actually, Secret, True, Universe, Finally, Will, Would, Other, Somehow, Very, Back, Many, Have, Artifact, Things, Life, Body, Memory, Freedom, India, Later, Having, Except, Magic, Magus, During, Human, Salvation, Right, Someone, Until

---
### Line 8421-8429 (Match: 'Bruno')
**Folder**: Book I
...
```
**Co-occurrences**: Acts, Christian, Gnostic, Well, Perhaps, World, Since, Because, Therefore, Only, Time, Urgrund, Mind, Hermetic, Does, Once, Again, Reality, Being, Although, Self, Divine, Himself, Anamnesis, Brain, Creator, Those, Their, Church, Through, Most, True, Universe, Finally, Will, Would, Other, Somehow, Very, Under, Many, Have, Artifact, Life, Absolute, Memory, Freedom, Later, Magic, Magus, Human, Right, Until

---
### Line 8423-8431 (Match: 'Bruno')
**Folder**: Book I
...
```
**Co-occurrences**: Acts, Christian, Gnostic, Well, Perhaps, World, Since, Because, Therefore, Only, Time, Urgrund, Mind, Hermetic, Does, Zebrapedia, Once, Again, Reality, Being, Self, Divine, Himself, Anamnesis, Brain, Those, Their, Church, Through, Most, True, Universe, Will, Would, Other, Somehow, Very, Under, Many, Have, Artifact, Life, Absolute, Memory, Freedom, Later, Magic, Magus, Human, Until

---
### Line 8431-8439 (Match: 'Bruno')
**Folder**: part of
...
Needs Review
58
88 James-James certainly was deranged, + it certainly was this world he was spinning out Ah! "James-James" symbolizes him being a spoiled little boy - with too many toys. "Time is infinitegold a child playing at draught." Heraclitus. "the Prietch's "dualism in the Godhead" + cornfords world soul is partly irrational." To these two state ments refer to the samething. Plus the Gnostic idea it of a "primordial crisis in the Godhead. my intuition that "the universe is trying to + become sane." What we see as chaos or evil or ananke or purposeless determirism causing undeserve suffering - all these stem from the part of God which is irrational. How‐ aver - St Sophia is the noos or rational part (i.e. Logos). fames-James was crazy + capricious. In a particular very specific way: childish, tuntrumish, with no frustration tolerance. The opposite of what the "AI voice I heard seemed to be like: it was totally reasonable one of the greatest errors I made was to assess a theo‐ phany as undication of immanent deity or even panpsychism. were that argument correct, there could be no revelation of a transcendent deity, as each theophany would be thus construed t I think of Bruno's notion of the divine mind behind the physical universe. What does "behind" signity? Within? Or the "ham sandwich" model (i.e. layers, as in an onion.) I now perceive The theophany as a kind of invasion of the inanimate by purre mind, with the result that the inanimate is transformed into a mallable animate "body" - not soma to psyche, how over, but much as spinoza regarded the universe as God extensive in space. But was just one limited part

Last edit almost 3 years ago by svayambhu108
59
Needs Review
```
**Co-occurrences**: Logos, Sophia, Gnostic, Spinoza, These, Godhead, James, Like, World, Time, Noos, Mind, Even, St Sophia, Could, Does, Just, Heraclitus, Being, Divine, Part, Soul, Voice, Certainly, Revelation, Universe, Deity, Would, Were, Very, Many, Body, Evil, Ananke

---
### Line 13590-13598 (Match: 'Bruno')
**Folder**: part means
...
Complete
```
**Co-occurrences**: Christ, Christian, Toso, Indexed, Zebra, Logos, Complete, Brahman, Gnosticism, Roman, Spinoza, World, Since, Therefore, Only, Paraclete, Platonism, Even, Anyhow, Jakob Boehme, Atman, Brain, Greco, Brahmanism, Most, Xenophanes, Such, Deity, Other, Body, Eckhart

---
### Line 14338-14346 (Match: 'Bruno')
**Folder**: folder 02
...
Folder, Anamnesis, Brain, Their, Through, Living, Voice, Before, Would, Were, Back, Have, Life, Memory, Information, Remember, Magic, Hermes

---
### Line 14393-14401 (Match: 'Bruno')
**Folder**: folder 02
...
Then when the continuity of identity between lives was lost, the wisdom (gnosis, sacred knowledge) was lost as well; I am not sure why, but when I "remembered" Thomas - actually, when Thomas returned, i.e. came back to life - the knowledge came with him. Perhaps, as Plato thought, it is acquired between incarnations i.e. in the other or upper worlds. Anyhow, the primal wisdom + memory are locked together, you can't have one without the other. Well, in that case the between-incarnations periods reinforce or add to whatever original knowledge there was - it would tend to _grow_, not diminish. Contrast this to it being entirely forgotten - lost! I gather that truly successful attempts to artificially induce anamnesis have been relatively few. Even the knowledge _that_ there are lost memories - but actually still in us, inhibited, requiring the proper disinhibiting stimuli - is uncommon. - The Macrocosm (universe) - Microcosm (man) theory leads to the interesting idea that any given human mind contains _latently_within_it_ the entire structure or soul of the totality, but in miniature, so _all_ knowledge can be retrieved out of one person's mind through mirror-like "magic recollection" (Bruno). Jung sees this as the collective unconscious: the repository of the phylogenic history of the person. Ontogeny contains phylogeny. This looks very much like my "onion" model in "Ubik" but in "Ubik" it is the macrocosm whose phylogeny is recapitulated latently. This takes us back from Freud to Empedocles;

Last edit over 9 years ago by Toso
folder 02 - 084
Complete
```
**Co-occurrences**: Ubik, Toso, Thomas, Complete, Plato, Well, Wisdom, Perhaps, Like, Gnosis, Folder, Mind, Even, Anyhow, Being, Empedocles, Toso
Folder, Anamnesis, Without, Still, Jung, Through, Soul, Actually, Universe, Would, Other, Very, Back, Whatever, Have, Life, Memory, Knowledge, Upper, Magic, Human, Sacred

---
### Line 14399-14407 (Match: 'Bruno')
**Folder**: folder 02
...
Folder, Their, More, Paracelsus, Jung, Most, Actually, Love, True, Macro, Universe, Very, Back, Have, Answer

---
### Line 14405-14413 (Match: 'Bruno')
**Folder**: folder 02
...
folder 02 - 086
```
**Co-occurrences**: Toso, Thomas, Complete, Form, Fish, Golden, Wisdom, Like, Since, Golden Fish, Folder, Mind, Bardo, Thodol, Bardo Thodol, Nous, Toso
Folder, Viewed, Another, Soul, Such, Upon, Actually, Death, Macro, Universe, Would, Life, Info

---
### Line 14416-14424 (Match: 'Bruno')
**Folder**: folder 02
...
Folder, Indexed
Folder, Those, Paracelsus, Soul, Living, Such, Secret, Would, Erasmus, Information, Dialectic, Dream, Right, Someone, Answer

---
### Line 14422-14430 (Match: 'Bruno')
**Folder**: folder 02
...
Complete
```
**Co-occurrences**: Ubik, Toso, Complete, Gnostic, Well, Perhaps, Because, Folder, Book, Hermetic, Even, Okay, Just, Suppose, Although, Self, Orphic, Toso
Folder, Another, Through, Such, Finally, Other, Were, Have, Having, Right, Someone

---
### Line 14434-14442 (Match: 'Bruno')
**Folder**: folder 02
...
Indexed
folder 02 - 090
host brain, person + space-time world which carries it, + can work _through_ that host without its knowing (e.g. me). Thus we have here a master or matrix personality _living_in_more_ than one _time_; he is a transtemporal constant, + can add later persons to his rank, at his discretion. This is the highest initiation possible in all history, _+_is_kept_extraordinarily_ secret - which I must do. This is the matrix secret of the renaissance illuminati: passing the secret of immortality _directly_ from the secret immortal early xtians who learned (?) it from Christ. It has been passed to me: it is not knowledge as such (gnosis), like a recipe, etc - the life _itself_ is passed on (what I call "Firebright") using later humans as hosts. Under certain circumstances the immortal self surfaces + makes himself known to the host, which "initiates" the host, so that he, now, is drawn into this ongoing process. Some kind of "phylogeny in the ontogeny" is made use of, like an ultrasophisticated scientific principle. (Jung's collective unconscious.) Hence this symbol: [DNA double helix symbol] or ["whale's mouth" symbol] or: [ichthys symbol] or Bruno's "magic memory" - i.e. anamnesis. + not only does he possess immortality, but is also in touch with the Logos, Christ himself, St. Sophia, the AI voice I hear. The microcosm has entered syzygy with the soul of the macrocosm.

Last edit over 9 years ago by Toso

Folder 03 - 001
```
**Co-occurrences**: Christ, Christian, Toso, Indexed, Logos, Sophia, Like, World, Gnosis, Only, Time, Folder, Firebright, Does, Self, Toso
Folder, Himself, Anamnesis, Without, Indexed
Folder, Brain, Jung, Soul, Such, Voice, Secret, Under, Have, Life, Memory, Later, Knowledge, Magic
