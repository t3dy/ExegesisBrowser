...
```
**Co-occurrences**: Spirit, Holy, Logos, Rome, Christianity, Holy Spirit, Form, Parousia, However, Elijah, Father, Like, Fall, Because, Time, Harpax, After, Something, Once, Again, Zagreus, Being, Empedocles, Divine, Himself, Anamnesis, Without, More, Another, Upon, Actually, Fullerton, Certainly, Death, Universe, Would, Were, Back, Things, Life, Memory, Freedom, Jungian, Having, Remember, Unless, Dead, Suddenly, Mary

---
### Line 1845-1853 (Match: 'Adam')
**Folder**: part remain
...
Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Christian, Spirit, Holy, Holy Spirit, Form, Greek, Well, Perhaps, Maybe, Like, World, Only, Time, Harpax, Mind, Light, Even, Could, Does, Just, Something, Suppose, Diagram, Self, Without, Brain, Kathy, Those, Still, Part, More, Another, Most, Heaven, Such, Voice, Certainly, Death, Will, Would, Other, Somehow, Judge, Were, Attic, Back, Under, Campbell, Have, Life, Absolute, Justice, Days, Unless, Knowledge, Joseph, Cross, Truth, Greater, Human, Doesn, Joseph Campbell, Right

---
### Line 2524-2532 (Match: 'Adam')
**Folder**: part of
...
```
**Co-occurrences**: Sophia, World, Harpax, Aristotle, Death, Would, Life, Evil, Free

---
### Line 2996-3004 (Match: 'Adam')
**Folder**: Book of
...
```
**Co-occurrences**: Christ, Sophia, Paul, Well, These, Advent, Maybe, Like, Since, Fall, Only, Time, After, Cosmic, Book, Cosmic Christ, Even, Could, Anyhow, Just, Something, Again, Being, Great, Probably, Without, Grace, Nothing, Zoroaster, Those, More, Church, Another, Certainly, Before, True, Universe, Will, Calvin, Would, Were, Back, Have, Life, Body, Except, During, Whereas, Right, Someone

---
### Line 3065-3073 (Match: 'Adam')
**Folder**: Book of
...
Needs Review
```
**Co-occurrences**: Christ, Christian, Thomas, Spirit, Holy, Logos, Complete, Christianity, Sophia, Plato, Kingdom, Gnostic, Paul, Greek, Well, Bible, Gnosticism, Wisdom, Godhead, Father, Like, World, Fall, Time, After, Savior, Holy Wisdom, Good, Book, Gospel, Anyhow, Just, Once, Simon, Kingdom of God, Both, Being, Obviously, Orphic, Covenant, Either, Anamnesis, Creator, Their, Pantocrator, Through, Real, Before, Revelation, Mother, Death, Universe, Finally, Would, Judge, Were, Back, Many, Journey, Things, Body, Memory, Jungian, Truth, Magus, Doesn, Pleroma, Answer, Simon Magus

---
### Line 3939-3947 (Match: 'Adam')
**Folder**: book of
...
Needs Review
```
**Co-occurrences**: Christ, Ubik, Logos, Form, Sophia, Brahman, James, Like, World, Only, Savior, Just, Again, Reality, Being, Atman, Himself, Anamnesis, Creator, Through, Such, Upon, True, Will, Were, Whatever, Have, Life, Memory, God Himself, Knowledge, Dream, Free, Pleroma

---
### Line 5771-5779 (Match: 'Adam')
**Folder**: Book of
...
Needs Review
```
**Co-occurrences**: Christ, Spirit, Kingdom, Bible, World, Fall, Garden, Book, Even, Anyhow, Kingdom of God, Both, Reality, Being, Christi, Corpus, Palm, Anamnesis, More, Another, Corpus Christi, Finally, Kingship, Back, Tree, Memory, Evil, Remember, Salvation

---
### Line 7460-7468 (Match: 'Adam')
**Folder**: part of
...
```
**Co-occurrences**: Jesus, Xerox, Well, Gnosticism, Godhead, Scanner, World, Gnosis, Only, John, After, Good, Even, Does, Something, Look, Missive, Xerox Missive, Viewed, Those, Still, Part, Through, Universe, Back, Many, Have, Artifact, Life, Later, Days, Evil, Having, Right

---
### Line 8369-8377 (Match: 'Adam')
**Folder**: part of
...
Needs Review
149
140 Is this all some gigantic 2-player board game? There is a missing piece. +, as Calvin says, we are occluded. This being established, there is no way we (the occluded mechanism) can retrieve the missing piece. "Did Adam fall, or was he pushed?" All erased. The occlusion is right here in my head. there is a teaching machine present, ZeBra, but it is an invader, + camouflaged re the "false" external causality: in Knbit 3-74 I continued to react - act - in 8857000 response to external pretextual stimuli 845-7000! out of synch (I believe before they hap‐ pened) - thus revealing to me the structure channal if I of ingerrious + concealed engramming - with the real causal agent not lying external but somehow "pre‐ wound" in me (which is why I called the police). I can only appeal to Leibnitz, here, regarding synchronized munadic harmonics forming the cosmos. the significance of this (realization) beggars description. We (all) are meshed with all processes but this "astral" determinism can be broken - at which point we are liberated + become free (which is the true meaning of salvation: to comprehend what we are saved from this "astral" or "sin" slavery must be compre‐ hended, + we do not; the prevailing mundane power has given us a totally spurious sense of already being free: which is a major part of the whole delusional structure +as a part of this mechanism, is what K.W. refers to an in "inner clutch" but not under the control (or even within he awareness) of the individual. Thus separate constituents of information can be linked into meaningful sequences varying from person to person. That we are under the dominion of it least one titanc supernatural entity is obvious; it seems to resemble Xerophanes' noos. But there man be 2, with the 2nd prying us loose from the or

Last edit almost 3 years ago by svayambhu108
150
Needs Review
```
**Co-occurrences**: Zebra, Fall, Only, Noos, Even, Being, Part, Leibnitz, Real, Before, True, Calvin, Somehow, Under, Information, Salvation, Free, Right

---
### Line 12747-12755 (Match: 'Adam')
**Folder**: book was
...
Complete
```
**Co-occurrences**: Christian, Spirit, Holy, Zebra, Jesus, Complete, Holy Spirit, Paul, Lord, Only, Time, Savior, Just, Kerygma, Gods, Dionysus, More, Egypt, Such, Before, Death, Will, Back, Durant, Pentecost

---
### Line 12918-12926 (Match: 'Adam')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Complete, Form, Plato, Godhead, Like, World, Fall, Only, Time, Noos, Could, Jakob Boehme, Realm, Reality, Divine, Would, Very, Have, Later, Knowledge, Lower, Genesis, Pleroma

---
### Line 14344-14352 (Match: 'Adam')
**Folder**: folder 02
...
```
**Co-occurrences**: Toso, Thomas, Complete, Form, Roman, Wisdom, World, Fall, Because, Noos, Folder, Being, Toso
Folder, Anamnesis, Brain, Their, Bruno, Through, Living, Voice, Before, Would, Were, Back, Have, Life, Memory, Information, Remember, Magic, Hermes

---
### Line 16334-16342 (Match: 'Adam')
**Folder**: Book of
...
Last edit about 9 years ago by Toso
folder 20 - 005
Complete
```
**Co-occurrences**: Toso, Complete, Like, Only, Folder, Garden, Light, Could, Toso
Folder, Darkness, Will, Other, Were, Back, Tree, Life, Neither, Remember, Whereas, Until

---
### Line 16369-16377 (Match: 'Adam')
**Folder**: folder 20
...
Indexed
```
**Co-occurrences**: Christ, Tears, Christian, Toso, Indexed, Sophia, Kingdom, World, Prison, Time, Nixon, Folder, Garden, Buddha, Light, Does, Just, Once, Kingdom of God, Self, Toso
Folder, Apollo, Jewish, Without, More, Most, Voice, Other, Creation, Back, Many, Have, Dark, Dream, Salvation

---
### Line 16422-16430 (Match: 'Adam')
**Folder**: Book of
...
Complete
```
**Co-occurrences**: Christ, Acts, Toso, Indexed, Zebra, Complete, Paul, Perhaps, Father, Like, Prison, Folder, Garden, Savior, Book, Just, Toso
Folder, Himself, Great, Augustine, Probably, Indexed
Folder, Another, Through, Voice, Finally, Will, Were, Back, Have, Freedom, Info, God Himself, Karmic, Salvation, Genesis, Durant

---
### Line 16438-16446 (Match: 'Adam')
**Folder**: Book of
...
irreal; as in "Scanner" we are unaware of our occlusion + hence where we are. That is very basic + very important: we made a primordial error, all right, +, as in the Book of Adam + Eve it led to our expulsion from our primordial original home, the Garden, + imprisonment in this prison. But the error was intellectual, taking the irreal to be real. The road to salvation is an epistemological one, not ethical - but it is useless for us to try on our own, since the specific nature of our occlusion defeats us. Only Christ can save us, like Runciter or Ubik, from "outside". We did + are born here again + again, no more enlightened each time, unless he intervenes. At a single bold stroke the delusive power of this world, this prison, must be broken over us, as it was with me in 2-3/74. But my 25 years of writing + world-view had to preceed 2-3/74, had to lead up to it. Thus I say, my writing is an antidote to the delusion, to the occlusion (intoxication). Since the original error ("sin") is intellectual, not moral, then the antidote is knowledge; + the instrument of that salvific gnosis is Pansophiaism. The secret agents of that gnosis are the invisible Hermetic Paracelsusian adepts, + the goal of it is the creation of what I call Homoplasmates, through the mystical conjunction (wedding). Because of the self-world push-pull system which I believe exists there is no way to demonstrate the intellectual error (the spuriousness of world or rather worlds plural). Thus the savior, who enters the situation from outside, is necessary. Once my faculties were restored + I could see him (Zebra)

Last edit over 8 years ago by Toso
folder 20 - 015
Indexed
```
**Co-occurrences**: Christ, Ubik, Toso, Indexed, Zebra, Scanner, Like, World, Since, Gnosis, Because, Prison, Only, Time, Folder, Garden, Savior, Book, Hermetic, Could, Once, Again, Runciter, Self, Toso
Folder, Indexed
Folder, More, Through, Real, Secret, Creation, Were, Very, Unless, Knowledge, Salvation, Right

---
### Line 16581-16589 (Match: 'Adam')
**Folder**: Book of
...
Complete
```
**Co-occurrences**: Toso, Complete, Like, World, Fall, Prison, Folder, Book, Realm, Being, Divine, Toso
Folder, Great, Anamnesis, Those, Still, Through, Most, True, Macro, Would, Creation, Were, Back, Have, Memory, West, Lower, Genesis
