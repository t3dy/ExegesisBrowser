...
156
```
**Co-occurrences**: Christ, Tears, Rome, Kingdom, King, Felix, Well, Bible, Parousia, However, Perhaps, Maybe, Like, World, Since, Fall, Therefore, Iron, Only, Time, Harpax, After, Even, Could, Does, Kingdom of God, Although, Moses, Either, Still, Their, Egypt, Babylon, Revelation, Death, Will, Would, Angel, Were, Have, Life, Wise, Evidently, Genesis, Free, Right, Until, August

---
### Line 2465-2473 (Match: 'Biblical')
**Folder**: book was
...
```
**Co-occurrences**: Tears, Christian, Spirit, Holy, Jesus, Christianity, Holy Spirit, Form, Plato, Greek, Bible, Parousia, Wisdom, Dionysos, These, Perhaps, Father, James, Since, Because, Iron, Time, Harpax, Could, Does, Once, Again, Zagreus, Being, Divine, Himself, Apollo, Gods, Fate, Deus, Grace, Nothing, Those, Still, Part, More, Zeus, Most, Death, Macro, Will, Would, Other, Erasmus, Back, Beyond, Surely, Whatever, Under, Many, Have, Life, Evil, Magic, Right, Ananke, Grail

---
### Line 2791-2799 (Match: 'Biblical')
**Folder**: Book of
...
Needs Review
```
**Co-occurrences**: Christ, Tears, Christian, Ubik, Spirit, Holy, Logos, Jesus, Holy Spirit, King, Paul, Fish, Felix, Well, Bible, Parousia, Golden, Maze, Perhaps, Scanner, World, Because, Golden Fish, Only, Earth, After, Book, Even, Could, Just, Something, Although, Girl, Frolix, Daniel, Deus, Those, More, Living, Real, Secret, Revelation, Irae, Death, Other, Back, Under, Many, Have, Clearly, Judgment, Life, Body, Later, Evil, Deus Irae, Dream, Evidently, Genesis, Final, White

---
### Line 3429-3437 (Match: 'Biblical')
**Folder**: part of
...
Last edit almost 5 years ago by svayambhu108
```
**Co-occurrences**: Christ, Kingdom, Maze, Perhaps, Advent, Father, Like, World, Since, John, Time, After, Good, Mind, Light, Could, Reality, Although, Daniel, Without, Darkness, Those, More, Another, Through, Real, Before, True, Will, Would, Somehow, Were, Very, Back, Beyond, Under, Have, Things, Judgment, Knowledge, During, Evidently, Final, Until

---
### Line 3492-3500 (Match: 'Biblical')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Acts, Xerox, Rome, Greek, Bible, Maze, Maybe, World, Because, Only, Time, Even, Could, Just, Something, Once, Reality, Being, Obviously, Self, Everything, Probably, Anamnesis, Those, Dokos, Another, Brahmanism, Real, Actually, Calif, True, Will, Other, Very, Back, Have, Things, Judgment, Life, Absolute, Later, Having, Remember, Truth, Suddenly

---
### Line 3560-3568 (Match: 'Biblical')
**Folder**: book of
...
Needs Review
```
**Co-occurrences**: Christian, Logos, Christianity, Form, Plato, Bible, Maze, Like, World, Book, Even, Does, Just, Look, Reality, Nothing, More, Another, Living, Real, Such, True, Would, Were, Have, Info, Human, Dream

---
### Line 6061-6069 (Match: 'Biblical')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Tears, Acts, Christian, Holy, Logos, Rome, Form, However, Maze, Wisdom, Perhaps, Advent, Like, World, Time, Holy Wisdom, Mind, Even, Could, Just, Daniel, Anamnesis, Part, Another, Through, Real, Such, Certainly, Deity, Would, Were, Back, Information, Info, Right

---
### Line 6085-6093 (Match: 'Biblical')
**Folder**: part of
...
Needs Review
28
25 t persion saw through ➁ + relater to (1) he would be in the strange position of experiencing the distant past + future simultaneously: A) He would see as still extant ancient archetypes hazed over in (2) + B) He would en his own time experience what for other people would only come later when (2) peters out entirely. At first he would recapitu late the past, then phase over into prophesized events; i.e. to end-time events. The whole story being narrated (i.e. thought) by the deity would disclose it self to him +, oadly, he would be deluged with books + pages of writing since the apparatus he was plugged into is primarily computer-like (teaching machine + library like). The Bible is a fusion of ➀ ➀ + (3), of most use is that of a doorway to (1), available to minds locked into (3), read in a way excluding ( to which it unleasingly relates. The time rate (flow) of the Bible is the true time rate; that of (2) is not - is deluding in fact, giving a spurious impression (record) of a great deal of passing time. Percing by (3) to (1), or by upward into (3) it is between 70 - 90 AD, i.e. just falling the 1st Advent + just before the 2nd. My God - the Bible is the story which the punched computer tape of (1) is printing out via (2), directed at fulfilling ( I can deduce this from the Biblical elements in, e.g. I "Tears." It is (1) incising onto (3) via (2). "Tears" is a The only other way the elements of G mixtue of ➀ + (2 s could appear in my writing would be racial memory, but the "racial memory" would deal with realm to under lying anyhow, so just the why, not the what, would be changed (i.e. the reason I linked up to (1) directly, bypassing (). To sum up: realm ➁ is being spun or woven into realm ( which is a replication of realm ( which is doing the spinning + weaving.

Last edit almost 3 years ago by svayambhu108
29
Needs Review
```
**Co-occurrences**: Tears, Bible, Advent, Like, Since, Only, Time, Book, Could, Anyhow, Just, Realm, Being, Self, Great, Still, Through, Most, Before, True, Deity, Would, Other, Under, Memory, Later

---
### Line 6143-6151 (Match: 'Biblical')
**Folder**: part but
...
Needs Review
```
**Co-occurrences**: Tears, Christian, Thomas, Rome, Fish, Golden, Roman, These, Like, World, Since, Golden Fish, John, Time, Even, Something, Look, Both, Being, Nothing, Brain, Still, More, Church, Another, Real, Secret, True, Were, Luther, Impostor

---
### Line 8494-8502 (Match: 'Biblical')
**Folder**: part of
...
Indexed
```
**Co-occurrences**: Christ, Indexed, Logos, Form, Wisdom, World, Since, Only, Noos, Mind, Light, Could, Does, Soviet, Reality, Being, Without, Through, Most, Xenophanes, Real, Flux, Universe, Would, Other, Human, Genesis, Final

---
### Line 10331-10339 (Match: 'Biblical')
**Folder**: part of
...
If I just had the "Acts" + other biblical material in "Tears" to go on, it wouldn't be conclusive. The 2-74/75 anamnesis virtually authenticates it. But both together (to me, anyhow) makes me certain, since the two absolutely agree down to the year, the characters + events: congruence, not approximation merely. Coincidence on suggestive [..] under pentathol are ruled out.

Then if VALIS / Zebra is to be regarded as a sort of AI teaching machine camouflaged here, it is - as the ultimate lesson - moving us toward a disclosure of the above the above (the world of Acts + the savior to return imminently, despite all surface appearances to the

Last edit about 5 years ago by sekennedy62
```
**Co-occurrences**: Valis, Tears, Acts, Zebra, Satan, World, Since, Time, Savior, Anyhow, Just, Both, Reality, Anamnesis, True, Other, Under, Except

---
### Line 11060-11068 (Match: 'Biblical')
**Folder**: part of
...
51
51 suppose it is maintained (as with the Gnostics) that it was not man which fell but his "distant cousin from the pleroma, (Sophia), + this fall is what cornford discerns in Plato's world soul as irrational. Suppose such an event as St Sophia addressing me is not an instance of something which has always occured or at least always been possible. But that the world soul (like Brahman) is "waking up" - again becoming conscious + able to think - + speak - rationally who ever before has reported St. Sophia speaking to them? Only in Biblical times. What it/she said to me seems to parallel what the shepherds were told at the time Christ was born; i.e. an unprecedented event in human history was about to - beginning to - take shape. Then "St Sophia will be born again..." etc. refers to a total rebirth of the cosmos into sentience - lucidity - an exact parallel to "Brahman sleeps, the Brahman dances, with the notion that the universe is a form which Brahman takes, assumes, is, or poses as I have a very strong intuition at this point that the above reasoning points to me (dare I say it?) as a Kingping ruman in a cosmological drama of reawakening. The macro-entity awakens (to lucidity?) + then on our world in micro form - + perhaps on many other worlds - it prepares to one again incarnate. Then its announcement to me carries the weight + force of revelations described in the Bible, esp. the N.T. is it connected with the insertions in Deus iral? The novel is selling in an awfied lot of countries to an awful lot of reople. At that time (N.T.) it was the role of John the Baptist to nnounce the coming of the Messiah - he thus was Elijah. hich for a long time I believed Thomas to be

Last edit almost 3 years ago by svayambhu108
52
Needs Review
```
**Co-occurrences**: Christ, Thomas, Form, Sophia, Plato, Gnostic, Brahman, Bible, Perhaps, Elijah, Like, World, Fall, Only, John, Time, St Sophia, Something, Again, Suppose, Deus, Soul, Such, Before, Macro, Universe, Will, Other, Messiah, Were, Very, Many, Have, Human, Baptist, Pleroma

---
### Line 12033-12041 (Match: 'Biblical')
**Folder**: Unknown
...
```
**Co-occurrences**: Tears, Acts, Rome, Felix, Perhaps, Father, After, Black, Book, Even, Gospel, Could, Just, Philip, Anamnesis, Real, Secret, Finally, Very, Later

---
### Line 12203-12211 (Match: 'Biblical')
**Folder**: Unknown
...
56
Unexplained are: If I did not recognize the Acts (biblical) elements in "Tears" when I wrote it, how come I properly identified them the month "Tears" was release + I found myself in that very same world? Why didn't I identify that world as the one I had written about?
...
The questions in para one are more astute than first appears. The questions - one question actually - is formally phrased as: "If you can identify y, why can't you identify y?"
```
**Co-occurrences**: Tears, Acts, Rome, These, World, More, Such, Actually, Very

---
### Line 12810-12818 (Match: 'Biblical')
**Folder**: Unknown
...
church" that I write about + know exists actually consists of apostolic age xtians; some of us (all at first?) had false memories + identities + believes in what they saw, but techniques exist + are used to promote anamnesis - among this small grout - who, as I say, are the actual Biblical Xtians. This Satanic interpolation is what I calll "The Kingdom [age] of Tears" - actual realisty is innocence + joy.

------

Upon reading Roman I see that my whole doctrine of acquital - in "Tears" - is indeed the Good news - kerygima - of God's Grace, as I was sure it was. I have, in fact, very well expressed it. the joy, the innocence, God's mutual love for/with his sons (us), specifically, I worked out the concept of God's saving Grace, in a surprising complex fashion ➀ I saw Christ, discorporate + cosmic, + the proof of it was the transformation of pinky; this is one of the signs foretold. ➀ The concept is hard to understand, + yet. reading over what I wrote, ➁ I see that only with divine assistance could I ever have arrived at such an accurate + comprehensive understanding of it - + - if turned into one of acquital through agapē. ➁ in these previous pages
```
**Co-occurrences**: Christ, Tears, Christian, Complete, Kingdom, Well, Roman, These, Only, Cosmic, Good, Could, Pinky, Divine, Anamnesis, Grace, Church, Through, Such, Upon, Actually, Love, Very, Have, Sons

---
### Line 12949-12957 (Match: 'Biblical')
**Folder**: book has

```text
Last edit over 4 years ago by bendakar1
114
Needs Review
114
i other biblical material in "Tears" it is Acts. what does this realization (about additional Acts material in "Tears") we me? When I wrote "Tears" I was con o sciously striving to describe agape - the takes us back to Rome CAD 45-70, which in is remarkable enough, but then I see it, a t me - actually there. I describe the future the past. The response to Rome is this i version; the solution to Rome is this conce effected through death, grief + years to con exculpation. I wrote it but I don't un t stand it. It is a magic + a miracle so s that it can abolish the BIP + its warp. power, as if the tears are a solvent agage The true power, issuing out of grief. I must remember Rome + these events i the experience on the road to Damascus. am I? Who is "Thomas"? He is an an stolic Xtian. He remembers. "Wer seen brennen in meiner Brust As 4 it insists on the importance of the Holy Spirit Acts attributes the spread of the developing church to the wor yous activity of the Holy Spirit, + why it seems so full of sp som + wonder at God's works - that is why the book has been called "the gospel of the Spirit'" etc. Jerusalem bi t Acts is the scriptural account of the Hol Spirit. Thus I say, about this does the spirit well kn the I i o t

Last edit almost 3 years ago by svayambhu108
115
Needs Review
```
**Co-occurrences**: Tears, Acts, Christian, Thomas, Spirit, Holy, Rome, Holy Spirit, Well, These, Book, Gospel, Does, Church, Through, Actually, True, Death, Other, Back, Remember, Magic
