...
```
**Co-occurrences**: Indexed, Bible, Like, Since, Time, After, Book, Okay, Zebrapedia, Will, Claudia, Testament, Chip, Final

---
### Line 159-167 (Match: 'Ground')
**Folder**: book of
...
```
**Co-occurrences**: Complete, Like, Only, Book, Being, Runciter, Still, Wait, Star, Heaven, Voice, Actually, True, Universe, Would, Whatever, Have, Claudia, Spring, Except, Dream, Until

---
### Line 393-401 (Match: 'Ground')
**Folder**: book A
...
```
**Co-occurrences**: Christian, These, Time, Suppose, Both, Maya, Reality, Being, Grace, Nothing, Real, Upon, Would, Back, Have, Absolute

---
### Line 448-456 (Match: 'Ground')
**Folder**: book about
...
Needs Review
```
**Co-occurrences**: Acts, Spirit, Sophia, Greek, Golden, Wisdom, Dionysos, Perhaps, Elijah, Like, World, Since, Only, Time, Harpax, Even, Does, Just, Once, Again, Both, Being, Although, Everything, Dante, Divine, Aristotle, Either, Gods, Anamnesis, Part, Their, More, Another, Soul, Actually, Certainly, Before, Consider, Greece, True, Universe, Will, Deity, Would, Very, Attic, Whatever, Have, Life, Body, Memory, Whether, Knowledge, Upper, During, Human, Lower, Evidently, Right

---
### Line 1577-1585 (Match: 'Ground')
**Folder**: book COSMIC
...
Needs Review
```
**Co-occurrences**: Christian, Form, Fish, Golden, These, Maybe, Like, Golden Fish, Time, Harpax, Light, Anyhow, Once, Great, Jewish, Still, Wait, Finally, Back, Under, Life, Lower, Right

---
### Line 1892-1900 (Match: 'Ground')
**Folder**: part left
...
Needs Review
```
**Co-occurrences**: Christ, Thomas, Kingdom, Greek, Well, Maybe, Like, World, Because, Time, Harpax, Gospel, Just, Something, Reality, Being, Probably, Nothing, Part, Another, Through, Egypt, Real, Universe, Will, Calvin, Would, Other, Somehow, Were, Whatever, Have, Life, Fake, Information, Instead, Jungian, Luther, Except, Suddenly, Human, Right, Until

---
### Line 1898-1906 (Match: 'Ground')
**Folder**: part left
...
```
**Co-occurrences**: Logos, Form, Kingdom, Well, These, Maybe, Like, World, Because, Only, Time, Harpax, Garden, Light, Could, Joint, Does, Once, Reality, Kosmos, Heraclitus, Being, Self, Everything, Without, Brain, Still, Through, Most, Real, Such, Voice, Upon, Actually, Before, Mother, True, Universe, Very, Back, Beyond, Have, Things, Justice, Memory, Having, Truth, Magic, Right, Until

---
### Line 1924-1932 (Match: 'Ground')
**Folder**: part left
...
166
```
**Co-occurrences**: Christ, Spirit, Holy, Holy Spirit, Form, Kingdom, These, Godhead, World, Therefore, Time, Harpax, Mind, Light, Firebright, Could, Look, Again, Kingdom of God, Being, Divine, Great, Darkness, Jung, Through, Soul, Heaven, Real, Such, Before, Universe, Will, Other, Creation, Somehow, Back, Have, Claudia, Dark, Later, Human

---
### Line 2327-2335 (Match: 'Ground')
**Folder**: part of
...
Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Christ, Tears, Logos, Kingdom, Greek, Well, Parousia, These, World, Because, Therefore, Time, Harpax, After, Mind, Could, Anyhow, Once, Again, Kingdom of God, Teilhard, Being, Great, Viewed, Part, Through, Most, Heaven, Real, Gold, Such, Voice, Before, Would, Other, Somehow, Ching, Very, Back, Beyond, Have, Clearly, Things, Memory, Cross, Dream

---
### Line 2335-2343 (Match: 'Ground')
**Folder**: part of
...
```
**Co-occurrences**: Christ, Tears, Holy, Sophia, Kingdom, King, Parousia, These, Advent, World, Because, Time, Harpax, After, Buddha, Something, Kingdom of God, Both, Although, Viewed, Through, Real, Voice, Secret, Will, Other, Very, Later, Dream, Right

---
### Line 2628-2636 (Match: 'Ground')
**Folder**: part of
...
201
```
**Co-occurrences**: Ubik, Like, World, Because, Therefore, Only, Time, Harpax, Mind, Even, Does, Anyhow, Something, Once, Reality, Being, Although, Viewed, Nothing, Still, Part, More, Another, Through, Most, Real, Universe, Will, Would, Back, Beyond, Have, Things, Whether, Greater, Evidently, Doesn, Answer

---
### Line 3031-3039 (Match: 'Ground')
**Folder**: Book of
...
```
**Co-occurrences**: Logos, Jesus, Kingdom, Greek, Well, Golden, Maybe, Like, Since, Only, Time, Even, Gospel, Could, Anyhow, Just, Once, Again, Kingdom of God, Heraclitus, Obviously, Girl, Everything, Divine, Covenant, Probably, Their, Soul, Living, Real, Before, True, Will, Would, Creation, Judge, Were, Back, Egyptian, Beyond, Under, Life, Body, Dark, Wise, Whether, Remember, Except, Cross, Evidently, Someone

---
### Line 3874-3882 (Match: 'Ground')
**Folder**: part of
...
11
```
**Co-occurrences**: Ubik, Sophia, Brahman, Fish, Well, Wisdom, Like, World, Since, After, Savior, Could, Just, Look, Again, Runciter, Atman, Himself, Great, Their, Star, Through, Gold, Upon, Would, Life, Dream, Chip

---
### Line 3951-3959 (Match: 'Ground')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Kingdom, Like, World, Since, Gnosis, Because, Only, Time, Mind, Even, Gospel, Could, Does, Again, Kingdom of God, Being, Everything, Part, Their, Nonetheless, True, Universe, Will, Would, Have, Judgment, Berkeley, Whether, Knowledge, Human

---
### Line 4079-4087 (Match: 'Ground')
**Folder**: part could
...
Needs Review
```
**Co-occurrences**: Xerox, Rome, Christianity, Iron, Prison, Time, Black, Karma, Once, Self, Black Iron Prison, Grace, Their, Actually, Before, Finally, Will, Life, Karmic, Iron Prison, Right

---
### Line 4165-4173 (Match: 'Ground')
**Folder**: book which
...
Needs Review
```
**Co-occurrences**: Tears, Maybe, Like, World, Book, Even, Could, Soviet, Look, Once, Although, Self, Everything, Still, Gold, Certainly, Revelation, Other, Many, Have, Life, Information, During, Evidently, Track

---
### Line 4384-4392 (Match: 'Ground')
**Folder**: part of
...
Q: (written + audio messages are created + sent, either scrambled set/ground or divided into [two] portions + requiring relinking the knowledge of which PTS to match being akin to the color coding of the 3-D a superimposed set/ground system unscrambling requiring the depth sense based on the color discrimination of the 3rd eye) although it is evident that the information emanates from Zebra (which is my nickname for the mimicking entity) for whom are they intended? other parts of Zebra? Is this how Zebra maintains itself as a concerted unitary entity? Like nerve impulses within a body - inner information, among the parts: Zebra is body or brain or both. This fit with my noetic impressions that we are within Zebra's body. In our own (micro)body Neural signals travel all over - sense impressions, orders to muscles pain, etc. our own bodies are alive with messages, so is Zebra. + there is coding (i.e. use of declaratory symbols + cypher)

It is interesting, how we inadvertently (unknowngly) carry Zebra's mesages for It., Piggyback on our own. it's as if Zebra says "as long as you're born, that direction take this along too" I suppose a phagocyte doesn't know anything about its [job?] either. In seeing these messages flying back & forth I may mave witnessed our primary function withinn Zebra. It certainly must be mine
...
```
**Co-occurrences**: Zebra, These, Perhaps, Like, Since, Time, Could, Suppose, Both, Being, Although, Either, Brain, Certainly, Other, Back, Body, Information, Knowledge, Human, Doesn
