...
### Line 2720-2728 (Match: 'St Sophia')
**Folder**: book in
...
Needs Review
79
3 Tears describes our world not distant in tire ot in space my other personality is my actual one, who flee here. St Sophia is our leader, about to be reborn - all these things in my books will tell us what's happening. + possibly, duer what to quiet secrets, one by one do (Tears dream we are being reborn, + soon our leader (Christ) be. That is why the Bible speaks of "bee will again frure above, in the spirit) - in ade to born last time we could not get the Kingdered. entr king accepted here, but this time we will be our - are being - successful 1 against the God. (Nixon) 2) my small battle was non this fie 3) Finally Christ will be accepted. others of us were asklepios, Ptath (or thoth) Empedicles (as he himself said), apollonius of Tyana. Our ship or whatever - anyhow we landed (or what ever) princibly in Greece, so when anamnesis occurs we revert back to Greek our lagsuan one of our best kept secrets as is that our King is a female. the Golden Rectangle is a space ward gate to another planet. Maybe where we'll go next - a planel where we con, unlike here (so far).
...
76
3 transsubstantiation gotten with in objects + processes by a sort of plasmatic infiltration + the reason that what I glimpsed has not been glimpsed over the past 2000 years is two fold He has only recently "inserted" or "immersed 1) himself this much down into our world (historic process) + 2) Human individual consciousnesses are just now being analogously raised to an equal point (in the synchronization I referred to; after all, we individuals are parts of this world he is, as Christ, inserting himself into: we are all one continuum. I for instance was/am an actual object or part of that historical process! Of a certainly, I even saw it enter + transform my animals So here is a different sort of "Pantheism": transcent dent God is assimilating the world to himself, abolishing the sundered condition of the divine realm vs the falle "sublunar" realm; the further this process progresses, the more immanent he will also (not instead of transcended be - + the more it will seem like Pantheism. What I saw in 3-74 indicates it has progressed pretty fore; + the consummation or culmination will be "St Sophia being born again." + the Kingdom (which is another is ward for "heaven") will there be here (as well as where it is now: after death supralunar) in answer to my Q: this, then, would be intervention insertion + assimilation) - God coming here. Not God (s being (already always] here, the beginning of this assimilation can even be dated. As Hegel I s
...
Needs Review
32
29 KW arrived a priori at what, when the anja chakra opened; I saw. Either this or Christ lied or was wrong. but if that is excluded - + I know what I saw; what I had not realized until K.W. came up with This line of reasoning was that it has to be as I saw (or else Christ lied or was wrong). I now add: despite our conviction to the contrary, time cannot be (inear. It may be circular - accruing, with (cf "Ubik) the past inside the present: the palpimsest. What I experienced was the "rolling back" of time described in Maze" as a power God has. The past - ever the for past - is accessible somehow, very topologically nearby one further point which occured to me this morning. It may not be so much (or solely) that our time is delusional but we should shift the emphasis from the reality - us unreality of time, our time, etc. + study the meaning of the unique breaking through into our space-time categories which the 1st Advent consisted of. perhaps a quality or aspect of This extraordinary event is to make all sublunar times + places close to it. + now: will the 2nd Advent lock it all into proximity? Advent one: tangent to every elayer. Same would be true of Advent two: tangent to 6 all regions of our time, t however we regard our time (i.e. whichever model is correct) Accrueing circular time Anyhow (B) on previous page (he did return + we don't know it) has to be refected by me because what the spirit said to me was, "St Sophia will be born again" - i.e. it hasn't yet occuped perhaps the 1st Advent, being supralunar (the only event of it's kind in history) conferred supralunar permancence t the sublunar space-time continuum it breached: i.e. Rome of AD is to say ad 70 to about 100 years of that continuum.
...
Needs Review
15
N the orthogonal continuum changes in (the direction of growing] intensity until it "peaks" or "emerges" - i.e. breaks through, but not as first Advent - it forces its way through as 2nd, but at a time only slightly later than the first. I have now given a correct theoretical account of what I saw: what remains is the 2nd Advent which will have come in the 1st century (if measured along the linear axis). All this explains, too, why my epistomology finds the linear time strip world to be "fake" - it is fake as soap bubble mere shin" when compared to the density" (depth) of the orthogonal matrix, of which there is only one, the 2nd Advent being the concluding part of the first + not a second, separate matrix: it merely completes or fulfills the 1st Advent - the reality of which linkage, impossible to conceive in linear time experience, was already linked in the fundamental transformation of memory-process which I underwent in anamnesis. This is indeed the true "window to heaven or the next world which has opened for the first time in 2000 years" + also con‐ forms to Jeter's a priori reasoning that despite appearances it must still, in essence - level, be only the 1st century A.D in the 2nd Advent (unlike the first) Rome c Babylon) will be overthrown. This broke through in '74 + led to the pastoral Kingdom which I saw. But St Sophia must incar‐ nate again in linear time (as he/she did before, in linear time) to destroy linear time + "Fix" the pastoral Kingdom here (where we are, lost in the veil of dokos). What I experienced in 3-74 was nothing other than the end times coming so close that, with my ajna chakra opened; I could see through the imrer + outer veil + into it, + its events. Evidently along with the abolition of the spurious linear time world externally There will be, for many but not all of us an opening of the 5th chakra, as in my case.
...
Needs Review
43
In "Scanner": the doorway into the next world is mentioned. could that be important - even more than the "St Sophia" mention in "Deus Iral"? + especially, if you put the ( dream in "Tears" with the "St Sophia "message in "Deves Erve" + the doorway to the next word" in "Scanner" - look at the eschatological composite they form. God breaks through - into history - Christ is to return, + a doorway has opene into the next world, with mentions of Hellenistic elements. "+ always the same proportions, very narrow. He said it was very - pleasing. Outlined in vivid red + Gold. He never thought of going through it. He said there was another world on the other side. He really believed it was God, + it was the (sic!) doorway to the next world. There was moonlight + water - a shore, a beach of an islard. He was saw it was ancient Greeces. There was a woman on the is land - more a statue, the Cyrenaican aphrodite. It was a promise. Something to come. Maybe when he died." (PP1845) there is the stuff about the phosphere activity. + quite + from St. Paul: "We see the universe reversed." Added together, there is really quite a bit. But I'm thinking specifically about be + peep + their claim about the doorway to Heaven opening for the first time in 2000 years. In addition. There is the material in Maze" about group hallucination; in "Ubik" about the wisdom words (Logos), etc. If my books were all read through, inc. these, wouldn't there be a lot of "the" message in the montage? t "I recall distinctly the short interval in which things (e.g. Paul Mclartny's "Teddy boy") still had engramming hold over me. giving me abrupt satori that these stimule controlled me - + thes their engramming power was broken. (Cf Paul, + freedom from the planetar powers.) Q: Was there a deliberate entity behind these stimuli which controlled one, or was it all jut chance? In any case I was in thrall to the stimuli, + had never known it. I think That what I call Zebra did it all (achieves the engramming); in such fashion he creates + maintain the cosmos (esp. human history). But what a thing to see: an entity controlling us all by means of engramming. We do as he wills; he orders + regulates our lives but then I was made aware of this system: how it - God? o works in men's lives: his absolute power, of which we normally have no awareness.
...
Needs Review
58
2 in many respects the Gnostic structure is correct. sick creator, interventive "St Sophia," + the true God totally above it all + not found in nature. The messages, then, are from the intercessor, as part of his salvific activity. I've figured out what the Holy Spirit does, + why Christ said, "it's for your good that I go. because then God can send the 2nd Advocate." Here it is, the pay-off realization. In the 2-person "game" (between James-James the creator + the savior (who Acts to turn JJ's chaos into a cosmos - the Holy Spirit as the final + most mnearly - or is - the true God - his role is to guaranted Christ's [interventive success. That's it. + when you think about it that's some task: that's really important. That means that if we know that the Holy Spirit exists (+ know what he's for) we know what the outcome of the "Game" will be: success by the savior, in other words, it's not an even match between J5 + Christ. the Holy Spirit insures final (interventive] triumph. That is why if you have the Holy Spirit + You have an invincible advocate. His presence in you is not cosmos but victory. When he comes into you, the battle is over + the book closed. He is not a contestant in the 2-player struggle but the hall mank of its absolute outcome,
