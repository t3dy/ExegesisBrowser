...
### Line 1096-1104 (Match: 'Nonetheless')
**Folder**: part of
...
Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Christ, Christian, Spirit, Holy, Logos, Jesus, Holy Spirit, Form, Paul, Empire, Bible, Parousia, Roman, Lord, Elijah, Father, Like, World, Fall, Time, Harpax, After, Savior, Good, Mind, Book, Could, Does, Thodol, Both, March, Great, Probably, Anamnesis, Essene, Part, Their, More, Most, Living, Real, Before, True, Death, Will, Somehow, Very, Whatever, Have, Judgment, Life, Body, Spring, Evil, Except, Dead, Human, Dream, Evidently, Chardin, Right

---
### Line 1329-1337 (Match: 'Nonetheless')
...
Needs Review
```
**Co-occurrences**: Christ, Logos, Jesus, Kingdom, Felix, Satan, Parousia, Perhaps, Advent, Father, Maybe, Since, Only, John, Time, Harpax, After, Savior, Good, Book, Gospel, Could, Does, Pinky, Something, Both, Being, Jesus Christ, Although, Everything, Himself, Bacchae, Without, Wait, More, Real, Certainly, Secret, True, Easter, Will, Would, Hamlet, Kingship, Very, Campbell, Have, Journey, Life, Absolute, Body, Truth, Whereas, Until, Grail

---
### Line 1428-1436 (Match: 'Nonetheless')
**Folder**: Unknown
...
```
**Co-occurrences**: Christ, Form, Well, Maze, Perhaps, Maybe, Like, World, Because, Only, Time, After, Good, Light, Could, Anyhow, Just, Something, Look, Again, Reality, Being, Self, Himself, Anamnesis, Grace, Those, Still, Wait, Most, True, Death, Universe, Finally, Would, Very, Surely, Many, Have, Clearly, Life, Body, Having, Remember, Cross, Dead, Answer

---
### Line 1439-1447 (Match: 'Nonetheless')
**Folder**: Unknown
...
```
**Co-occurrences**: Christian, Spirit, Roman, Maybe, Like, Since, Because, Time, Earth, Harpax, After, Book, Even, Okay, Could, Again, Both, Being, Obviously, Everything, Tessa, Those, More, Another, Most, Real, Such, Certainly, True, Would, Very, Back, Have, Life, Justice, German, Blood, Final

---
### Line 3951-3959 (Match: 'Nonetheless')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Kingdom, Like, World, Since, Gnosis, Because, Only, Time, Mind, Even, Gospel, Could, Does, Again, Kingdom of God, Being, Everything, Part, Their, Ground, True, Universe, Will, Would, Have, Judgment, Berkeley, Whether, Knowledge, Human

---
### Line 5181-5189 (Match: 'Nonetheless')
**Folder**: part of
...
56
53 w it is not the responsibility of the memory spool to "play back" - another component, when it is descrees is to do that. Ah! How suddenly I see how this fits in with the anamnesis I experienced as a part of the over-all 3-74 experience very old (early, prior, antecedent) hither to not retrieved (played back) but nonetheless there mem ories all at once got "played back" - i.e. retrieved, by the Golden Fish necklace qua signal to do so: well, the process of playback (of what evidently were na coded memories) had the effect of retrieving (restoring) The personality (entity) who had had the experiences which aid down the memories. For how could anyone but that person "have" those memories? They by def inition couldn't have been those of the person (PKD) bom in AD 1928. to remember seems to entail (or produce) something more than we tend to realize, e.g. When an LP record "remembers" the performance of a schuman song cycle sung by the late fritz wunderlich in a certain very real (true) sense it doesn't just remember that wunderlich sang that songcycle but in point of fact restores (to perfection as limit) that voice + that music. perhaps, in contemplating the phenomenon of anamnesis we fail to grasp the full significance; if indeed I am a perceiving -remembering - + -playback "spood." + "on me (i.e. in me) is long terme memory of the first Advent + due to an external cue (signal) I do play that section back - what do we have? Not just a transcript in another cesser dimension, liked a typed transcript (i.e. the words only) say of a famous speech - but so to speak the speech given I the person giving it: an event, not a dead object (fossil impression) After all, the disinhibited long term DNA memorier - their re-activation - was one of the most astonishing parts of 3-74 - it alone is staggering in importance. The accurate observer contains the event he observed; we call this memory. Through him. its actual - not feigned - restoration is possible.

Last edit almost 3 years ago by svayambhu108
57
Needs Review
```
**Co-occurrences**: Fish, Well, Golden, Perhaps, Advent, Golden Fish, Only, After, Could, Just, Something, Once, Anamnesis, Those, Part, Their, More, Another, Through, Most, Real, Voice, True, Were, Very, Back, Have, Memory, Remember, Dead, Suddenly, Evidently, Doesn

---
### Line 5861-5869 (Match: 'Nonetheless')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Gnostic, Paul, Spinoza, Like, World, Good, Realm, Reality, Being, Aristotle, Leibnitz, Through, Most, Such, Before, True, Artifact, Evil, Hermes, Right

---
### Line 6180-6188 (Match: 'Nonetheless')
**Folder**: part but
...
Last edit over 4 years ago by Kfischer
```
**Co-occurrences**: Well, Perhaps, Like, Only, Time, Once, Luke, Although, Himself, Those, Another, Star, Voice, Other, Were, Wars, Back, Beyond, Under, Have, Star Wars, Wise, Neither, Evil, Remember, Government, Greater

---
### Line 6332-6340 (Match: 'Nonetheless')
**Folder**: book came
...
Needs Review
22
D finally I would make a "leap of faith" + define orthogonal time as "an event in which another world devoid of linear time breaches into our world at a particular moment along the linear manifold thus conferring unending existence to it in a timeless present which, although obscured by subsequent linear time accretions is nonetheless still There. It is located along the linear axis of our space-time world but does not pass away, + therefore can theoretically be exposed as lying within or beneath successive linear layers. Other earlier locke on the linear axis are not so hypostatized. in other words, its survival does not prove that the past as such survives or can be retrieved; this orthogonal locus is not retrieved because it never passed away in The first place, but was only buried. The entity which traveled through the "gate" into our linear world must by its nature, having once come here, remain permanently, since it possesses an eternal nature; for me to believe that Christ rose on the 3rd day is not only possible, but is in fact something which my system indicates must be. Were it not the case, I could not have experienced that Rome c AD 70 maties, since its permanence is derived from his. But the only way to experience him is to re-experience that matrix, to shed the linear accretions; this will not continue to be true, since a 2nd breaching - in our linear future which has not yet popped into being along the strip - will occur, in which case for a second time a linear locus will acheive permanences. The second that the breaching occur that will happen; the linear strip will says, cease to advance forever, + as Drydan

Last edit almost 3 years ago by svayambhu108
23
Needs Review
```
**Co-occurrences**: Christ, Rome, World, Since, Because, Therefore, Only, Time, Faith, Could, Does, Something, Once, Being, Although, Still, Another, Through, Such, True, Finally, Will, Would, Other, Were, Have, Having

---
### Line 7339-7347 (Match: 'Nonetheless')
**Folder**: part of
...
21
```
**Co-occurrences**: Valis, Tears, Zebra, Xerox, Rome, Form, Satan, However, Perhaps, Like, World, Parmenides, Since, Because, Only, Time, Even, Yang, Could, Does, Anyhow, Just, Obviously, Missive, Xerox Missive, Either, Still, Their, More, Another, Metz, Real, Upon, Consider, Universe, Will, Would, Other, Have, Absolute, Later, Whether, Human, Doesn, Right, Track

---
### Line 7616-7624 (Match: 'Nonetheless')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Xerox, These, Like, Only, Time, Good, Something, Once, Both, Missive, Although, Xerox Missive, Either, Bureau, Wait, Voice, Will, Would, Have, Free

---
### Line 7665-7673 (Match: 'Nonetheless')
**Folder**: book of
...
Needs Review
```
**Co-occurrences**: Tears, Holy, Zebra, King, However, Maze, Wisdom, Like, World, Only, Time, Black, Holy Wisdom, Light, Just, Both, Although, Bacchae, Sibyl, Most, True, Will, Deity, Hamlet, Creation, Judge, Very, Things, August

---
### Line 8435-8443 (Match: 'Nonetheless')
**Folder**: part of
...
Complete
55
detect them + zap them before they can follow out the programmed instructions buried in them. This may shed some light on what Hal said about PKD1, PKD2, PKD3, which I wasn't aware of. The object of the BIP's play is to get the Xtians before they can act; but they begin to act early on. Not knowing consciously why + what (they are doing) but nonetheless chapping away at the BIP which they instinctively dislike...+ wish to destroy.

Watergate was a major coordinated assault on the BIP, which ended in victory.

Christ, of course, is the psyche or noös - i.e. mind of the total organism.
```
**Co-occurrences**: Christ, Christian, Complete, Mind, Light, Before

---
### Line 9973-9981 (Match: 'Nonetheless')
**Folder**: part of
...
Last edit about 5 years ago by sekennedy62
```
**Co-occurrences**: Logos, Complete, Form, However, Wisdom, These, Godhead, Father, World, Since, Yang, Does, Again, Everything, Without, Creator, Still, Part, Real, Voice, Love, True, Hindu, Under, Absolute, Having, Whereas, Final

---
### Line 11113-11121 (Match: 'Nonetheless')
**Folder**: part of
...
Needs Review
60
69 There was a tremendous "amping up" in me, which is all I can be positive of, but if my presumption of a common continuum is correct, the animating life seized we are al the reality around me + modulated it as well speaking here of a life form so exacted that to it I + objects presented no real distinction except perhaps one of degree. It brought a higher level of life to me + it brought life to the inert, the dead [things] so in effect we are speaking about the bestower of life per se; it can animate even stones. But it does not bestow an individual life to each thing; all things are intorwoven to form the vast universe -living-organism As always, I can't help thinking that what I under‐ went + perceived was the pristine, primordial state of man + the ain world before the Fall. Animate dropped to a low ebb which left us only partly alive + the universe dead. The vast animal sank into madness, + illness (vitiation) as well, much of that which animated it withdrawn. Thus it is said that with man the cosmos itself fell. Our fate is interwoven with it + its fate; also, man because something much more powerful (called lucifer + his host) fell. So renewed life must be restored to the total cosmos, + man as a part of that cosmos. no full, adequate appreciation of the disasterous magni tude of the fall can be entertained unless it is viewed as a fall (drop in potency) of the entelechy which comprises the entire creation. This is why, although we may object to the lack of justice involved, it is nonetheless factually true that at the primordial fall we all fell, even now So much later. Now and to this injured condition of the entelechy a continued malignant working of the evil one. Blow + counter blow coming faster + faster as Satans time runs out," as the E.B. puts it. The organism must heal itself: throw off the vitiating sickness which t struck it down at the beginning. Here, again, is the

Last edit almost 3 years ago by svayambhu108

61
```
**Co-occurrences**: Form, Well, Perhaps, World, Fall, Because, Only, Time, Even, Does, Something, Again, Reality, Although, Fate, Viewed, Part, More, Living, Real, Before, True, Universe, Creation, Under, Things, Life, Justice, Later, Evil, Unless, Except, Dead

---
### Line 11205-11213 (Match: 'Nonetheless')
**Folder**: part goes
...
Needs Review
```
**Co-occurrences**: Tears, Xerox, Sophia, Well, Scanner, Time, Noos, Good, St Sophia, Anyhow, Realm, Being, Missive, Covenant, Xerox Missive, Deus, Grace, Part, More, Real, Before, Irae, Other, Were, Back, Life, Information, Deus Irae, Truth, Ananke

---
### Line 13836-13844 (Match: 'Nonetheless')
**Folder**: folder 02
...
Indexed
folder 02 - 004
the Acts material in "Tears"+ due to Thomas being not merely a co-inhabiting personality in my head but the master personality. Regarding "Tears", it is not that in it, in the [future] world depicted, Acts material has been inserted. No - on the contrary: that future, fictional world, on closer, informed scrutiny, turns out to be the world of Acts. To know this you must of course be familiar with Acts, which I was not when I (sic) wrote it + reread it. This is the paradigm. This shows how it can be done - by "it" I mean a modern society that nonetheless is really, latently a time + place from the distant past. Or do I mean "resembles" rather than "is"? No, I mean is, this is the miracle + mystery. "Resembles" poses no problem. What I saw in 3-74 was Acts; what I flashed on as so in 2-74 was Acts. "This is what is", I realized in 2-74, + this is what I saw in 3-74, + later was shown in "Tears" by Father Rasch. This is what broke through (see p.6): first in my writing in 1970, then realized as so in 2-74 upon seeing the Golden Fish, + then seen externally in 3-74 with Thomas internally surfacing as a personality analog. The writing in '70 + the world in 3-74 broke through because of Thomas in me.

Last edit over 5 years ago by Toso
folder 02 - 005
Indexed
```
**Co-occurrences**: Tears, Acts, Toso, Thomas, Indexed, Fish, Golden, Father, World, Because, Golden Fish, Time, Folder, Being, Toso
Folder, Indexed
Folder, Through, Upon, Later

---
### Line 14769-14777 (Match: 'Nonetheless')
**Folder**: Folder 03
...
The title of the story was: "Beyond Lies the Wug," an obvious combination of "Wub" and "Vug." What do "Wub" + "Vug" have in common? Both are alien life forms which enter + take over a human host by an exchange of mental contents (as in "Human Is") or simply impersonate humans - look like them through illusion-generation. This was an updated issue of Planet Stories, + it was divided into 2 parts, + was coming apart. The first, "Wub," seemed more hinted at - i.e., indicated: exchange of inner contents, but "Vug" suggests invasion of this planet by an alien life form plural (the Wub was a solo entity). The message is: This planet has been invaded by a benign super wise alien life form which exchanges mental contents + then uses the human soma as a host. (The Wub was wise + benign.) + there was material in the book (or magazine) not by me but about me. So maybe my matrix immortal self isn't human, but another life form from "elsewhere" ("Albemuth"). Thomas is not a human being - nor will be the Savior; they were smuggled in like cuckoo's eggs - they are wise + benign, like Wubs. But nonetheless they have replaced human (lesser) mental contents with themselves. This is something I almost thought of - I saw the resemblance between Thomas + the alien entity in "Human Is" who replaced the woman's husband, but gave himself away via speech mannerisms. Just add in the Wub story - with an overtone of the Vugs.. + the term "planet" itself, this has to do with planets. Thomas was born in me from the start, but had forgotten himself. They (the brotherhood) deliberately set off anamnesis in 2-74, because the time for him to act had come; anamnesis was anyhow necessary. But prior to this Thomas had underwritten my writing (e.g. "Ubik" + "Tears").

Last edit over 5 years ago by Toso
Folder 03 - 042
Indexed
```
**Co-occurrences**: Tears, Ubik, Toso, Thomas, Indexed, Form, Maybe, Like, Because, Time, Folder, Savior, Book, Anyhow, Just, Something, Look, Both, Being, Self, Toso
Folder, Himself, Anamnesis, More, Another, Through, Will, Were, Beyond, Have, Life, Wise, Human
