...
```text
Of course God could accomplish the same thing by making the apostolic [KH aus?] immortal: the 2nd advent would then occur in this life their lifteimes, but it wouldn't be same, though. & this solution (explanation) doesn't appeal to me because it involves no radical epistomological considerations (i.e. it doesn't make use of my impression that the phenomenal world is not quite real).
...
```text
Starting from my "True Vine" revelation, we are kept in a "lopped-off" relationship to God by the world itself -- the faulty pseudo-cosmos in which we find ourselves living. A mere undercurrent sensation of alienation mut blossom into something greater, or anyhow can; it can lead to a moral repudiation of the world (the kind of ethical balking such as the Ramparts tax strike) or it can lead to an epistomo-logica "dissolving-away of the world" such as my writings contain. Perhaps where I made my mistake for several years about God being immanent was that whereas I thought I saw him _in_ nature, in point of fact he, like the messages in UBIK, were filtering through nature from beyond, beneath or below. Nature could either become transparent, or the reality of the divine could, through its boundless power, assert itself through, breach through. The latter is what happened in 3-74. However, it was not visible to the unenhanced eye. The world did not weaken; God chose to make his move -- the real God, not the demiurge.

Beyond doubt, the true God could annhilate our pseudo-world, not merely permitting a temporary vision to one person (such as he did for me by having me taken over by the Paraclete) but for everyone. The Paraclete, possessing me, literally saw _through_ the world, as if it were transparent; I remember that; wow, it was something, that gate, those geometric forms, and the presence of Zebra (God). (Or the cosmic Christ.) Lem says that in UBIK "a sacardotal power buried in the gutter or rubbish for aeons has been resurrected"; I can begin to see what he might mean by that. It's damn strange how the OCCP keeps show-ing up in all this. Have they picked up what they regard as signals? Not emanating from "space" as anticipated but filtering through reality, to its surface? The world as hologram, pierced by information from the far (other?) side...

An interesting point is that this whole presentation places a new light on my theory of the human being defined by balking. Viewed from the Gnostic standpoint, the act of balking is a refusal not just to be involved in the world but in fact a no to the world itself. It has an inherent power of literally _dissolving_ the world. It is the "metaphysical strike" which the E of philo article on Gnosticism speaks of.
...
```text
Focus of p. 6-7 is on the information flow of 3-74 – was information coming up? Through? From above? From behind? A few references to the OCCP = ?? Contextually, it seems to mean Soviet scientists (Kozyrev et al.). It’s possibly a (repeated) typo for CCCP, i.e. USSR.

Nice section on Ubik on p. 7—“one must extrapolate from Runciter to whatever Runciter represents.”

Also on p. 7 –“… until I recently studied the E of Philo article on Gnosticism so thoroughly …” which explains a lot. Also “… if one knows very much about Gnosticism (which I didn’t until a few days ago) …”

Brings in Stigmata (and transubstantiation), Maze as well. p. 8-9 are in Sutin, and with good reason.
...
Needs Review
4
1 hates, condemns + punishes (i.e. kills). Thus, as the so Gnostics saw, God is pitted against the world, + f the are his disciples, + although it appears as if world hates, condemns + punishes those disciples this is all a mirror-image: backward (cf "Scanner" on seeing. By reflection in the bottom of a metal pan") The disciples, when reunified with the risen Christ, sit down in the judgment seat (sacred throme, ancient of Days) + judge the world. This is one of the things I experienced (did) + saw. The judgment which is passed on the world is condemnatory. This abolishes it. Here I revert to my seminal conviction: the world is not real. God + man, isomorphic, are. Now, as to the black Iron Prison, which is what this world really is - plus the wardens (our oppressors are the jailers, + the real oppression is this incarceration. The graphic is: intervention from outside at the gates-wales - of this prison world - i.e. (3) - man - is inside ➁, the world, but beyond ( lies ➀1, God. ➀ Thrusts through into this world with information (the Gnosis which in itself is salvific, since, as the E, of Philo points out. The original fall consisted of the loss (fall into ignorance) of this (ontological] knowledge. To know is (in itself) to reverse, to rectify, the fall + head the original split between man + God. So this crucial "defallifying" information intrudes into this world exactly as Runciter: info (esp. re Ubik) intrudes into the cold pac world in "Ubik." In "Scanner" the final revelation is that enslave ment is the goal of those who produce substance D. Not financial profit but a debasing punishment: + that is the opening sentence of the afterword: "This is a novel about some people who were punished entirely too much for what they did, this punishment consisting of imprisonment, forced cabor. slavery - "By the Government," as has been repeatedly said about the book.
...
```text
Last edit 2 minutes ago by Gabriel Mckee
3
Needs Review
3
3 temporarily there ceased to be any discrepincy + between my inner picture of reality of + "Tears" reality (due both to "Faith (or Pythagoras' Kosmos) - + then I saw Valis which was the same as Ubik in "Ubik" + so three lines of forces inner back + forth existed between a picture of world + outer world - the magic mirror phenomenon). my inner analog picture synchronized per fectly with reality, but it was not the picture + reality I + other people normally hold to, but a complex acosmism, an idealism + Pantheism + the dystopia "Tears" which is set in Acts. the blitz that occurred was what Philo cails knowledge of God in contrast to knowledge or belief that God exists etc. The empirical was assimilated totally by the a priori or innate cate aories (forms). Psychologically, I annexed the world p introjected it I had discovered that by consulting the innate (a priori) contents of my own mind I could per fectly know the outer world + even predict ("Faith of") what would happen next. What caused this corres‐ pondence I do not know, but there it was. "Faith of" was the first then "Tears" + "Ubik" + "Tears" linked up with what the Girl seemed to be really saying. The clue as to how the inner analog could be correct - even to details about the out. side world denied to me a posteriori, lies in the AI voice - whatever that may be It would be, too, the Hermetic microcosm - macro aff. cos fo
...
Needs Review
103
101 + past (archaic) layers within itself-phylogenic strata, which synchronize with world. the world we see is actually two realms combined: Ubik (upper) + "Tears" (lower + ossified). The upper alone seems to be the "Kingdom of God" which Christ spoke of, + which he rules or even is entree into this upper realm requires the splitting-apart of the two realms in terms of our perception, + time reversion of the lower therefore (since it is not stabilized in forward-moving time by the upper); this comes about, as in "Ubik," by a kind of dying of the percipient person. Thus, just as the characters in "Ubik" died + thereafter saw 1) Ubik, + 2) the regressing (decaying, decomposing devolving - to - the- past) world, so I died in 3-74 + thereupon saw Ubik + the world of "Tears," instead of a combined-signal world. as hinted at in "Ubik" Ubik seems to be related to the Platonic forms; in any case the regression is called form reversion + specifically dentified as Platonic form reversion. Philo's view that the forms exist in the mind of the Logos seems involved, here Then the Q: "Where is God (or Christ/Logos)?" is answered by: "what we call world is really two realms, the lower of which is inert or ossified the upper one divine + alive." The mystery as to where the Kingdom of God lies is solved: it is right here, but must be discriminated (unscram sled) from the lower realm for it to be visible as such. Then the lower realm can be suppressed is ground to set the latter becoming hieroglyphs or information. Separated from the upper reali
...
Needs Review
143
14 my distinction is a correct one then there is a severe consequence: substantial reality (the physical universe) may never become cosmos but may be allowed to] fall victim To the laws of entropy + thermal decay. The substantial universe is not the issue. what I saw in 3-74 which was cosmos probably was limiting structure which had temporarily become palpable to me If Philo is correct, these are the Platonic forms + the mind they are in: viz: the Logos or Valis or Ubik. So Ubik (in the novel) which in itself moves toward divine epiphany, presides over a universe of decay (entropy), a stockpile from which it selects that which it incor porates permanently into itself - but it itself is not material reality but a blueprint, map or mind. Thus in "Ubik" the two domains or realms pull apart farther + farther! In Gnostic terms, the divine (en sof) does not reannex the sinking part of the cosmos in toto but extracts - picks up - only those bits it wishes to incorporate! This places quite a different light on 2-3-74! could it be that it is locating fragments d itself - locating + identifying - + reannexing it seeks for clues to its lost identities, then will reveal themselves. Once it reacquires its fragments the whole material universe could cease to be + nothing would be lost, is this not Gnostic acosmism, + mind, too
