...
51
N For hing tears was a message about the original world by one who remembered to others who remembered, which is to say, knew the truth - the incredible truth not just that we originaly live in a worse world but - most impotat of all - God is reweaving the historical past to improve our lot, + is still active doing it (which should give the present authorities something to think about - i.e Nixon). That is why the dream section is absoluter vital to the message - in fact it (esp. "Felix" - be prosperous + multiply: his command which underlies the reweaving). But suppose, as K.W. pointed out, what about those - in authority here + in Russia who were in power in the black Iron verse + who not only yearn to see it back but deliberated model then regimes on those lines? I think the Xerox letter came from them, + I dident understand, but my not-I self - he knew, because He knew the significance of tears in the first place + feared this exactly as he feard the Romans there were intriguing hints which he had put in "Stigmata, Ubik, Maze faith? etc) to which the soviets, via Lem, had already reacted with interest, This too is the Gnostic revelation. The black Iron world is the creator's (J-5's) original creation - a dreadful hell, like nazi Germany (Hitter evidently knew this + deliberately tried to restore original black Iron" conditions here). Another better God, the real God, intervened - this was the divine christ intervening for us (I got a glimpse of what it would be like - is or was, whatever, like - without him the stance of the secret Christian, in the black iron world showes then ferocious entity towne 5-3's world, moligated in this, partially saved world - but over there it is absolute + undying mutual opposition. So the other God, the good one, has been steadily reweaving 3 3: universe - as I saw noeti cally: the 2 forces interacting dialectically. What a secret hinted at in books + stories of mind.
...
Needs Review
70
or [. in such books as "Ubik" + "Maze" he was already revealing his secret Christian Platonistic views which was bad enough, but the fat was in the fire when he showed up gulag in "Tears" - that forced his graud + him to flee. (here.) In that case the Xerox letter followed as soon as he defected, to remind hin they knew where he had gone; he recognized if (ever anticipated it), + knew what to do with it to extricate himself - + esp not go to elams.
...
answers the Q: whom are the messages for? evidently just for a small conscious elite but anyone at any this possibly points to analogous internal [unintelligible???] presynchronyzed (from birth) differing in different individuals, so as to later linkup a good example of a big one for me was the Gold fish neckless thus Zebra continually guides (controls?) us as we move (are moved) through the "maze" of the disinhibited constantly at the right time +place by the right signal this. is a major insight. Zebra uses these messages to communicate with all of us -exactly like the Runciter messages. Wow, did Ubik to touch on a major undiscovered aspect of the univers: it (God or Zebra or Ubik) talking to us if necessary via the trash grafitti the gutter walls. But a message only works this magic if the analogous inner programming has been put there, a prearranged monadic harmony Ubik -"Runciter"- is talking to us but always subllimnally -+ of course even if we were consciousthat, say, a certain song lyrics had "affected" us, it would still not occur to us why -i.e. from whom, +do how puposeful. Half of the brain is involved (right half-) maye this is a major right - hemisphere function so the message in Tears could link us differently the 2 parts joined - in different persons; only ½ the message is on the Pages; the other halves are inside the brain of certain various readers Like the internal the pre-message analogs possible estabilished in dreams?
...
Needs Review
19
16 In drawing on my previous personality for his skills/experience, in dection with the Xerox letter, I was (+ certainly) felt very much like some of Barry’s rats solving the maze better, more quickly, by using a progenitor’s memory. In both cases the stress of dire, vital problem solving brought it about (it came forth when needed). Perhaps more than an accidental parallel is involved. (Do “they” have us in a maze?) I am sure I solved the Xerox letter problem extra quickly (I felt I was being timed) due to genetic memory (it help). I felt I had done this before- as if it all had already happened.

+ I was rewarded. By months of [beatifiblics?], for solving the problem correctly. Whatever entity or entities set the problem up, they are on the level of Zebra. When I was rewarded I could see Zebra; did Zebra judge? Or even set the puzzle up? To see one super-armed entity there at the time is to tend to ratify my intuition that, yes, the Xerox letter was a “man maze” To be solved, + I did it-but my through the resurrection of an 1800 year old other self.
...
Needs Review
22
t that the Xerox letter-problem was coming, + when (i.e. very soon) made use of a successful disin hibiting stimulus presented to me to restore that personality. So the DNA memory (gene pool them, which at first seemed to explain everything which happened to me, does not, since the phosphere firing (restoration of memor-DNA memory) began ever before the Estonian letter arrived, + days before the Xerox letter did. The DNA memory structure explains where "Thomas" came from, + I guess how, but there is only the semblance (spurious appearance) of why (Like: the problem so mmined it because back in its own time it faced coped with, solved a similar problem, + this is an analog of barry; rats who using the orthomolecular vitaming, recalled then ancestors, skils in solving the maze," + this would appear to explain it - a sort of synchronization between theory + event, although the theory is new - but too bad for this explanation: disinhibition began days before the Xerox letter came, I can still use it in the book, somewhat modified. in reality, some kind of teleology is implied, but not a kind we can accept (i.e. the purpose of Thomas neturnin was to take ove to solve the Xerox letter problem I'm going to opt for the programmed ahead of time inner take - the one which ran fast at the time of Ray bradburys trinterview. Set up (engrammed, the contours of reality enhanced) by an entity or mind which (perhaps because not bound by time but possessing a vast present. inc. Both our past + our future) saw it all coming
...
Needs Review
9
( abolished by the person waking up. But he can't wake himself up, since he does not know he is asleep. This is where the savior comes in: he wakes us, exactly as Runciter speaks to those in cold-pak. So there is a third truth in "Ubik". 1) The retreivability of the past; (2) information intruding into this world; + (3) the nature (content) of the information: that it is designed to inform + awaken us to our true state, meanwhile conveying to us something of the nature of the awakened (compare the cold-pak state in Ubik" to the polyencephalic fusion in "Maze": the same basis situation is represented - + it is our true one maybe this is exactly what I was: one of those waiting + watdin who fell asleep, into the wald of the cydes of birth + death which the Hindies believe in What about my "Rome AD70 perception + inner anotes personality being a cyclic return to Rome c. 70 AD + therefore the perception? Cyclic time? Conditions are again as they were once, hence a kind of fusion - aw fuck Joee on the phone: "When I played with my kids after years, it was as if no time (i.e. the 6 years) had passed"; i.e o the 6 year interval became an ellipsis because of the identity Philo between the 1st + 2nd plaging- with. If change determines time (v. the macro on "time") then if the matrix of all significant changes are identical to a previous matrix, the fan time must of necessity become one (i.e. the first time returns). There would be a sort of psychic short circuit across from time to time 2 obviating the intervening time. This explanation would indicate why the element of my remembering is the crucial. factor I the key to understanding it. What I saw reminded me (I.e. once before): of 70 AD + hence reminded me that I had lived at that time 1974 levent is Could king o were the buried memory of having trips off I memory lived in 70 AD not there, there of 70 AD would have been no possibility trips ot 1974 recognition G of recognizing 1974 as same as identity 70 35as
