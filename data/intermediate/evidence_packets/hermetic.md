...
would have to be known to write "UBIK." Not only that, I was thereupon able to see Zebra, which now I realize is UBIK. It is a Unitary Cosmic data (info) processing Brain whose messages flow as traffic through our world, embedded in our communications media, exactly as in "UBIK." So "UBIK" contains Great secret (or unrecognized) truths: 1) Possibility of form axis reversion due to dialectic interfight between love and strife (i) (Phylogeny in ontogeny in the macrocosm): (i) negentropy vs entropy 2) which points to a hylozoic single animal universe. 3) which ratifies the truth of the Macro-Microcosm Hermetic Cosmology; 4) an info processing cosmic brain (Logos or World Soul) as analogy to a man's brain and soul (mind) exists; 5) it is directing us salvifically but subliminally through its traffic of messages, 6) it opposes the form-axis reversion to more stable but more primitive states, presumably both in the macro- and microcosms. 7) It has a spokesperson or voice which we can hear (as well as see its written information) which we can link up with in dialog, which is very desirable.

Ah! If the macrocosm has a phylogeny, and it is contained in its ontogeny, then prior times do lie "under" (latent) the surface: the "onion" model is correct - not just for the human [mind] - But for the universe [qua animal] as well - So under certain unusual circumstances there could be a time reversion (like in "UBIK" - but my plural psychoi-worlds push-pull system show how it could/would happen to an individual only)
...
there.) Man's problem is to grasp these meanings by means of intellect guided by imagination. Imagination is the explosive flare that lights up the inner spaces, revealing meaning. So P. had my experience. What does this imply? 1) Based on the cosmology of "Ubik" I pinpointed Thomas as located among the Hermetic macro-microcosm alchemists of the Renaissance + not antiquity. 2) The "mercury" dreams further pinpointed P, who fits into that category (i.e. (1) supra). 3) I then researched P. Many elements fitted in. 4) I find that P had my "inner spaces, mirror of the universe" 3-74 experience in his lifetime. 5) No one else except P's pupil J. Boehme seems to have had my experience. 6) Therefore? It's too much for me. Here is a cross-corrolation. I zero in on P as being Thomas, i.e. the other person "inside my head not living in this century" + find he had my experience which consisted of (among other things) his coming here - to our time, my time. I never anticipated this. Can't be coincidence. What are the laws of this 'inner firmament' that P speaks of? Is it transtemporal? Then I am in touch with P alive at his time, as with a telephone, is that it? No, he is in my head. Okay - the omnitemporal matrix I wrote Pat about. Fuck! Did P. reach across to me - no, he was (or is) here; certainly he was in 3-74 when he literally took over. No - that was an apostolic Xtian. Oh shit. Fuck. I can't account for it; I have {...} answer but I don't understand it!
