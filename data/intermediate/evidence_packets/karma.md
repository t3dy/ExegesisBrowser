...
```
**Co-occurrences**: Well, These, Only, Time, Harpax, Noos, Light, Even, Gospel, Could, Does, Taoism, Being, Nothing, Those, More, Real, Upon, Mother, Will, Would, Back, Whatever, Many, Have, Wise, Later, Testament, Dream, Doesn, Right

---
### Line 2313-2321 (Match: 'Karma')
**Folder**: part piece
...
Probably this is connected to the vision I had to the two-person game at work: move and counter-move would be action and reaction, a reaciton to restore wholeness, harmony and balance. Too, a vast law of karma is involved --and disclosed-- here. I do not need personally to react to everything; the universe will do much of that (which provides a basis for understanding Christ's ethical system; when you're hit you don't hit back, but rather you let this universal ma'at or Tao do it for you). Really, for Christ's ethical system to work one must presuppose some universal system of recompense (which He does), much like this; it is important to recall that ma'at is judge of the dead, with her feather weighed in the scales against the deceased's heart.

Having experience this blissful mystical understanding of it all, everything I've been into from 3 74 to now, I am thinking, Perhaps I can infer that the Parousia are not here in any universal or objective

Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Christ, Parousia, Perhaps, Like, Harpax, After, Good, Does, Anyhow, Everything, Probably, Universe, Will, Would, Other, Judge, Very, Back, Have, Having, Dead

---
### Line 3137-3145 (Match: 'Karma')
**Folder**: part of
...
```
**Co-occurrences**: Christ, Spirit, Holy, Holy Spirit, Brahman, Parousia, Golden, Lord, Perhaps, World, Since, Because, Time, After, Good, Mind, Light, Even, Could, Something, Once, Obviously, Self, Everything, Without, Grace, Brain, Still, Part, Another, Through, Such, Voice, Upon, Before, Universe, Finally, Will, Would, Other, Were, Back, Have, Later, Dream, Until

---
### Line 3400-3408 (Match: 'Karma')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Christ, Xerox, Brahman, Roman, World, Because, Only, Time, Maya, Atman, Divine, Without, Nothing, Brahmanism, Living, Real, Voice, Western, Universe, Were, Life, Except

---
### Line 4056-4064 (Match: 'Karma')
**Folder**: part could
...
Needs Review
```
**Co-occurrences**: Holy, Xerox, World, Only, Time, Light, Even, Could, Zebrapedia, Realm, Again, Maya, Being, Self, Great, Viewed, Part, Indian, Real, Before, Finally, Would, Were, Back, Have, Judgment, Life, Memory, Later, Whether, Karmic, Salvation, Free, Final

---
### Line 4074-4082 (Match: 'Karma')
**Folder**: part could
...
41
```
**Co-occurrences**: Christian, Xerox, Rome, Christianity, Well, World, Iron, Prison, Time, Black, Good, Light, Could, Once, Maya, Being, Tony, Black Iron Prison, Palm, Still, Soul, Upon, Actually, Before, Death, Finally, Will, Would, Were, Egyptian, Have, Tree, Life, Unless, Karmic, Iron Prison, Until

---
### Line 4079-4087 (Match: 'Karma')
**Folder**: part could
...
Needs Review
```
**Co-occurrences**: Xerox, Rome, Christianity, Iron, Prison, Time, Black, Once, Self, Black Iron Prison, Grace, Their, Ground, Actually, Before, Finally, Will, Life, Karmic, Iron Prison, Right

---
### Line 4085-4093 (Match: 'Karma')
**Folder**: part could
...
Needs Review
```
**Co-occurrences**: Acts, Christian, Well, World, Since, Fall, Iron, Prison, Only, Time, Black, Garden, Book, Could, Something, Again, Both, Self, Black Iron Prison, Probably, Palm, More, Through, Such, Universe, Will, Would, Further, Tree, Life, Iron Prison, Evidently, Final

---
### Line 5199-5207 (Match: 'Karma')
**Folder**: part of
...
Needs Review
```
**Co-occurrences**: Zebra, Brahman, Well, However, Like, Noos, Good, Mind, Although, Self, Without, Nothing, Through, Will, Would, Under, Have, Things, Absolute, Knowledge, Suddenly, Free, Final, Right

---
### Line 5205-5213 (Match: 'Karma')
**Folder**: part The
...
Needs Review
60
3 acting on, but never acted upon. Up to then I had been continually acted upon. I had never been aware of the greater "I" which was not me. I gave way to it + merged with it. Thereupon it can be said, as Jamis said, that it had "taken control," but I was also it, + not the acted-on I which I had all my life been. If I was a pawn of anything I was a pawn of myself. That is a paradox. To sur vender completely to Brahman directly (it acting directly, i.e. inwardly, not through externd-internal analogs), to be Brahman is to be more fully, to be absolutely, rather than relatively; to lose one's ego is to cease becoming + to be -fully realized - finally. Also, in this process the inner take" running along in synch with the outer stimuli - it was abolished, + so the outer stimuli ceased to have inner analogs responds, to them. In the Leibnitz system, the ruling monad of the entire macrocosmos supplanted my limited monad mind But I was not diminished by this: it must either be sace that I no longer existed at all; or (2) I becoming the ruling monad, acting on but never acted on; or (2) both. Of These formulations (1) is probably most accurate. It was not another mind which took (me) over but absolute mind, of which I (+ everyone else) already was/am a part The structure of things seems to be that we are harmoninged programmed) without our knowledge by the total universe-organism, which makes us unfree (maya hides this controlling, which the Hindus called Karma). It is for our own good + the good of the total structure, + as necessary for us as it is for snails + carp. However, absolute spirit, first working through biological evolution (processes) + then history, desires to bring us pro a gressively greater + greater freedom, the good being ever higher levels of self-motivation. In achieving a jump upward. the control, programming structure is revealed as the

Last edit almost 3 years ago by svayambhu108

61
```
**Co-occurrences**: Spirit, Brahman, However, These, Good, Mind, Both, Maya, Being, Self, Either, Probably, Without, Part, Leibnitz, More, Another, Through, Most, Upon, Universe, Finally, Have, Things, Life, Absolute, Freedom, Knowledge, Greater

---
### Line 6869-6877 (Match: 'Karma')
**Folder**: part of
...
Complete
```
**Co-occurrences**: Valis, Tears, Toso, Indexed, Jesus, Complete, Xerox, Time, Cosmic, Even, Could, Just, Missive, Orphic, Xerox Missive, Indian, Another, Through, Soul, Would, Judge, Were, Further, Have, Judgment, Life, Freedom, Evil, Until

---
### Line 10944-10952 (Match: 'Karma')
...
Needs Review
```
**Co-occurrences**: Christ, Christian, Christianity, World, Since, Because, Only, Good, Mind, Could, Does, Something, Anamnesis, Creator, Most, Real, Actually, Revelation, Will, Would, Hindu, Have, Life, Evil, Remember, Durant, Doesn

---
### Line 12008-12016 (Match: 'Karma')
**Folder**: Unknown
...
Needs Review
44
6) "tears" is full of material from Acts of the Gospels and Revelation, and discloses a secret message: of exculpation and happiness; I_e, the Lord is alive, and, I think, with us as ready as about to be. Which dovetails with (4) (2) (7) Zebra pulled down the current poly forum of karma, the Nixon Government. this is said to be the absolute certain signal that almost as King is about to return ( "the fall of Babylon" ). theory: Christ returned, but the power of Darkness have occluded us with: 1) a negative hallucination that he has Not returned and that ? won over xtlanity? 2) and that it's 1974 in 1978, etc; whereas in fact this is a spurious interpolation, a ?felt wald , delusion convening the ? wald (the palm tree Garden), and it's ? about 70 AD real time. 1 1 for 27 years Ive Belabored this theme in my writing: spurious reality laid over the real thing. 8) When my occlusion cleared up in 2-74/3-74 I saw the real wald?, and it was ? 45 to 70, just like I write about,

Last edit over 4 years ago by bendakar1
45
Complete
```
**Co-occurrences**: Christ, Tears, Acts, Zebra, Complete, King, Lord, Like, Fall, Time, Nixon, Garden, Gospel, Just, Reality, Palm, Darkness, Babylon, Real, Secret, Revelation, Have, Tree, Absolute, Government, Whereas

---
### Line 14254-14262 (Match: 'Karma')
**Folder**: folder 02
...
Indexed
```
**Co-occurrences**: Indexed, Xerox, Like, Time, Gabriel, Folder, Mckee, Gabriel Mckee, Just, Something, Look, Being, Missive, Xerox Missive, Great, Part, More, Voice, True, Were, Have, Life, Days, Final

---
### Line 14260-14268 (Match: 'Karma')
**Folder**: folder 02
...
Indexed
folder 02 - 067
knew I was free for the first time. Maya, which is a form of karma (delusion) also broke! It all fits; I was freed from illusion + inner karma: the power of illusion to compel assent (belief) was finally shattered. + it is karma (v. E.B.) which acts to create amnesia about our past lives (karma or maya - they interact). Hence the dreams about the 3rd eye - it all fits. - Voice: "He was an intelligence officer in the army" i.e. he who sent me the xerox letter. Yes, of course. Not FBI, not CIA, but army: they had bought those 236 copies of "Tears". So the xerox thing was, as I suspected, connected with "Tears" - but I never connected the army with the xerox thing. - The "Cabrillo" + watch dream:: found money + watch, returned both to their proper owners. The slot in the money where the word "cabrillo" appeared: it meant code + it referred to the xerox missive. The xerox missive had code in it - which helps explain why it was so dangerous to me to have it. Cabrillo = Jello. The Jello Box of the Rosenbergs'. A US intelligence frame up. - There is no doubt that I broke through inner maya (+ remembered a past life - anamnesis) + outer maya (saw reality + not the illusory world), + was released from karma (which I have been calling

Last edit 2 days ago by Gabriel Mckee
folder 02 - 068
Complete
```
**Co-occurrences**: Tears, Acts, Indexed, Complete, Xerox, Form, World, Time, Gabriel, Folder, Mckee, Gabriel Mckee, Both, Maya, Reality, Missive, Xerox Missive, Anamnesis, Indexed
Folder, Those, Their, Through, Voice, Finally, Have, Life, Days, Dream, Free

---
### Line 14266-14274 (Match: 'Karma')
**Folder**: part one
...
Indexed
```
**Co-occurrences**: Christian, Toso, Indexed, Zebra, Complete, Brahman, These, Perhaps, World, Gabriel, Folder, Mckee, Gabriel Mckee, Buddha, Book, Again, Shiva, Maya, Atman, Siddhartha, Toso
Folder, Great, Anamnesis, Without, Brain, Still, Part, Voice, Upon, Death, Will, Would, Things, Life, Information, Days, Magic, Free

---
### Line 14272-14280 (Match: 'Karma')
**Folder**: part of
...
```
**Co-occurrences**: Toso, Indexed, Zebra, Xerox, Form, Brahman, Well, However, World, Since, Fall, Iron, Only, Cosmic, Folder, Mind, Both, Reality, Atman, Missive, Self, Siddhartha, Xerox Missive, Toso
Folder, Indexed
Folder, Part, Holt, Voice, True, Olive, Olive Holt, Macro, Finally, Would, Were, Under, Have, Life, Remember, Truth, West, Someone

---
### Line 14321-14329 (Match: 'Karma')
**Folder**: folder 02
...
Complete
folder 02 - 074
The Buddha taught that nirvana sets in when the pressure of karma projected into the future (future lives) has worked itself out (of existence). Thus in 3-74 I felt karma's hold over me break, + not long thereafter I experienced the ecstatic void, which I now believe is nirvana. #4 on p. 74 is Noos, mind or Brahman. It is the _process_ of #3 the brain. #6 is a surprise + does not follow #5 in any a priori sequence. It is the final level of that which _is_: the Urmutter even beyond purely esthetic geometric form. We have been wrongly taught. Yet - she also appeared _first_ in the order of revealed levels, perhaps as psychopomp + spirit of my religion [Note2], hence she occupies two stations: between #1 + #2, + then is _again_ revealed at #6, above + beyond the polychrome geometric ratio which would _seem_ logically to lead directly to #7 [Note1], the void - but there once more, betweeen #5 + #7 was she, now not flesh + sensual body, panting with erotic desires + sexuality but rather as pure beauty (status of Aphrodite rather than fleshly torso). As #6 she was to be contemplated visually, not touched. This is a decisive metamorphosis of her: #6 is absolute beauty, but at the beginning there was a carnality to her. So I guess there are eight, not seven levels.

[Note1] Since geometric ratio #5 is abstract + resembles Plato's archetypes (forms). [Note2] + is the AI voice (St. Sophia's) _her_ voice, her as #6?

Last edit over 9 years ago by Toso
```
**Co-occurrences**: Toso, Spirit, Complete, Form, Sophia, Plato, Brahman, Perhaps, Since, Noos, Folder, Buddha, Mind, Even, Does, Once, Toso
Folder, Brain, More, Voice, Would, Beyond, Have, Absolute, Body, Aphrodite, Final
