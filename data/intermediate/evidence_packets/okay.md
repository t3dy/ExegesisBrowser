...
11
```
**Co-occurrences**: Bible, Like, Since, Time, After, Book, Zebrapedia, Ground, Will, Claudia, Testament, Chip, Final

---
### Line 220-228 (Match: 'Okay')
**Folder**: book of
...
```
**Co-occurrences**: Tears, Paul, Like, World, Because, After, Could, Anyhow, Just, Tessa, More, Through, Real, Other, Page, Have, Dead, Today, Final

---
### Line 292-300 (Match: 'Okay')
**Folder**: part of
...
Last edit over 5 years ago by Zebrapedia
```
**Co-occurrences**: Complete, These, Time, Zebrapedia, Those, Love, Very, Right

---
### Line 1043-1051 (Match: 'Okay')
**Folder**: part of
...
```
**Co-occurrences**: Christianity, Form, Well, Gnosticism, Dionysos, Plotinus, Elijah, Father, Like, Time, Harpax, After, Cosmic, Savior, Good, Light, Firebright, Could, Does, Just, Something, Look, Being, Self, Orphic, Divine, Himself, Sibyl, Viewed, Grace, More, Orphism, Such, Certainly, True, Would, Other, Were, Beyond, Have, Life, Body, Justice, Truth, Human, Doesn

---
### Line 1138-1146 (Match: 'Okay')
**Folder**: book is
...
Needs Review
```
**Co-occurrences**: Greek, Well, Because, Harpax, Mind, Could, Does, Hebrew, Look, Both, Kosmos, Being, Everything, Jews, Their, Zeus, Another, Certainly, Greece, Deity, Have, Body

---
### Line 1256-1264 (Match: 'Okay')
**Folder**: part of
...
```
**Co-occurrences**: These, Like, Fall, Only, Time, Just, Both, Kosmos, Heraclitus, Being, Either, Nothing, Creator, More, Real, Secret, True, Will, Other, Egyptian, Have, Justice, Truth, Otherwise, Right

---
### Line 2341-2349 (Match: 'Okay')
**Folder**: part of
...
Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Christ, Tears, Holy, Sophia, Kingdom, King, Parousia, These, Perhaps, Advent, World, Because, Time, Harpax, After, Buddha, Even, Does, Kingdom of God, Both, Being, Although, Either, Great, Viewed, Those, More, Another, Through, Real, Such, Voice, Finally, Will, Other, Very, Back, Have, Life, Information, Later, Knowledge, Dream, Right, Answer

---
### Line 2604-2612 (Match: 'Okay')
**Folder**: part of
...
```
**Co-occurrences**: Christian, Spirit, Roman, Maybe, Like, Since, Because, Time, Earth, Harpax, After, Book, Even, Could, Again, Both, Being, Obviously, Everything, Tessa, Those, More, Another, Most, Real, Nonetheless, Such, Certainly, True, Would, Very, Back, Have, Life, Justice, German, Blood, Final

---
### Line 2943-2951 (Match: 'Okay')
**Folder**: Book of
...
```
**Co-occurrences**: Christ, Christian, Logos, Jesus, Form, Sophia, Well, However, Wisdom, These, Plotinus, Like, World, Since, Fall, John, Earth, Savior, Book, Light, Even, Could, Just, Look, Once, Realm, Again, Being, Although, Aristotle, Great, Deus, Grace, More, Through, Heaven, Real, Such, Upon, Before, Irae, Death, Will, Would, Other, Further, Have, Fake, Information, Freedom, Deus Irae, During, Lower, Someone

---
### Line 6258-6266 (Match: 'Okay')
**Folder**: Unknown
...
Last edit over 4 years ago by Kfischer
```
**Co-occurrences**: Perhaps, World, Since, Time, Good, Could, Does, Just, Again, Being, Although, Beethoven, Still, More, Through, Before, Would, Other, Whatever, Have, Instead, Except, Doesn, Right, Answer

---
### Line 6800-6808 (Match: 'Okay')
**Folder**: part cycle
...
Indexed
```
**Co-occurrences**: Valis, Tears, Acts, Christian, Toso, Indexed, Maybe, Like, Yang, Something, Kosmos, Being, Part, Other, Illustration, Tree, Life, Evil, Dialectic, Otherwise, Doesn

---
### Line 6900-6908 (Match: 'Okay')
**Folder**: part of
...
Last edit over 5 years ago by Toso
```
**Co-occurrences**: Christ, Tears, Acts, Christian, Toso, Indexed, Xerox, Sophia, Satan, Empire, Like, World, Because, Therefore, Only, St Sophia, Could, Both, Being, Missive, Xerox Missive, Part, Star, Living, Real, True, Will, Other, Creation, Wars, Have, Star Wars, Evil

---
### Line 6941-6949 (Match: 'Okay')
**Folder**: part of
...
Indexed
```
**Co-occurrences**: Toso, Thomas, Indexed, Satan, Like, Faith, Another, Would, Have, Impostor, Human, Answer

---
### Line 7417-7425 (Match: 'Okay')
**Folder**: part about
...
Needs Review
```
**Co-occurrences**: Thomas, Xerox, Rome, Scanner, Like, Iron, Prison, Time, Black, Just, Once, Both, Missive, Self, Black Iron Prison, Xerox Missive, Anamnesis, Nothing, Would, Other, Were, Back, Have, Life, Info, Later, Remember, Suddenly, Iron Prison, Answer

---
### Line 7829-7837 (Match: 'Okay')
**Folder**: part when
...
66
69 Ixerox missive schematized as follows: Thomas s track A its thailo This means that I started out in life on track A as Thomas who was involved with the party. Then there was a reweaving, not just on/for me but in terms of human history (this was before 1974). Because of these pre-7y changes the tyranny was successible to successful overthrow (in contrast to track A, the purpose a laying down track B at point X in time was not to help me or any other single given person, but to depose + destroy the "cont" t Spirators." Well, this broad historic purpose was achieved, but there were loose ends. My error has been to regard the tracks as totally different each from the others. Okay, I was a portion of the changed part when the tinkering took place at point X I obtained new memories + a different history + hence different personality. But the situation "at the other end," which is to say, the section out of which the Xerox Missive emanated wasn't changed. The missive was sent. The track B PKD couldn't have handled it - wouldn't have known 1) wWhat it was (signified) or 2) what to do with it. Such fuckups must abound when part of a world is changed with other parts left unchanged; you get spooky "doesn't compute" (apply any longer) phenomena. So, I'm saying, Thomas had to be brought back (at least temporarily) or there'd This weird loose-end Xerox object. be what I got to see was: the ghostly outlines of the iron prison world of track A, + the Logos weaver - reweaver savior, actually at work. (I was temporarily "above" worlds, abore both tracks. I was in the reweaver's world, not ours

Last edit almost 3 years ago by svayambhu108
67
Needs Review
```
**Co-occurrences**: Thomas, Logos, Xerox, Well, These, World, Because, Iron, Prison, Time, Savior, Just, Both, Missive, Xerox Missive, Part, Such, Actually, Before, Other, Were, Back, Have, Life, Human, Iron Prison, Doesn, Track

---
### Line 11072-11080 (Match: 'Okay')
**Folder**: part of
...
Needs Review
53
1 83 is If a higher life form lives in our vicinity undetected There is no immediate answer as to its origin, let alone its nature. My perception of it is that by the way in which it "melted" or "bent" empirical reality it disclosed the merely - projected quality of that reality. Had that reality been intrinsically truly substantial it would not have yielded as it did to what appeared to be a kind of ergic pressure. Reality gave. It was subject to manipulation or my perception of it was subject to manipulation, or: the two are the same. It melted me + simultaneously what I saw + heard melted. But There was no hallucination-like quality to it. I had the sense that enormous energy was expended. Deflection was minimal + skillful + revealed great wisdom. It melted only what it had to melt. perhaps one clue that I'm overlooking is the 3:5 doorway: perhaps it indicates that Zebra entered this world from another world (whatever that might mean). the impression I got of it was a past continuum of our world. It had short cut 2500 years by some kind of direct route. The 3 eyed people indicated time travel, or more accurately, the nullification of linear time as essentially spurious (this revealingly dovetails with my sudden sense of it being really Rome C. AD 70 + not 1974 Calify Okay - I'll go so far as to say that AD 1974 Calif is a fraudulent "echosphere" + that in reality its Rome c AD70, + that some life form or human group knows this + is free of (not controlled by) this interpolation: they or it know see what we don't know + see. We are to it or them a he inertials in cold par are to Runciter, who is fully alive (i.e. awake). Just because we are compelled to accept this spurious interpolation doesn't mean everyone else is.

Last edit almost 3 years ago by svayambhu108
54
Needs Review
```
**Co-occurrences**: Zebra, Rome, Form, Wisdom, Perhaps, Like, World, Because, Only, Time, Just, Reality, Being, Runciter, Great, More, Another, Calif, Would, Whatever, Have, Life, Human, Doesn, Free, Answer

---
### Line 11927-11935 (Match: 'Okay')
**Folder**: Unknown
...
```
**Co-occurrences**: Tears, Ubik, Complete, Form, King, Felix, Well, However, Like, World, Because, Only, Stigmata, Good, Could, King Felix, Just, Realm, Himself, Their, Real, True, Other, Evil, Lower, Dream, White

---
### Line 12132-12140 (Match: 'Okay')
**Folder**: book has

```text
Complete
52
is it totally camouflaged? There is no exoteric verbak interger which represents it, nor any knowledge of it in our experience. We do not know it exists if we do not know of the good news as its defeat.

Something warping + evil we don't know of has been defeated by a group secret to us, with the result (unknown to us - hidden from us) that Christ has or will return. All 3 elements - the whole narrative - is occluded all from us okay.

1) The BIP is imperial (ancient) Rome.

2) When I was de-occluded (verifed by "Tears" I saw it here now (+ the secret early Xtians overthrowing it - the secret message being that they had + Christ is or will be back).
```
**Co-occurrences**: Christ, Tears, Christian, Complete, Rome, Good, Something, Being, Secret, Will, Back, Evil, Knowledge

---
### Line 12451-12459 (Match: 'Okay')
**Folder**: part of

```text
But if you are a dancer, one who plays, a [..]; picking up a gun is no answer. Force is no answer. When the joyful one is arrested, like Goldie Hahn, he can only succumb. Fighting + playing are mutually exclusive. (Consider the throat-cutting Zealots.) But cooperating with the BIP is out of the question - i.e. sobering up + going to work in the tin mind.

v. "A Thousand Clowns." There it all is. Being a fit person. Murray Burns is the arch criminal, as viewed by the BIP + its misguided (warped) agents - its police. Work for its own sake, is what they want - like play (homo ludeus) for its own sake. It becomes an end in itself. A distinguishing mark.

"By their fruit ye shall know them," + work esp for its own sake, marks you as okay. Just as play marks you as a "parasite."

"But are you writing something serious?" Note the word.

Fuck. If they couldn't get us to write serious things, they solved the problem bty deceiving that what we were writing was serious.
```
**Co-occurrences**: Like, Only, Mind, Just, Something, Being, Viewed, Their, Consider, Were, Things, Answer
