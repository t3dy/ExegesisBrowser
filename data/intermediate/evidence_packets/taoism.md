...
```
**Co-occurrences**: Ubik, Complete, Christianity, Well, Dionysos, Like, Since, Because, Only, Time, After, Soviet, Again, Reality, Kosmos, Being, Runciter, Although, Great, Viewed, Without, Darkness, Those, More, Living, Real, Zoroastrianism, Greece, True, Death, Egyptian, Beyond, Many, Have, Life, Spring, Instead, Days, Evil, Greater, Final, Right, Until

---
### Line 610-618 (Match: 'Taoism')
**Folder**: part was
...
```
**Co-occurrences**: Form, Like, Parmenides, Since, Only, Time, Harpax, Mind, Again, Reality, Being, Their, More, Universe, Will, Other, Further, Things, Life, Apparently, Dead, Right

---
### Line 634-642 (Match: 'Taoism')
**Folder**: part or
...
```
**Co-occurrences**: Well, These, Only, Time, Harpax, Noos, Light, Even, Karma, Gospel, Could, Does, Being, Nothing, Those, More, Real, Upon, Mother, Will, Would, Back, Whatever, Many, Have, Wise, Later, Testament, Dream, Doesn, Right

---
### Line 742-750 (Match: 'Taoism')
**Folder**: part segment
...
Last edit over 5 years ago by Harpax
```
**Co-occurrences**: Tears, Form, Well, Golden, However, These, Maybe, Like, World, Only, Time, Harpax, Light, Could, Does, Again, Both, Great, Apollo, Still, Part, More, Another, True, Universe, Would, Other, Page, Very, Whatever, Many, Have, Tagomi, Info, Form One, Dream, Evidently, Whereas, Final, Right

---
### Line 750-758 (Match: 'Taoism')
**Folder**: part segment
...
```
**Co-occurrences**: Logos, Maybe, Like, Because, Only, Time, Harpax, Light, Could, Anyhow, Just, Empedocles, Although, Great, Without, Nothing, Darkness, Their, Heaven, Would, Other, Were, Back, Dark, Right

---
### Line 2297-2305 (Match: 'Taoism')
**Folder**: part of
...
I therefore took the couse, last night, of denying the testimony of my senses, and said: God is at work in the world but below the surface; so that evil, although empirically evident, is not actually in control as it appears to be. Further, I realized, a discernment past superficial reality shows evil to be or anyhow at one time in the past (prior to 8 94) to have been in the saddle in a much deeper way than it allowed us to see; in other words, evil masked its own power, the more to control and enslave us. So at first step, a penetration into the heart of reality showed it even more evil, or in the control of evil, than did mere superficial analysis. However, below the ring of iron around us (Rome, as the metaphor goes), I saw that God had breached, penetrated, and in fact made hollow this evil, and turned it into a shell by something transforming it from within, into its opposite...which made me recall Taoism, and I think it was Empedocles -- one of the pre-Socratics, he or Hericlitus, I suppose, the point being that one of them had argued that any quality contains its opposite within it and will be transformed into it (yin into yang, etc.) if pressed far enough. What this then yielded to in my thinking was the concepts of palintropos and

Last edit over 5 years ago by Harpax
173
Needs Review
```
**Co-occurrences**: Spirit, Holy, Rome, Holy Spirit, However, World, Therefore, Iron, Time, Harpax, Even, Yang, Anyhow, Something, Suppose, Reality, Being, Empedocles, Obviously, Although, Either, More, Actually, True, Will, Other, Mission, Further, Have, Evil

---
### Line 2482-2490 (Match: 'Taoism')
**Folder**: vol 12
...
```
**Co-occurrences**: Christian, Spirit, Holy, Jesus, Christianity, Holy Spirit, Form, Fish, Greek, Bible, Wisdom, Dionysos, Perhaps, Elijah, Like, Because, Only, Time, Harpax, Good, Even, Could, Does, Something, Being, Girl, Orphic, Himself, Great, Viewed, Without, Grace, More, Another, Orphism, Living, Heaven, Real, Certainly, Before, Zoroastrianism, Death, Would, Other, Were, Very, Back, Surely, Under, Have, Life, Dark, Freedom, Later, Evil, God Himself, Elisha, Human, Dream, Ananke

---
### Line 2635-2643 (Match: 'Taoism')
**Folder**: part of

```text
201
Linear time, then, is God At Work On Creation. God's Activity (which is the Logos). Now, since systole and dystole are opposites (reversals) of each other, then maybe what we have here in this breathing terminology is another expression of "Form One and Form Two," which are mirror opposites of each other -- and also at the time I saw the regressive (retro) time I realized that I'd been "seeing the universe backward." A mirror opposite. Thus I must have gone from seeing the customary form or function to seeing the one concealed -- reality beneath appearance, so to speak; all this makes sense in terms of my experience, what seemed diverse aspects or properties then I can now see as one single event: the sudden encounter with the other form. (I assign to that other form the qualities of eternal, benevolent, and wise.) I suddenly get the impression that true or total reality is a loop going in two --opposite-- directions in time simultaneously. They are laminated, pasted one over the other (my god; my twin drive clock-ball mechanism, each rotor going in a direction opposite to the other!!!!!!). Thus stasis is achieved. These are the cycles of the universe; it ends on begins to reverse itself, but not so as to wipe out its previous achieved forward cycle; it then loops back invisible to us on the forward mode. Otherwise there would be a cancellation of reality, rather than balance. But, I think, this opposite-moving reality affects ours! We are laminated to it, and influenced by it even though we can't see it (maybe this is how precognition works). Behind our forward is an invisible retracting world. Which is a form-completing force for our world. This intrusion (thrusting forward into visibility) of the reverse-moving reality is what we see in UBIK!!! When the surface forward for any reason declines, so as to expose it. It is precisely in this reverse flow that the missing integers of meaning exist, which when added to what we (forward) see makes sense out of our world -- and which not seen, keep out of reach that completeness, that wholeness, that making sense out of our world -- and which not seen, keep out of our reach that completeness, that wholeness, that making sense. These are the lacking parts from here and there, found only on the reverse band of the loop; these would give answers to our "Why?s". My god, this is a fantastic balance system! These twin drives with their confluence which I saw in a dream! (But by the third eye of enlightenment we are able to discern this other-directional flow, and so can comprehend at last what we see, since what we see is now complete.) Without the third eye processes experienced or seen backward do not add up at all, but are mere chaos to us, in our half-blind state.

The I CHING makes it clear that there is a secret backward motion in time, through which eternity is achieved, perfection and eternity. Permanence, due to a balancing of the sine wave of the forward moving time-reality. What isn't here is there; what is here isn't there; the total is always complete. This fits into Taoism well, and Christian ideas of humbling oneself (transformation into opposites). What looms large here is tiny there and vice versa. All that is lost (spilled) here is gathered up there. However, the universe is always simultaneously moving in two (time) directions or modes at once; if the forward mode were ever to reverse itself, then the reverse direction would take the system backtracking parallel to what it had swept out previously. Thus for it to oscillate alternately would be automatically to achieve a simultaneity of motions, which is what I saw.

Last edit over 5 years ago by Harpax
202
Needs Review
```
**Co-occurrences**: Christian, Ubik, Logos, Complete, Form, Well, However, These, Maybe, World, Since, Only, Time, Harpax, Even, Once, Reality, Without, Their, Another, Through, Secret, True, Universe, Would, Other, Creation, Ching, Were, Back, Have, Wise, Form One, Suddenly, Otherwise, Dream

---
### Line 2799-2807 (Match: 'Taoism')
**Folder**: Book of
...
Needs Review
```
**Co-occurrences**: Christ, Christian, Holy, Rome, Christianity, King, Well, Parousia, Wisdom, These, Advent, Father, Like, World, Time, Nixon, Holy Wisdom, Good, Yang, Could, Joint, Just, Something, Again, Suppose, Reality, Empedocles, Himself, Great, Bacchae, Probably, Nothing, Kathy, Their, Such, Love, Greece, Would, Other, Hamlet, Were, Back, Whatever, Evil, Remember, Cross, Dialectic, Dead, Otherwise, Dream, Lamb, Right, Answer, Until

---
### Line 3796-3804 (Match: 'Taoism')
**Folder**: Book of
...
56
```
**Co-occurrences**: Christ, Christian, Zebra, Christianity, Gnostic, Wisdom, James, Only, Noos, Good, Yang, Being, Although, Nothing, Taoist, Creator, Jews, More, Secret, Love, True, Other, Creation, Have, Life, Evil, Having, Salvation

---
### Line 6808-6816 (Match: 'Taoism')
**Folder**: part cycle
...
```
**Co-occurrences**: Valis, Tears, Indexed, King, Only, Buckman, Just, Both, Kosmos, Divine, Their, More, Death, Illustration, Whatever, Life, Wise

---
### Line 9043-9051 (Match: 'Taoism')
**Folder**: Unknown
...
Last edit over 5 years ago by sekennedy62
```
**Co-occurrences**: Christ, Complete, Christianity, Form, Gnostic, Paul, Maybe, World, Parmenides, Because, Only, Light, Could, Just, Something, Look, Both, Being, More, Living, Ground, Real, Timaeus, Before, Zoroastrianism, True, Universe, Will, Would, Were, Unless, Dialectic, Right, Ananke

---
### Line 9057-9065 (Match: 'Taoism')
**Folder**: Unknown

```text
Hyperuniverse I: Freedom, supralunar, God's great
...
Last edit over 5 years ago by sekennedy62
```
**Co-occurrences**: Acts, Zebra, Form, Gnostic, Maybe, Like, World, Gnosis, Because, Therefore, Only, Could, Both, Self, Great, Anamnesis, Without, Essene, Living, True, Death, Calvin, Back, Have, Mani, Clearly, Memory, Freedom, Human, Pleroma, Answer

---
### Line 9191-9199 (Match: 'Taoism')
**Folder**: part will
...
```
**Co-occurrences**: Christ, Christian, Zebra, Jesus, Christianity, Form, Sophia, Satan, Well, Gnosticism, Wisdom, Like, World, Gnosis, Good, Even, Just, Shiva, Being, Hagia, Although, Hagia Sophia, Either, Gods, Creator, Most, Real, Secret, Love, Before, Revelation, True, Deity, Have, Mani, Evil, Unless, Right

---
### Line 9924-9932 (Match: 'Taoism')
**Folder**: part is

```text
[Diagram] unreal: ☯ → BIP (in comparison to this one) real [..]

The yin creation is not real (as Parmenides was the first to realize - i.e. Form II). However, the true creative half of God, the yang half, is infusing real essence into our world. But not to the BIP aspects: the PTG will replace the BIP. We do not discern this metamorphosis because the BIP isn't perceptible to us in the first place: the great actions of salvation are invisible behind the scenes.

All my writing, in which irreal, forgery universes are presented, are expressions of Parmenides' insight about the non reality of Form II. This sets me + Parmenides apart from Taoism. It prepares the war for Gnosticism + the concept of a botched, bungled world. Form II can be regarded as "false work," necessary but temporary. Yin was given the first try at copying the androgynous Godhead, + failed. The BIP resulted. So yang penetrates to add what is [missing], which is nothing less that reality itself.

It is not just the BIP which is not real; it is the yin's world, no less. Of course, we do not inhabit purely yin world (ground). Set (yang) is here, [..] to a very large degree.

Last edit about 5 years ago by sekennedy62
```
**Co-occurrences**: Form, Gnosticism, However, Godhead, World, Parmenides, Because, Yang, Just, Diagram, Reality, Great, Nothing, Ground, Real, True, Will, Creation, Very, Salvation

---
### Line 10071-10079 (Match: 'Taoism')
**Folder**: part of

```text
76
Therefore I claim that at last I can characterize the interventive presence of Zebra as necessarily implied by the whole structure. I rejoice in the knowledge that the interventive entity is alive (which can only be experientially known, not a priori known), + intervenes by sentient decisions in fact based on Holy Wisdom itself. I have no way to compute the frequency of intervention or extent, but it must of necessity be there (a priori) + I saw it in 3-74. Now we can properly appraise Christ's salvific role in human history + redefined the term "salvation" itself to yield some tangible meaning.

UBIK is the entity known in Taoism as yang.

So although Zebra has in one sense invaded the world (which is to say the yin world) it is necessary in order to complete the world; it could not continue without it. ([..] is well-portrayed in "Ubik"). ("Ubik" makes clear what would happen to a world composed only of yin: it would decay back along the platonic form-axis.

The vast dialectic between the yin world + the yang entity drives the universe forward. What I know from my 3-74 experience is that yin is mindless (blind + without teleological purpose) whereas yang (e.g. Zebra, UBIK) is very much alive - it has distinct personality + views - i.e. it envisions clearly what it wants to achieve. It can achieve as objectives through (by means of) the vast machining (grinding world) of yin. So yin (resisting [..] inertia or not) is directed, incised, recontoured by the intelligent yang (the Logos as plan + conceiver of plan). The yin world that which is formed, shaped (the recepticle of being.) Yang is shaper; yin is thing shaped. Yang is not a being, a world; it is a force, an energy, an eidos. Look what I know by revelation: yang is alive. When you ponder it, it is logical that it would be alive. How could it have a plan otherwise? How can cosmos emerge out of change if no noös is involved?
```
**Co-occurrences**: Christ, Ubik, Holy, Zebra, Logos, Complete, Form, Well, Wisdom, World, Therefore, Only, Holy Wisdom, Yang, Could, Look, Being, Although, Platonic, Without, Through, Revelation, Universe, Would, Very, Back, Have, Clearly, Knowledge, Dialectic, Otherwise, Human, Salvation, Whereas

---
### Line 10109-10117 (Match: 'Taoism')
**Folder**: part of

```text
A synthetic cosmology appears:
...
```
**Co-occurrences**: Zebra, Gnosticism, Godhead, World, Good, Yang, Zoroastrianism

---
### Line 10154-10162 (Match: 'Taoism')
**Folder**: part of
...
Complete
```
**Co-occurrences**: Logos, Complete, Christianity, Form, Plato, Kingdom, Well, Gnosticism, These, Godhead, World, Parmenides, Prison, Only, Garden, Gestalt, Yang, Does, Kingdom of God, Reality, Heraclitus, Being, Empedocles, Hegel, Soul, Real, Zoroastrianism, Creation, Wise, Salvation

---
### Line 10186-10194 (Match: 'Taoism')
**Folder**: part of
...
```
**Co-occurrences**: Complete, Christianity, Parmenides, Because, Only, Does, Both, Reality, Without, Most, Upon, Zoroastrianism, Western, Macro, Will, Deity, Somehow, Hindu, Knowledge, Eastern, West, Durant, Right
